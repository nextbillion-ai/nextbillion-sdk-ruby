...
module Nextbillionai
  module Models
    class RichGroupResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(Nextbillionai::RichGroupResponse::Direction::TaggedSymbol)
        )
      end
      ...
      sig do
        params(
          direction: Nextbillionai::RichGroupResponse::Direction::OrSymbol
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            Nextbillionai::RichGroupResponse::RestrictionType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          restriction_type:
            Nextbillionai::RichGroupResponse::RestrictionType::OrSymbol
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(Nextbillionai::RichGroupResponse::State::TaggedSymbol)
        )
      end
      attr_reader :state

      sig do
        params(state: Nextbillionai::RichGroupResponse::State::OrSymbol).void
      end
      attr_writer :state
      ...
      sig do
        params(status: Nextbillionai::RichGroupResponse::Status::OrSymbol).void
      end
      attr_writer :status
      ...
      sig do
        params(
          ...
          speed_limit: Float,
          start_time: Float,
          state: Nextbillionai::RichGroupResponse::State::OrSymbol,
          status: Nextbillionai::RichGroupResponse::Status::OrSymbol,
          update_at: Time
        ...
        override.returns(
          {
            ...
            create_at: Time,
            direction:
              Nextbillionai::RichGroupResponse::Direction::TaggedSymbol,
            end_time: Float,
            geofence: T.anything,
            highway: String,
            mode: T::Array[String],
            ...
            speed_limit: Float,
            start_time: Float,
            state: Nextbillionai::RichGroupResponse::State::TaggedSymbol,
            status: Nextbillionai::RichGroupResponse::Status::TaggedSymbol,
            update_at: Time
          }
        )
      end
      ...
      module Direction
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Nextbillionai::RichGroupResponse::Direction)
          end
        ...
        sig do
          override.returns(
            T::Array[Nextbillionai::RichGroupResponse::Direction::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module RestrictionType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Nextbillionai::RichGroupResponse::RestrictionType)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module State
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Nextbillionai::RichGroupResponse::State)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ENABLED =
          T.let(:enabled, Nextbillionai::RichGroupResponse::State::TaggedSymbol)
        DISABLED =
          T.let(
            :disabled,
            Nextbillionai::RichGroupResponse::State::TaggedSymbol
          )
        DELETED =
          T.let(:deleted, Nextbillionai::RichGroupResponse::State::TaggedSymbol)

        sig do
          override.returns(
            T::Array[Nextbillionai::RichGroupResponse::State::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Status
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Nextbillionai::RichGroupResponse::Status)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        ACTIVE =
          T.let(:active, Nextbillionai::RichGroupResponse::Status::TaggedSymbol)
        INACTIVE =
          T.let(
            :inactive,
            Nextbillionai::RichGroupResponse::Status::TaggedSymbol
          )

        sig do
          override.returns(
            T::Array[Nextbillionai::RichGroupResponse::Status::TaggedSymbol]
          )
        end
        def self.values
        end
