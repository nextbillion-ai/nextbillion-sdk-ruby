  ...
  module Models
    class IsochroneComputeResponse < Nextbillionai::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Nextbillionai::Models::IsochroneComputeResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Nextbillionai::Models::IsochroneComputeResponse::Feature]
          )
        )
      end
      ...
      sig do
        params(
          features:
            T::Array[
              Nextbillionai::Models::IsochroneComputeResponse::Feature::OrHash
            ]
        ).void
      end
        ...
        override.returns(
          {
            features:
              T::Array[
                Nextbillionai::Models::IsochroneComputeResponse::Feature
              ],
            msg: String,
            status: String,
            type: String
      ...
      class Feature < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          params(
            geometry:
              Nextbillionai::Models::IsochroneComputeResponse::Feature::Geometry::OrHash
          ).void
        end
        ...
        sig do
          params(
            properties:
              Nextbillionai::Models::IsochroneComputeResponse::Feature::Properties::OrHash
          ).void
        end
