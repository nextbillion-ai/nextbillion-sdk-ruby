    ...
    module DistanceMatrix
      class JsonRetrieveResponse < Nextbillionai::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::Models::DistanceMatrix::JsonRetrieveResponse,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Nextbillionai::Models::DistanceMatrix::JsonRetrieveResponse::Row
              ]
            )
          )
        end
        ...
        sig do
          params(
            rows:
              T::Array[
                Nextbillionai::Models::DistanceMatrix::JsonRetrieveResponse::Row::OrHash
              ]
          ).void
        end
        attr_writer :rows
        ...
        class Row < Nextbillionai::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Nextbillionai::Models::DistanceMatrix::JsonRetrieveResponse::Row::Element
                ]
              )
            )
          end
          ...
          sig do
            params(
              elements:
                T::Array[
                  Nextbillionai::Models::DistanceMatrix::JsonRetrieveResponse::Row::Element::OrHash
                ]
            ).void
          end
