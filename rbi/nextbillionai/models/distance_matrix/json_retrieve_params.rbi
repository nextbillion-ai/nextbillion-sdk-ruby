    ...
    module DistanceMatrix
      class JsonRetrieveParams < Nextbillionai::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::DistanceMatrix::JsonRetrieveParams,
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::DistanceMatrix::JsonRetrieveParams::Approaches::OrSymbol
            )
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::DistanceMatrix::JsonRetrieveParams::Avoid::OrSymbol
            )
          )
        end
        attr_reader :avoid
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::DistanceMatrix::JsonRetrieveParams::Mode::OrSymbol
            )
          )
        end
        attr_reader :mode
        ...
        module Approaches
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Nextbillionai::DistanceMatrix::JsonRetrieveParams::Approaches
              )
            end
          ...
          UNRESTRICTED =
            T.let(
              :unrestricted,
              Nextbillionai::DistanceMatrix::JsonRetrieveParams::Approaches::TaggedSymbol
            )
          CURB =
            T.let(
              :curb,
        ...
        module Avoid
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Nextbillionai::DistanceMatrix::JsonRetrieveParams::Avoid
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          TOLL =
            T.let(
              :toll,
              Nextbillionai::DistanceMatrix::JsonRetrieveParams::Avoid::TaggedSymbol
            )
          FERRY =
            T.let(
              :ferry,
        ...
        module Mode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Nextbillionai::DistanceMatrix::JsonRetrieveParams::Mode
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          CAR =
            T.let(
              :car,
              Nextbillionai::DistanceMatrix::JsonRetrieveParams::Mode::TaggedSymbol
            )
          TRUCK =
            T.let(
              :truck,
