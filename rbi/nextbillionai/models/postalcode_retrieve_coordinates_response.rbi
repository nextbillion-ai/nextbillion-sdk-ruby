  ...
  module Models
    class PostalcodeRetrieveCoordinatesResponse < Nextbillionai::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse,
      ...
      sig do
        params(
          places:
            Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::OrHash
        ).void
      end
      attr_writer :places
      ...
      class Places < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          params(
            boundary:
              Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::OrHash
          ).void
        end
        ...
        sig do
          params(
            geopoint:
              Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Geopoint::OrHash
          ).void
        end
        ...
        class Boundary < Nextbillionai::Internal::Type::BaseModel
          ...
          sig do
            params(
              geometry:
                Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Geometry::OrHash
            ).void
          end
          ...
          sig do
            params(
              multipolygon:
                T::Array[
                  Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::OrHash
                ]
            ).void
          end
          ...
          class Multipolygon < Nextbillionai::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::Polygon
                  ]
                )
              )
            end
            ...
            sig do
              params(
                polygon:
                  T::Array[
                    Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::Polygon::OrHash
                  ]
              ).void
            end
            attr_writer :polygon
            ...
            class Polygon < Nextbillionai::Internal::Type::BaseModel
              ...
              sig do
                params(
                  points:
                    T::Array[
                      Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::Polygon::Point::OrHash
                    ]
                ).void
              end
              attr_writer :points
