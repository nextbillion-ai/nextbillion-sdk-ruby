      ...
      module Routes
        class StepCreateParams < Nextbillionai::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Nextbillionai::Fleetify::Routes::StepCreateParams,
          ...
          sig do
            returns(
              Nextbillionai::Fleetify::Routes::StepCreateParams::Type::OrSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            returns(
              T.nilable(Nextbillionai::Fleetify::Routes::StepCreateParams::Meta)
            )
          end
          attr_reader :meta
          ...
          sig do
            params(
              meta:
                Nextbillionai::Fleetify::Routes::StepCreateParams::Meta::OrHash
            ).void
          end
          attr_writer :meta
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Nextbillionai::Fleetify::Routes::StepCreateParams::Type
                )
              end
            ...
            START =
              T.let(
                :"`start`",
                Nextbillionai::Fleetify::Routes::StepCreateParams::Type::TaggedSymbol
              )
            JOB =
              T.let(
                :"`job`",
          ...
          class Meta < Nextbillionai::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Nextbillionai::Fleetify::Routes::StepCreateParams::Meta,
                  Nextbillionai::Internal::AnyHash
                )
              end
