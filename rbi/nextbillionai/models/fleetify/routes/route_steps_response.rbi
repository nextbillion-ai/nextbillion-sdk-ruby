      ...
      module Routes
        class RouteStepsResponse < Nextbillionai::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Nextbillionai::Fleetify::Routes::RouteStepsResponse,
          ...
          sig do
            params(
              completion:
                Nextbillionai::Fleetify::Routes::RouteStepsResponse::Completion::OrHash
            ).void
          end
          ...
          sig do
            params(
              meta:
                Nextbillionai::Fleetify::Routes::RouteStepsResponse::Meta::OrHash
            ).void
          end
          attr_writer :meta
          ...
          class Completion < Nextbillionai::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  Nextbillionai::Fleetify::Routes::RouteStepsResponse::Completion::Status::TaggedSymbol
                )
              )
            end
            attr_reader :status
            ...
            sig do
              params(
                status:
                  Nextbillionai::Fleetify::Routes::RouteStepsResponse::Completion::Status::OrSymbol
              ).void
            end
            attr_writer :status
