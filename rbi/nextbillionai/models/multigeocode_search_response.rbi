  ...
  module Models
    class MultigeocodeSearchResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Nextbillionai::Models::MultigeocodeSearchResponse::Entity]
          )
        )
      end
      ...
      sig do
        params(
          entities:
            T::Array[
              Nextbillionai::Models::MultigeocodeSearchResponse::Entity::OrHash
            ]
        ).void
      end
        ...
        override.returns(
          {
            entities:
              T::Array[
                Nextbillionai::Models::MultigeocodeSearchResponse::Entity
              ]
          }
        )
      end
      ...
      class Entity < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          params(
            data_source:
              Nextbillionai::Models::MultigeocodeSearchResponse::Entity::DataSource::OrHash
          ).void
        end
        ...
        class DataSource < Nextbillionai::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Nextbillionai::Models::MultigeocodeSearchResponse::Entity::DataSource::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Nextbillionai::Models::MultigeocodeSearchResponse::Entity::DataSource::Status::OrSymbol
            ).void
          end
          attr_writer :status
