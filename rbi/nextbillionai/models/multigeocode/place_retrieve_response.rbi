    ...
    module Multigeocode
      class PlaceRetrieveResponse < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          params(
            data_sorce:
              Nextbillionai::Models::Multigeocode::PlaceRetrieveResponse::DataSorce::OrHash
          ).void
        end
        ...
        class DataSorce < Nextbillionai::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                Nextbillionai::Models::Multigeocode::PlaceRetrieveResponse::DataSorce::Status::TaggedSymbol
              )
            )
          end
          attr_reader :status
          ...
          sig do
            params(
              status:
                Nextbillionai::Models::Multigeocode::PlaceRetrieveResponse::DataSorce::Status::OrSymbol
            ).void
          end
          attr_writer :status
