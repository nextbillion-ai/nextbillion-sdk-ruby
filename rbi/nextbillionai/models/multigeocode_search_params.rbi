  ...
  module Models
    class MultigeocodeSearchParams < Nextbillionai::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Nextbillionai::MultigeocodeSearchParams,
      ...
      sig { returns(Nextbillionai::MultigeocodeSearchParams::At) }
      attr_reader :at

      sig do
        params(at: Nextbillionai::MultigeocodeSearchParams::At::OrHash).void
      end
      attr_writer :at
      ...
      class At < Nextbillionai::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::MultigeocodeSearchParams::At,
              Nextbillionai::Internal::AnyHash
            )
          end
