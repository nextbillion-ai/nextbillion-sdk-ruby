...
module Nextbillionai
  module Models
    class GeofenceAPI < Nextbillionai::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(Nextbillionai::GeofenceAPI, Nextbillionai::Internal::AnyHash)
        end
      ...
      sig { returns(T.nilable(Nextbillionai::GeofenceAPI::CircleCenter)) }
      attr_reader :circle_center

      sig do
        params(
          circle_center: Nextbillionai::GeofenceAPI::CircleCenter::OrHash
        ).void
      end
      ...
      sig do
        params(geojson: Nextbillionai::Geofence::PolygonGeojson::OrHash).void
      end
      attr_writer :geojson
      ...
      sig { returns(T.nilable(Nextbillionai::GeofenceAPI::Type::TaggedSymbol)) }
      attr_reader :type

      sig { params(type: Nextbillionai::GeofenceAPI::Type::OrSymbol).void }
      attr_writer :type
      ...
      sig do
        params(
          ...
          name: String,
          tags: T::Array[String],
          type: Nextbillionai::GeofenceAPI::Type::OrSymbol,
          updated_at: Integer
        ...
        override.returns(
          {
            ...
            name: String,
            tags: T::Array[String],
            type: Nextbillionai::GeofenceAPI::Type::TaggedSymbol,
            updated_at: Integer
          }
        )
      end
      ...
      module Type
        ...
        sig do
          override.returns(
            T::Array[Nextbillionai::GeofenceAPI::Type::TaggedSymbol]
          )
        end
        def self.values
        end
