    ...
    class GeocodeStructuredRetrieveResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item
            ]
          )
        )
      end
      ...
      sig do
        params(
          items:
            T::Array[
              Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OrHash
            ]
        ).void
      end
      attr_writer :items
      ...
      class Item < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          params(
            opening_hours:
              Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::Scoring
            )
          )
        end
        attr_reader :scoring
        ...
        sig do
          params(
            scoring:
              Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::Scoring::OrHash
          ).void
        end
        attr_writer :scoring
        ...
        class OpeningHours < Nextbillionai::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange
                ]
              )
            )
          end
          ...
          sig do
            params(
              time_ranges:
                T::Array[
                  Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::OrHash
                ]
            ).void
          end
          ...
          class TimeRange < Nextbillionai::Internal::Type::BaseModel
            ...
            sig do
              params(
                end_time:
                  Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::EndTime::OrHash
              ).void
            end
            ...
            sig do
              params(
                start_time:
                  Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::StartTime::OrHash
              ).void
            end
