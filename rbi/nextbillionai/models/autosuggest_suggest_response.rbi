  ...
  module Models
    class AutosuggestSuggestResponse < Nextbillionai::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Nextbillionai::Models::AutosuggestSuggestResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[Nextbillionai::Models::AutosuggestSuggestResponse::Item]
          )
        )
      end
      attr_reader :items
      ...
      sig do
        params(
          items:
            T::Array[
              Nextbillionai::Models::AutosuggestSuggestResponse::Item::OrHash
            ]
        ).void
      end
      attr_writer :items
      ...
      class Item < Nextbillionai::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::Models::AutosuggestSuggestResponse::Item,
              Nextbillionai::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            opening_hours:
              Nextbillionai::Models::AutosuggestSuggestResponse::Item::OpeningHours::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::Models::AutosuggestSuggestResponse::Item::Scoring
            )
          )
        end
        attr_reader :scoring
        ...
        sig do
          params(
            scoring:
              Nextbillionai::Models::AutosuggestSuggestResponse::Item::Scoring::OrHash
          ).void
        end
        attr_writer :scoring
        ...
        class OpeningHours < Nextbillionai::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Nextbillionai::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange
                ]
              )
            )
          end
          ...
          sig do
            params(
              time_ranges:
                T::Array[
                  Nextbillionai::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::OrHash
                ]
            ).void
          end
          ...
          class TimeRange < Nextbillionai::Internal::Type::BaseModel
            ...
            sig do
              params(
                end_time:
                  Nextbillionai::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::EndTime::OrHash
              ).void
            end
            ...
            sig do
              params(
                start_time:
                  Nextbillionai::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::StartTime::OrHash
              ).void
            end
