  ...
  module Models
    class SnapToRoadSnapResponse < Nextbillionai::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Nextbillionai::Models::SnapToRoadSnapResponse,
      ...
      sig do
        returns(
          T.nilable(Nextbillionai::Models::SnapToRoadSnapResponse::Geojson)
        )
      end
      attr_reader :geojson
      ...
      sig do
        params(
          geojson:
            Nextbillionai::Models::SnapToRoadSnapResponse::Geojson::OrHash
        ).void
      end
      attr_writer :geojson
      ...
      sig do
        returns(
          T.nilable(Nextbillionai::Models::SnapToRoadSnapResponse::RoadInfo)
        )
      end
      ...
      sig do
        params(
          road_info:
            Nextbillionai::Models::SnapToRoadSnapResponse::RoadInfo::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              Nextbillionai::Models::SnapToRoadSnapResponse::SnappedPoint
            ]
          )
        )
      end
      ...
      sig do
        params(
          snapped_points:
            T::Array[
              Nextbillionai::Models::SnapToRoadSnapResponse::SnappedPoint::OrHash
            ]
        ).void
      end
      ...
      class Geojson < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          params(
            geometry:
              Nextbillionai::Models::SnapToRoadSnapResponse::Geojson::Geometry::OrHash
          ).void
        end
        attr_writer :geometry
      ...
      class RoadInfo < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                Nextbillionai::Models::SnapToRoadSnapResponse::RoadInfo::MaxSpeed
              ]
            )
          )
        end
        ...
        sig do
          params(
            max_speed:
              T::Array[
                Nextbillionai::Models::SnapToRoadSnapResponse::RoadInfo::MaxSpeed::OrHash
              ]
          ).void
        end
      ...
      class SnappedPoint < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          returns(
            Nextbillionai::Models::SnapToRoadSnapResponse::SnappedPoint::Location
          )
        end
        ...
        sig do
          params(
            location:
              Nextbillionai::Models::SnapToRoadSnapResponse::SnappedPoint::Location::OrHash
          ).void
        end
