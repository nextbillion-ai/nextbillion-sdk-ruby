    ...
    module Skynet
      class TripUpdateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::Skynet::TripUpdateParams,
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::Skynet::TripUpdateParams::Cluster::OrSymbol
            )
          )
        end
        attr_reader :cluster
        ...
        sig do
          returns(
            T.nilable(T::Array[Nextbillionai::Skynet::TripUpdateParams::Stop])
          )
        end
        attr_reader :stops
          ...
          override.returns(
            {
              ...
              meta_data: T.anything,
              name: String,
              stops: T::Array[Nextbillionai::Skynet::TripUpdateParams::Stop],
        ...
        module Cluster
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Nextbillionai::Skynet::TripUpdateParams::Cluster)
            end
          ...
          AMERICA =
            T.let(
              :america,
              Nextbillionai::Skynet::TripUpdateParams::Cluster::TaggedSymbol
            )
        ...
        class Stop < Nextbillionai::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Nextbillionai::Skynet::TripUpdateParams::Stop,
                Nextbillionai::Internal::AnyHash
              )
            end
