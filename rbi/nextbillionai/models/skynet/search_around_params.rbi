    ...
    module Skynet
      class SearchAroundParams < Nextbillionai::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::Skynet::SearchAroundParams,
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::Skynet::SearchAroundParams::SortBy::OrSymbol
            )
          )
        end
        attr_reader :sort_by
        ...
        sig do
          params(
            sort_by: Nextbillionai::Skynet::SearchAroundParams::SortBy::OrSymbol
          ).void
        end
        attr_writer :sort_by
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::Skynet::SearchAroundParams::SortDrivingMode::OrSymbol
            )
          )
        end
        ...
        module SortBy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Nextbillionai::Skynet::SearchAroundParams::SortBy)
            end
          ...
          DISTANCE =
            T.let(
              :"`distance`",
              Nextbillionai::Skynet::SearchAroundParams::SortBy::TaggedSymbol
            )
          DURATION =
            T.let(
              :"`duration`",
        ...
        module SortDrivingMode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                Nextbillionai::Skynet::SearchAroundParams::SortDrivingMode
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          CAR =
            T.let(
              :"`car`",
              Nextbillionai::Skynet::SearchAroundParams::SortDrivingMode::TaggedSymbol
            )
          TRUCK =
            T.let(
              :"`truck`",
