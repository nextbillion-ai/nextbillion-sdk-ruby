  ...
  module Models
    module Skynet
      class TripRetrieveResponse < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Nextbillionai::Models::Skynet::TripRetrieveResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              Nextbillionai::Models::Skynet::TripRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: Nextbillionai::Models::Skynet::TripRetrieveResponse::Data,
              message: String,
              status: String
            }
          )
        ...
        class Data < Nextbillionai::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Nextbillionai::Models::Skynet::TripRetrieveResponse::Data,
                Nextbillionai::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                Nextbillionai::Models::Skynet::TripRetrieveResponse::Data::Trip
              )
            )
          end
          attr_reader :trip
          ...
          sig do
            params(
              trip:
                Nextbillionai::Models::Skynet::TripRetrieveResponse::Data::Trip::OrHash
            ).void
          end
          attr_writer :trip
