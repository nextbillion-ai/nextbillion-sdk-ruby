    ...
    module Skynet
      class MonitorCreateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::Skynet::MonitorCreateParams,
        ...
        sig do
          returns(Nextbillionai::Skynet::MonitorCreateParams::Type::OrSymbol)
        end
        attr_accessor :type
        ...
        sig do
          returns(
            T.nilable(Nextbillionai::Skynet::MonitorCreateParams::IdleConfig)
          )
        end
        ...
        sig do
          returns(
            T.nilable(Nextbillionai::Skynet::MonitorCreateParams::MatchFilter)
          )
        end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Nextbillionai::Skynet::MonitorCreateParams::Type)
            end
          ...
          ENTER =
            T.let(
              :enter,
              Nextbillionai::Skynet::MonitorCreateParams::Type::TaggedSymbol
            )
          EXIT =
            T.let(
              :exit,
        ...
        module Cluster
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Nextbillionai::Skynet::MonitorCreateParams::Cluster)
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          AMERICA =
            T.let(
              :america,
              Nextbillionai::Skynet::MonitorCreateParams::Cluster::TaggedSymbol
            )
