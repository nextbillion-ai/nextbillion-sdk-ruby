    ...
    module Skynet
      class AssetTrackParams < Nextbillionai::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::Skynet::AssetTrackParams,
        ...
        sig { returns(Nextbillionai::Skynet::AssetTrackParams::Locations) }
        attr_reader :locations

        sig do
          params(
            locations:
              Nextbillionai::Skynet::AssetTrackParams::Locations::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::Skynet::AssetTrackParams::Cluster::OrSymbol
            )
          )
        end
        attr_reader :cluster
        ...
        sig do
          params(
            cluster: Nextbillionai::Skynet::AssetTrackParams::Cluster::OrSymbol
          ).void
        end
        attr_writer :cluster
        ...
        class Locations < Nextbillionai::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Nextbillionai::Skynet::AssetTrackParams::Locations,
                Nextbillionai::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              Nextbillionai::Skynet::AssetTrackParams::Locations::Location
            )
          end
          ...
          sig do
            params(
              location:
                Nextbillionai::Skynet::AssetTrackParams::Locations::Location::OrHash
            ).void
          end
        ...
        module Cluster
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Nextbillionai::Skynet::AssetTrackParams::Cluster)
            end
          ...
          AMERICA =
            T.let(
              :america,
              Nextbillionai::Skynet::AssetTrackParams::Cluster::TaggedSymbol
            )
