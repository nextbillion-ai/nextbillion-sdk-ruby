      ...
      module Asset
        class EventListParams < Nextbillionai::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Nextbillionai::Skynet::Asset::EventListParams,
          ...
          module Cluster
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Nextbillionai::Skynet::Asset::EventListParams::Cluster
                )
              end
            ...
            AMERICA =
              T.let(
                :america,
                Nextbillionai::Skynet::Asset::EventListParams::Cluster::TaggedSymbol
              )
