      ...
      module Asset
        class LocationListParams < Nextbillionai::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Nextbillionai::Skynet::Asset::LocationListParams,
          ...
          sig do
            returns(
              T.nilable(
                Nextbillionai::Skynet::Asset::LocationListParams::Cluster::OrSymbol
              )
            )
          end
          attr_reader :cluster
          ...
          sig do
            returns(
              T.nilable(
                Nextbillionai::Skynet::Asset::LocationListParams::GeometryType::OrSymbol
              )
            )
          end
          ...
          module Cluster
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Nextbillionai::Skynet::Asset::LocationListParams::Cluster
                )
              end
            ...
            AMERICA =
              T.let(
                :america,
                Nextbillionai::Skynet::Asset::LocationListParams::Cluster::TaggedSymbol
              )
          ...
          module GeometryType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Nextbillionai::Skynet::Asset::LocationListParams::GeometryType
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            POLYLINE =
              T.let(
                :polyline,
                Nextbillionai::Skynet::Asset::LocationListParams::GeometryType::TaggedSymbol
              )
            POLYLINE6 =
              T.let(
                :polyline6,
