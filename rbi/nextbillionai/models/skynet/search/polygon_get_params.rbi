      ...
      module Search
        class PolygonGetParams < Nextbillionai::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                Nextbillionai::Skynet::Search::PolygonGetParams,
          ...
          sig do
            returns(
              T.nilable(
                Nextbillionai::Skynet::Search::PolygonGetParams::SortBy::OrSymbol
              )
            )
          end
          attr_reader :sort_by
          ...
          sig do
            returns(
              T.nilable(
                Nextbillionai::Skynet::Search::PolygonGetParams::SortDrivingMode::OrSymbol
              )
            )
          end
          ...
          module SortBy
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  Nextbillionai::Skynet::Search::PolygonGetParams::SortBy
                )
              end
