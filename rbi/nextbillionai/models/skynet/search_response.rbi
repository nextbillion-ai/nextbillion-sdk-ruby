    ...
    module Skynet
      class SearchResponse < Nextbillionai::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::Skynet::SearchResponse,
              Nextbillionai::Internal::AnyHash
            )
          end

        # A data object containing the search result.
        sig { returns(T.nilable(Nextbillionai::Skynet::SearchResponse::Data)) }
        attr_reader :data

        sig do
          params(data: Nextbillionai::Skynet::SearchResponse::Data::OrHash).void
        end
        attr_writer :data
        ...
        sig do
          params(
            data: Nextbillionai::Skynet::SearchResponse::Data::OrHash,
            message: String,
            status: String
        ...
        class Data < Nextbillionai::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[Nextbillionai::Skynet::SearchResponse::Data::Asset]
              )
            )
          end
          attr_reader :assets
          ...
          sig do
            params(
              assets:
                T::Array[
                  Nextbillionai::Skynet::SearchResponse::Data::Asset::OrHash
                ]
            ).void
          end
          attr_writer :assets
          ...
          class Asset < Nextbillionai::Internal::Type::BaseModel
            OrHash =
              T.type_alias do
                T.any(
                  Nextbillionai::Skynet::SearchResponse::Data::Asset,
                  Nextbillionai::Internal::AnyHash
                )
              end
            ...
            sig do
              params(
                latest_location:
                  Nextbillionai::Skynet::Asset::TrackLocation::OrHash
              ).void
            end
            ...
            sig do
              params(
                ranking_info:
                  Nextbillionai::Skynet::SearchResponse::Data::Asset::RankingInfo::OrHash
              ).void
            end
