    ...
    module Skynet
      class MonitorUpdateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::Skynet::MonitorUpdateParams,
        ...
        sig do
          returns(
            T.nilable(Nextbillionai::Skynet::MonitorUpdateParams::IdleConfig)
          )
        end
        ...
        sig do
          returns(
            T.nilable(Nextbillionai::Skynet::MonitorUpdateParams::MatchFilter)
          )
        end
        ...
        sig do
          returns(
            T.nilable(
              Nextbillionai::Skynet::MonitorUpdateParams::Type::OrSymbol
            )
          )
        end
        attr_reader :type
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, Nextbillionai::Skynet::MonitorUpdateParams::Type)
            end
          ...
          ENTER =
            T.let(
              :"`enter`",
              Nextbillionai::Skynet::MonitorUpdateParams::Type::TaggedSymbol
            )
          EXIT =
            T.let(
              :"`exit`",
