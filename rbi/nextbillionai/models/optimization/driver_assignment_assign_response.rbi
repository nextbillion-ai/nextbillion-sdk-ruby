    ...
    module Optimization
      class DriverAssignmentAssignResponse < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          params(
            result:
              Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::OrHash
          ).void
        end
        attr_writer :result
        ...
        class Result < Nextbillionai::Internal::Type::BaseModel
          ...
          sig do
            params(
              alternate_assignments:
                T::Array[
                  Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::AlternateAssignment::OrHash
                ]
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip
                ]
              )
            )
          end
          ...
          sig do
            params(
              trips:
                T::Array[
                  Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::OrHash
                ]
            ).void
          end
          attr_writer :trips
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::UnassignedOrder
                ]
              )
            )
          end
          ...
          sig do
            params(
              unassigned_orders:
                T::Array[
                  Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::UnassignedOrder::OrHash
                ]
            ).void
          end
          ...
          class AlternateAssignment < Nextbillionai::Internal::Type::BaseModel
            ...
            sig do
              params(
                assignments:
                  T::Array[
                    Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::AlternateAssignment::Assignment::OrHash
                  ]
              ).void
            end
          ...
          class Trip < Nextbillionai::Internal::Type::BaseModel
            ...
            sig do
              params(
                vehicle:
                  Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::OrHash
              ).void
            end
            attr_writer :vehicle
            ...
            class Vehicle < Nextbillionai::Internal::Type::BaseModel
              ...
              sig do
                params(
                  steps:
                    Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps::OrHash
                ).void
              end
              attr_writer :steps

              # Location info.
              sig { returns(T.nilable(Nextbillionai::Optimization::Location)) }
              attr_reader :vehicle_current_location

              sig do
                params(
                  vehicle_current_location:
                    Nextbillionai::Optimization::Location::OrHash
                ).void
              end
              ...
              class Steps < Nextbillionai::Internal::Type::BaseModel
                ...
                # Location info.
                sig do
                  returns(T.nilable(Nextbillionai::Optimization::Location))
                end
                ...
                sig do
                  returns(
                    T.nilable(
                      Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps::Type::TaggedSymbol
                    )
                  )
                end
                attr_reader :type
                ...
                sig do
                  params(
                    type:
                      Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps::Type::OrSymbol
                  ).void
                end
                attr_writer :type
                ...
                module Type
                  ...
                  TaggedSymbol =
                    T.type_alias do
                      T.all(
                        Symbol,
                        Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps::Type
                      )
                    end
