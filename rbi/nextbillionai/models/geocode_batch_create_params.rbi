  ...
  module Models
    class GeocodeBatchCreateParams < Nextbillionai::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            Nextbillionai::GeocodeBatchCreateParams,
      ...
      sig { returns(T::Array[Nextbillionai::GeocodeBatchCreateParams::Body]) }
      attr_accessor :body

      sig do
        params(
          key: String,
          body: T::Array[Nextbillionai::GeocodeBatchCreateParams::Body::OrHash],
      ...
      sig do
        override.returns(
          {
            key: String,
            body: T::Array[Nextbillionai::GeocodeBatchCreateParams::Body],
      ...
      class Body < Nextbillionai::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Nextbillionai::GeocodeBatchCreateParams::Body,
              Nextbillionai::Internal::AnyHash
            )
          end
