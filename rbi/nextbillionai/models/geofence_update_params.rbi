...
module Nextbillionai
  module Models
    class GeofenceUpdateParams < Nextbillionai::Internal::Type::BaseModel
      ...
      sig { returns(T.nilable(Nextbillionai::GeofenceUpdateParams::Circle)) }
      attr_reader :circle

      sig do
        params(circle: Nextbillionai::GeofenceUpdateParams::Circle::OrHash).void
      end
      attr_writer :circle
      ...
      # geofence.
      sig { returns(T.nilable(Nextbillionai::GeofenceUpdateParams::Isochrone)) }
      ...
      sig { returns(T.nilable(Nextbillionai::GeofenceUpdateParams::Polygon)) }
      attr_reader :polygon

      sig do
        params(
          polygon: Nextbillionai::GeofenceUpdateParams::Polygon::OrHash
        ).void
      end
      attr_writer :polygon
      ...
      sig do
        returns(T.nilable(Nextbillionai::GeofenceUpdateParams::Type::OrSymbol))
      end
      attr_reader :type

      sig do
        params(type: Nextbillionai::GeofenceUpdateParams::Type::OrSymbol).void
      end
      attr_writer :type
      ...
      sig do
        params(
          ...
          polygon: Nextbillionai::GeofenceUpdateParams::Polygon::OrHash,
          tags: T::Array[String],
          type: Nextbillionai::GeofenceUpdateParams::Type::OrSymbol,
      ...
      class Circle < Nextbillionai::Internal::Type::BaseModel
        ...
        sig { returns(Nextbillionai::GeofenceUpdateParams::Circle::Center) }
        attr_reader :center

        sig do
          params(
            center: Nextbillionai::GeofenceUpdateParams::Circle::Center::OrHash
          ).void
        end
        attr_writer :center
        ...
        class Center < Nextbillionai::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                Nextbillionai::GeofenceUpdateParams::Circle::Center,
                Nextbillionai::Internal::AnyHash
              )
            end
      ...
      class Polygon < Nextbillionai::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(Nextbillionai::GeofenceUpdateParams::Polygon::Geojson)
          )
        end
        attr_reader :geojson
        ...
        sig do
          params(
            geojson:
              Nextbillionai::GeofenceUpdateParams::Polygon::Geojson::OrHash
          ).void
        end
        attr_writer :geojson
      ...
      module Type
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, Nextbillionai::GeofenceUpdateParams::Type)
          end
        ...
        CIRCLE =
          T.let(
            :circle,
            Nextbillionai::GeofenceUpdateParams::Type::TaggedSymbol
          )
        POLYGON =
          T.let(
            :polygon,
        ...
        sig do
          override.returns(
            T::Array[Nextbillionai::GeofenceUpdateParams::Type::TaggedSymbol]
          )
        end
        def self.values
        end
