  ...
  module Resources
    class Geocode
      ...
      sig do
        ...
        ).returns(Nextbillionai::Models::GeocodeRetrieveResponse)
      end
      def retrieve(
      ...
      sig do
        params(
          ...
          request_options: Nextbillionai::RequestOptions::OrHash
        ).returns(Nextbillionai::Models::GeocodeBatchCreateResponse)
      end
      def batch_create(
      ...
      sig do
        params(
          ...
          street: String,
          request_options: Nextbillionai::RequestOptions::OrHash
        ).returns(Nextbillionai::Models::GeocodeStructuredRetrieveResponse)
      end
