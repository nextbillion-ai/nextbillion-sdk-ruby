...
module Nextbillionai
  module Resources
    class Geofence
      sig { returns(Nextbillionai::Resources::Geofence::Console) }
      attr_reader :console

      sig { returns(Nextbillionai::Resources::Geofence::Batch) }
      attr_reader :batch
      ...
      sig do
        ...
        ).returns(Nextbillionai::Models::GeofenceCreateResponse)
      end
      def create(
      ...
      sig do
        params(
          ...
          key: String,
          request_options: Nextbillionai::RequestOptions::OrHash
        ).returns(Nextbillionai::Models::GeofenceRetrieveResponse)
      end
      def retrieve(
      ...
      sig do
        params(
          ...
          tags: String,
          request_options: Nextbillionai::RequestOptions::OrHash
        ).returns(Nextbillionai::Models::GeofenceListResponse)
      end
      def list(
        # A key is a unique identifier that is required to authenticate a request to the
        # API.
      ...
      sig do
        params(
          ...
          verbose: String,
          request_options: Nextbillionai::RequestOptions::OrHash
        ).returns(Nextbillionai::Models::GeofenceContainsResponse)
      end
      def contains(
        # A key is a unique identifier that is required to authenticate a request to the
        # API.
