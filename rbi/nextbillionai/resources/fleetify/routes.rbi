...
module Nextbillionai
  module Resources
    class Fleetify
      class Routes
        sig { returns(Nextbillionai::Resources::Fleetify::Routes::Steps) }
        attr_reader :steps
        ...
        sig do
          ...
          ).returns(Nextbillionai::Models::Fleetify::RouteCreateResponse)
        end
        def create(
        ...
        sig do
          params(
            ...
            distance: Float,
            request_options: Nextbillionai::RequestOptions::OrHash
          ).returns(Nextbillionai::Models::Fleetify::RouteRedispatchResponse)
        end
        def redispatch(
