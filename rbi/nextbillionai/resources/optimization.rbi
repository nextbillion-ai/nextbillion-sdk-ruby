...
module Nextbillionai
  module Resources
    class Optimization
      sig { returns(Nextbillionai::Resources::Optimization::DriverAssignment) }
      attr_reader :driver_assignment

      sig { returns(Nextbillionai::Resources::Optimization::V2) }
      attr_reader :v2
      ...
      sig do
        ...
        ).returns(Nextbillionai::Models::OptimizationComputeResponse)
      end
      def compute(
