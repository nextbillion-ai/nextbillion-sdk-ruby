...
module Nextbillionai
  module Resources
    class Skynet
      class Asset
        sig { returns(Nextbillionai::Resources::Skynet::Asset::Event) }
        attr_reader :event

        sig { returns(Nextbillionai::Resources::Skynet::Asset::Location) }
        ...
        sig do
          ...
          ).returns(Nextbillionai::Models::Skynet::AssetCreateResponse)
        end
        def create(
        ...
        sig do
          params(
            ...
            tags: String,
            request_options: Nextbillionai::RequestOptions::OrHash
          ).returns(Nextbillionai::Models::Skynet::AssetListResponse)
        end
        def list(
          # A key is a unique identifier that is required to authenticate a request to the
          # API.
        ...
        sig do
          params(
            ...
            key: String,
            cluster:
              Nextbillionai::Skynet::AssetDeleteParams::Cluster::OrSymbol,
            request_options: Nextbillionai::RequestOptions::OrHash
          ).returns(Nextbillionai::Skynet::SimpleResp)
        end
        def delete(
