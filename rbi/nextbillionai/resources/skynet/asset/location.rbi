    ...
    class Skynet
      class Asset
        class Location
          ...
          def list(
            # ID of the `asset` for which the location track information needs to be
            # retrieved. This is the same ID that was generated/provided at the time of
            # creating the `asset`.
            id,
          ...
          def get_last(
            # ID of the `asset` whose last location is to be retrieved. This is the same ID
