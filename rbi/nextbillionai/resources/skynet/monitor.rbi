      ...
      class Monitor
        ...
        sig do
          params(
            key: String,
            tags: T::Array[String],
            type: Nextbillionai::Skynet::MonitorCreateParams::Type::OrSymbol,
            cluster:
              Nextbillionai::Skynet::MonitorCreateParams::Cluster::OrSymbol,
            custom_id: String,
            description: String,
            geofence_config:
              Nextbillionai::Skynet::MonitorCreateParams::GeofenceConfig::OrHash,
            geofence_ids: T::Array[String],
            idle_config:
              Nextbillionai::Skynet::MonitorCreateParams::IdleConfig::OrHash,
            match_filter:
              Nextbillionai::Skynet::MonitorCreateParams::MatchFilter::OrHash,
            meta_data: T.anything,
            name: String,
            speeding_config:
              Nextbillionai::Skynet::MonitorCreateParams::SpeedingConfig::OrHash,
            request_options: Nextbillionai::RequestOptions::OrHash
          ).returns(Nextbillionai::Models::Skynet::MonitorCreateResponse)
        end
        def create(
        ...
        sig do
          params(
            ...
            key: String,
            request_options: Nextbillionai::RequestOptions::OrHash
          ).returns(Nextbillionai::Models::Skynet::MonitorRetrieveResponse)
        end
        def retrieve(
        ...
        sig do
          params(
            ...
            description: String,
            geofence_config:
              Nextbillionai::Skynet::MonitorUpdateParams::GeofenceConfig::OrHash,
            geofence_ids: T::Array[String],
            idle_config:
              Nextbillionai::Skynet::MonitorUpdateParams::IdleConfig::OrHash,
            match_filter:
              Nextbillionai::Skynet::MonitorUpdateParams::MatchFilter::OrHash,
            meta_data: T.anything,
            name: String,
            speeding_config:
              Nextbillionai::Skynet::MonitorUpdateParams::SpeedingConfig::OrHash,
            tags: T::Array[String],
            type: Nextbillionai::Skynet::MonitorUpdateParams::Type::OrSymbol,
            request_options: Nextbillionai::RequestOptions::OrHash
        ...
        sig do
          params(
            ...
            tags: String,
            request_options: Nextbillionai::RequestOptions::OrHash
          ).returns(Nextbillionai::Models::Skynet::MonitorListResponse)
        end
        def list(
          # A key is a unique identifier that is required to authenticate a request to the
          # API.
