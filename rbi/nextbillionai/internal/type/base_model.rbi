    ...
    module Type
      class BaseModel
        ...
        class << self
          ...
          sig { params(child: Nextbillionai::Internal::Type::BaseModel).void }
          def inherited(child)
          end
          ...
          sig do
            returns(
              T::Hash[
                Symbol,
                T.all(
                  Nextbillionai::Internal::Type::BaseModel::KnownField,
                  {
                    type_fn:
                      T.proc.returns(
        ...
        class << self
          ...
          sig do
            params(
              model: Nextbillionai::Internal::Type::BaseModel,
              convert: T::Boolean
            ).returns(Nextbillionai::Internal::AnyHash)
          end
        ...
        sig { overridable.returns(Nextbillionai::Internal::AnyHash) }
        def to_h
        end
