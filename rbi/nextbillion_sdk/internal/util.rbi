      ...
      class << self
        ...
        sig do
          params(url: T.any(URI::Generic, String)).returns(
            NextbillionSDK::Internal::Util::ParsedUri
          )
        end
        def parse_uri(url)
        end
        ...
        # @api private
        sig do
          params(parsed: NextbillionSDK::Internal::Util::ParsedUri).returns(
            URI::Generic
          )
        end
        ...
        sig do
          params(
            lhs: NextbillionSDK::Internal::Util::ParsedUri,
            rhs: NextbillionSDK::Internal::Util::ParsedUri
          ).returns(URI::Generic)
        end
      ...
      class << self
        ...
        sig do
          params(lines: T::Enumerable[String]).returns(
            T::Enumerable[NextbillionSDK::Internal::Util::ServerSentEvent]
          )
        end
        ...
        class << self
          ...
          sig do
            params(
              type:
                T.any(
                  NextbillionSDK::Internal::Util::SorbetRuntimeSupport,
                  T.anything
                )
            ).returns(T.anything)
          end
