...
module NextbillionSDK
  ...
  DirectionComputeRouteParams =
    NextbillionSDK::Models::DirectionComputeRouteParams
  ...
  GeocodeStructuredRetrieveParams =
    NextbillionSDK::Models::GeocodeStructuredRetrieveParams
  ...
  MdmCreateDistanceMatrixParams =
    NextbillionSDK::Models::MdmCreateDistanceMatrixParams

  MdmGetDistanceMatrixStatusParams =
    NextbillionSDK::Models::MdmGetDistanceMatrixStatusParams
  ...
  NavigationRetrieveRouteParams =
    NextbillionSDK::Models::NavigationRetrieveRouteParams
  ...
  OptimizationReOptimizeParams =
    NextbillionSDK::Models::OptimizationReOptimizeParams

  Position = NextbillionSDK::Models::Position

  PostalcodeRetrieveCoordinatesParams =
    NextbillionSDK::Models::PostalcodeRetrieveCoordinatesParams
  ...
  RestrictionListByBboxParams =
    NextbillionSDK::Models::RestrictionListByBboxParams
  ...
  RestrictionsItemListParams =
    NextbillionSDK::Models::RestrictionsItemListParams
