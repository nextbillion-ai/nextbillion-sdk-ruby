...
module NextbillionSDK
  module Resources
    class Skynet
      sig { returns(NextbillionSDK::Resources::Skynet::Asset) }
      attr_reader :asset

      sig { returns(NextbillionSDK::Resources::Skynet::Monitor) }
      attr_reader :monitor

      sig { returns(NextbillionSDK::Resources::Skynet::Trip) }
      attr_reader :trip

      sig { returns(NextbillionSDK::Resources::Skynet::NamespacedApikeys) }
      attr_reader :namespaced_apikeys

      sig { returns(NextbillionSDK::Resources::Skynet::Config) }
      attr_reader :config

      sig { returns(NextbillionSDK::Resources::Skynet::Search) }
      attr_reader :search
      ...
      sig do
        ...
        ).returns(NextbillionSDK::Models::SkynetSubscribeResponse)
      end
      def subscribe(
