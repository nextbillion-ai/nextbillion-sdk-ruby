      ...
      class Trip
        ...
        sig do
          params(
            ...
            key: String,
            cluster:
              NextbillionSDK::Skynet::TripRetrieveParams::Cluster::OrSymbol,
            request_options: NextbillionSDK::RequestOptions::OrHash
          ).returns(NextbillionSDK::Models::Skynet::TripRetrieveResponse)
        end
        def retrieve(
        ...
        sig do
          params(
            ...
            key: String,
            cluster:
              NextbillionSDK::Skynet::TripDeleteParams::Cluster::OrSymbol,
            request_options: NextbillionSDK::RequestOptions::OrHash
          ).returns(NextbillionSDK::Skynet::SimpleResp)
        end
        def delete(
        ...
        sig do
          params(
            ...
            key: String,
            cluster:
              NextbillionSDK::Skynet::TripGetSummaryParams::Cluster::OrSymbol,
            request_options: NextbillionSDK::RequestOptions::OrHash
          ).returns(NextbillionSDK::Models::Skynet::TripGetSummaryResponse)
        end
        def get_summary(
        ...
        sig do
          params(
            ...
            request_options: NextbillionSDK::RequestOptions::OrHash
          ).returns(NextbillionSDK::Models::Skynet::TripStartResponse)
        end
        def start(
          # Query param: A key is a unique identifier that is required to authenticate a
          # request to the API.
