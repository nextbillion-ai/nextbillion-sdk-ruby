  ...
  module Models
    class BatchRetrieveResponse < NextbillionSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::Models::BatchRetrieveResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[NextbillionSDK::Models::BatchRetrieveResponse::Response]
          )
        )
      end
      ...
      sig do
        params(
          responses:
            T::Array[
              NextbillionSDK::Models::BatchRetrieveResponse::Response::OrHash
            ]
        ).void
      end
      ...
      class Response < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::BatchRetrieveResponse::Response,
              NextbillionSDK::Internal::AnyHash
            )
          end
