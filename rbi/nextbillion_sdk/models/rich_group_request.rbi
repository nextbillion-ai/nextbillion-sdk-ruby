  ...
  module Models
    class RichGroupRequest < NextbillionSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::RichGroupRequest,
      ...
      sig do
        returns(
          T.nilable(NextbillionSDK::RichGroupRequest::Direction::OrSymbol)
        )
      end
      ...
      sig do
        returns(
          T.nilable(T::Array[NextbillionSDK::RichGroupRequest::Mode::OrSymbol])
        )
      end
      attr_reader :mode
        ...
        override.returns(
          {
            ...
            mode: T::Array[NextbillionSDK::RichGroupRequest::Mode::OrSymbol],
            repeat_on: String,
            segments: T::Array[NextbillionSDK::RichGroupRequest::Segment],
            speed: Float,
            speed_limit: Float,
            start_time: Float,
            tracks: T::Array[T::Array[Float]],
            turns: T::Array[NextbillionSDK::RichGroupRequest::Turn],
            weight: Integer,
            width: Integer
          }
        )
      ...
      module Direction
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, NextbillionSDK::RichGroupRequest::Direction)
          end
        ...
        sig do
          override.returns(
            T::Array[NextbillionSDK::RichGroupRequest::Direction::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      module Mode
        ...
        TaggedSymbol =
          T.type_alias { T.all(Symbol, NextbillionSDK::RichGroupRequest::Mode) }
        OrSymbol = T.type_alias { T.any(Symbol, String) }

        MODE_0W =
          T.let(:"0w", NextbillionSDK::RichGroupRequest::Mode::TaggedSymbol)
        MODE_2W =
          T.let(:"2w", NextbillionSDK::RichGroupRequest::Mode::TaggedSymbol)
        MODE_3W =
          T.let(:"3w", NextbillionSDK::RichGroupRequest::Mode::TaggedSymbol)
        MODE_4W =
          T.let(:"4w", NextbillionSDK::RichGroupRequest::Mode::TaggedSymbol)
        MODE_6W =
          T.let(:"6w", NextbillionSDK::RichGroupRequest::Mode::TaggedSymbol)

        sig do
          override.returns(
            T::Array[NextbillionSDK::RichGroupRequest::Mode::TaggedSymbol]
          )
        end
        def self.values
        end
      ...
      class Segment < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::RichGroupRequest::Segment,
              NextbillionSDK::Internal::AnyHash
            )
          end
      ...
      class Turn < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::RichGroupRequest::Turn,
              NextbillionSDK::Internal::AnyHash
            )
          end
