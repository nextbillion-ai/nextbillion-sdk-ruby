  ...
  module Models
    class IsochroneComputeParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::IsochroneComputeParams,
      ...
      sig do
        returns(
          T.nilable(NextbillionSDK::IsochroneComputeParams::Mode::OrSymbol)
        )
      end
      attr_reader :mode
      ...
      sig do
        params(
          mode: NextbillionSDK::IsochroneComputeParams::Mode::OrSymbol
        ).void
      end
      attr_writer :mode
      ...
      module Mode
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, NextbillionSDK::IsochroneComputeParams::Mode)
          end
        ...
        sig do
          override.returns(
            T::Array[NextbillionSDK::IsochroneComputeParams::Mode::TaggedSymbol]
          )
        end
        def self.values
        end
