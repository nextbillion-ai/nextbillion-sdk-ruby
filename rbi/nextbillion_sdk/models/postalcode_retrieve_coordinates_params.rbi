  ...
  module Models
    class PostalcodeRetrieveCoordinatesParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::PostalcodeRetrieveCoordinatesParams,
      ...
      sig do
        returns(
          T.nilable(NextbillionSDK::PostalcodeRetrieveCoordinatesParams::At)
        )
      end
      attr_reader :at
      ...
      sig do
        params(
          at: NextbillionSDK::PostalcodeRetrieveCoordinatesParams::At::OrHash
        ).void
      end
      attr_writer :at
      ...
      sig do
        returns(
          T.nilable(
            NextbillionSDK::PostalcodeRetrieveCoordinatesParams::Format::OrSymbol
          )
        )
      end
      attr_reader :format_
      ...
      sig do
        override.returns(
          {
            key: String,
            at: NextbillionSDK::PostalcodeRetrieveCoordinatesParams::At,
            country: String,
            format_:
              NextbillionSDK::PostalcodeRetrieveCoordinatesParams::Format::OrSymbol,
            postalcode: String,
      ...
      class At < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::PostalcodeRetrieveCoordinatesParams::At,
              NextbillionSDK::Internal::AnyHash
            )
          end
      ...
      module Format
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              NextbillionSDK::PostalcodeRetrieveCoordinatesParams::Format
            )
          end
        ...
        GEOJSON =
          T.let(
            :geojson,
            NextbillionSDK::PostalcodeRetrieveCoordinatesParams::Format::TaggedSymbol
          )
