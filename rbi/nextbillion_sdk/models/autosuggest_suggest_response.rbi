  ...
  module Models
    class AutosuggestSuggestResponse < NextbillionSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::Models::AutosuggestSuggestResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[NextbillionSDK::Models::AutosuggestSuggestResponse::Item]
          )
        )
      end
      attr_reader :items
      ...
      sig do
        params(
          items:
            T::Array[
              NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OrHash
            ]
        ).void
      end
      attr_writer :items
      ...
      class Item < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::AutosuggestSuggestResponse::Item,
              NextbillionSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            opening_hours:
              NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::AutosuggestSuggestResponse::Item::Scoring
            )
          )
        end
        attr_reader :scoring
        ...
        sig do
          params(
            scoring:
              NextbillionSDK::Models::AutosuggestSuggestResponse::Item::Scoring::OrHash
          ).void
        end
        attr_writer :scoring
        ...
        class OpeningHours < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange
                ]
              )
            )
          end
          ...
          sig do
            params(
              time_ranges:
                T::Array[
                  NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::OrHash
                ]
            ).void
          end
          ...
          class TimeRange < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                end_time:
                  NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::EndTime::OrHash
              ).void
            end
            ...
            sig do
              params(
                start_time:
                  NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::StartTime::OrHash
              ).void
            end
