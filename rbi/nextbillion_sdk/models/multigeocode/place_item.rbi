    ...
    module Multigeocode
      class PlaceItem < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Multigeocode::PlaceItem,
        ...
        sig do
          returns(T.nilable(NextbillionSDK::Multigeocode::PlaceItem::Geopoint))
        end
        attr_reader :geopoint

        sig do
          params(
            geopoint: NextbillionSDK::Multigeocode::PlaceItem::Geopoint::OrHash
          ).void
        end
        ...
        sig { returns(T.nilable(NextbillionSDK::Multigeocode::PlaceItem::Poi)) }
        attr_reader :poi

        sig do
          params(poi: NextbillionSDK::Multigeocode::PlaceItem::Poi::OrHash).void
        end
        attr_writer :poi
        ...
        sig do
          params(
            ...
            geopoint: NextbillionSDK::Multigeocode::PlaceItem::Geopoint::OrHash,
            house: String,
            poi: NextbillionSDK::Multigeocode::PlaceItem::Poi::OrHash,
            postal_code: String,
            state: String,
            street: String,
            sub_district: String
          ...
          override.returns(
            {
              ...
              country: String,
              district: String,
              geopoint: NextbillionSDK::Multigeocode::PlaceItem::Geopoint,
              house: String,
              poi: NextbillionSDK::Multigeocode::PlaceItem::Poi,
              postal_code: String,
              state: String,
              street: String,
              sub_district: String
        ...
        class Geopoint < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Multigeocode::PlaceItem::Geopoint,
                NextbillionSDK::Internal::AnyHash
              )
            end
        ...
        class Poi < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Multigeocode::PlaceItem::Poi,
                NextbillionSDK::Internal::AnyHash
              )
            end
