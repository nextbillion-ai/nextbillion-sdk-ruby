    ...
    module Multigeocode
      class PlaceCreateParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Multigeocode::PlaceCreateParams,
        ...
        sig do
          returns(
            T::Array[NextbillionSDK::Multigeocode::PlaceCreateParams::Place]
          )
        end
        attr_accessor :place
          ...
          override.returns(
            {
              ...
              place:
                T::Array[
                  NextbillionSDK::Multigeocode::PlaceCreateParams::Place
                ],
              data_source:
                NextbillionSDK::Multigeocode::PlaceCreateParams::DataSource,
              force: T::Boolean,
        ...
        class Place < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              NextbillionSDK::Multigeocode::PlaceCreateParams::Place::Geopoint
            )
          end
          ...
          sig do
            params(
              geopoint:
                NextbillionSDK::Multigeocode::PlaceCreateParams::Place::Geopoint::OrHash
            ).void
          end
          ...
          sig do
            params(
              poi:
                NextbillionSDK::Multigeocode::PlaceCreateParams::Place::Poi::OrHash
            ).void
          end
          attr_writer :poi
        ...
        class DataSource < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Multigeocode::PlaceCreateParams::DataSource::Status::OrSymbol
              )
            )
          end
          attr_reader :status
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Multigeocode::PlaceCreateParams::DataSource::Status
                )
              end
            ...
            ENABLE =
              T.let(
                :enable,
                NextbillionSDK::Multigeocode::PlaceCreateParams::DataSource::Status::TaggedSymbol
              )
            DISABLE =
              T.let(
                :disable,
