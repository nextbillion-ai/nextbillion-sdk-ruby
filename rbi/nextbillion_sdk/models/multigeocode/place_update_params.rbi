    ...
    module Multigeocode
      class PlaceUpdateParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Multigeocode::PlaceUpdateParams,
        ...
        class DataSource < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Multigeocode::PlaceUpdateParams::DataSource::Status::OrSymbol
              )
            )
          end
          attr_reader :status
          ...
          module Status
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Multigeocode::PlaceUpdateParams::DataSource::Status
                )
              end
            ...
            ENABLE =
              T.let(
                :enable,
                NextbillionSDK::Multigeocode::PlaceUpdateParams::DataSource::Status::TaggedSymbol
              )
            DISABLE =
              T.let(
                :disable,
