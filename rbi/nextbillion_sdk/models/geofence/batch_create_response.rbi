    ...
    module Geofence
      class BatchCreateResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Geofence::BatchCreateResponse,
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::Geofence::BatchCreateResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              NextbillionSDK::Models::Geofence::BatchCreateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: NextbillionSDK::Models::Geofence::BatchCreateResponse::Data,
              status: String
            }
          )
        end
