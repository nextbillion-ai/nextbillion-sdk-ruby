  ...
  module Models
    class MdmCreateDistanceMatrixParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::MdmCreateDistanceMatrixParams,
      ...
      sig do
        returns(NextbillionSDK::MdmCreateDistanceMatrixParams::Option::OrSymbol)
      end
      ...
      sig do
        returns(
          T.nilable(
            NextbillionSDK::MdmCreateDistanceMatrixParams::Area::OrSymbol
          )
        )
      end
      attr_reader :area
      ...
      sig do
        returns(
          T.nilable(
            NextbillionSDK::MdmCreateDistanceMatrixParams::Avoid::OrSymbol
          )
        )
      end
      attr_reader :avoid
      ...
      sig do
        returns(
          T.nilable(
            NextbillionSDK::MdmCreateDistanceMatrixParams::Mode::OrSymbol
          )
        )
      end
      attr_reader :mode
      ...
      module Option
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, NextbillionSDK::MdmCreateDistanceMatrixParams::Option)
          end
        ...
        FLEXIBLE =
          T.let(
            :flexible,
            NextbillionSDK::MdmCreateDistanceMatrixParams::Option::TaggedSymbol
          )
      ...
      module Spliter
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              NextbillionSDK::MdmCreateDistanceMatrixParams::Spliter
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        OD_NUMBER_SPLITER =
          T.let(
            :od_number_spliter,
            NextbillionSDK::MdmCreateDistanceMatrixParams::Spliter::TaggedSymbol
          )
        STRAIGHT_DISTANCE_SPLITER =
          T.let(
            :straight_distance_spliter,
      ...
      module Area
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, NextbillionSDK::MdmCreateDistanceMatrixParams::Area)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
        ...
        SINGAPORE =
          T.let(
            :singapore,
            NextbillionSDK::MdmCreateDistanceMatrixParams::Area::TaggedSymbol
          )
        USA =
          T.let(
            :usa,
      ...
      module Avoid
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, NextbillionSDK::MdmCreateDistanceMatrixParams::Avoid)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module DestinationsApproach
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              NextbillionSDK::MdmCreateDistanceMatrixParams::DestinationsApproach
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module HazmatType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              NextbillionSDK::MdmCreateDistanceMatrixParams::HazmatType
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module Mode
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(Symbol, NextbillionSDK::MdmCreateDistanceMatrixParams::Mode)
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module OriginsApproach
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              NextbillionSDK::MdmCreateDistanceMatrixParams::OriginsApproach
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      module RouteType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              NextbillionSDK::MdmCreateDistanceMatrixParams::RouteType
            )
          end
        OrSymbol = T.type_alias { T.any(Symbol, String) }
