    ...
    module Fleetify
      class DocumentTemplateRetrieveResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Fleetify::DocumentTemplateRetrieveResponse,
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::Fleetify::DocumentTemplateRetrieveResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              NextbillionSDK::Models::Fleetify::DocumentTemplateRetrieveResponse::Data::OrHash
          ).void
        end
        attr_writer :data
