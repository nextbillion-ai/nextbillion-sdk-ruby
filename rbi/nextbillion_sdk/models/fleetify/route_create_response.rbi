    ...
    module Fleetify
      class RouteCreateResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Fleetify::RouteCreateResponse,
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data,
              status: Integer
            }
          )
        end
        ...
        class Data < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data::Driver
              )
            )
          end
          attr_reader :driver
          ...
          sig do
            params(
              driver:
                NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data::Driver::OrHash
            ).void
          end
          attr_writer :driver
          ...
          sig do
            returns(
              T.nilable(
                T::Array[NextbillionSDK::Fleetify::Routes::RouteStepsResponse]
              )
            )
          end
          attr_reader :steps
