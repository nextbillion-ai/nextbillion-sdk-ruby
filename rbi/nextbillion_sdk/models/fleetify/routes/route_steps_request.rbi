      ...
      module Routes
        class RouteStepsRequest < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Fleetify::Routes::RouteStepsRequest,
          ...
          sig do
            returns(
              NextbillionSDK::Fleetify::Routes::RouteStepsRequest::Type::OrSymbol
            )
          end
          attr_accessor :type
          ...
          sig do
            params(
              meta:
                NextbillionSDK::Fleetify::Routes::RouteStepsRequest::Meta::OrHash
            ).void
          end
          attr_writer :meta
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Fleetify::Routes::RouteStepsRequest::Type
                )
              end
            ...
            START =
              T.let(
                :start,
                NextbillionSDK::Fleetify::Routes::RouteStepsRequest::Type::TaggedSymbol
              )
            JOB =
              T.let(
                :job,
