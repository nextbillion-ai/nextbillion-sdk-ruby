      ...
      module Routes
        class StepUpdateParams < NextbillionSDK::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Fleetify::Routes::StepUpdateParams,
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Fleetify::Routes::StepUpdateParams::Meta
              )
            )
          end
          attr_reader :meta
            ...
            override.returns(
              {
                ...
                geofence_config:
                  NextbillionSDK::Fleetify::Routes::RouteStepGeofenceConfig,
                location: T::Array[Float],
                meta: NextbillionSDK::Fleetify::Routes::StepUpdateParams::Meta,
                type:
                  NextbillionSDK::Fleetify::Routes::StepUpdateParams::Type::OrSymbol,
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Fleetify::Routes::StepUpdateParams::Type
                )
              end
            ...
            START =
              T.let(
                :start,
                NextbillionSDK::Fleetify::Routes::StepUpdateParams::Type::TaggedSymbol
              )
            JOB =
              T.let(
                :job,
