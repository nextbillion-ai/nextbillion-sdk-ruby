      ...
      module Routes
        class RouteStepGeofenceConfig < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Fleetify::Routes::RouteStepGeofenceConfig::Type::OrSymbol
              )
            )
          end
          attr_reader :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Fleetify::Routes::RouteStepGeofenceConfig::Type
                )
              end
            ...
            CIRCLE =
              T.let(
                :circle,
                NextbillionSDK::Fleetify::Routes::RouteStepGeofenceConfig::Type::TaggedSymbol
              )
