    ...
    module Fleetify
      class RouteRedispatchResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Fleetify::RouteRedispatchResponse,
        ...
        sig do
          params(
            data:
              NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              completion:
                NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Completion::OrHash
            ).void
          end
          ...
          sig do
            params(
              driver:
                NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Driver::OrHash
            ).void
          end
          attr_writer :driver
          ...
          sig { returns(T.nilable(NextbillionSDK::Fleetify::RoutingResponse)) }
          attr_reader :routing

          sig do
            params(
              routing: NextbillionSDK::Fleetify::RoutingResponse::OrHash
            ).void
          end
          attr_writer :routing
          ...
          sig do
            params(
              steps:
                NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps::OrHash
            ).void
          end
          attr_writer :steps
          ...
          class Completion < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                status:
                  NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Completion::Status::OrSymbol
              ).void
            end
            attr_writer :status
          ...
          class Steps < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                completion:
                  NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps::Completion::OrHash
              ).void
            end
            attr_writer :completion
            ...
            sig do
              params(
                meta:
                  NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps::Meta::OrHash
              ).void
            end
            attr_writer :meta
