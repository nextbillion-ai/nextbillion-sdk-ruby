  ...
  module Models
    module Fleetify
      class DocumentTemplateContentRequest < NextbillionSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            NextbillionSDK::Fleetify::DocumentTemplateContentRequest::Type::OrSymbol
          )
        end
        attr_accessor :type
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Fleetify::DocumentTemplateContentRequest::Meta
            )
          )
        end
        attr_reader :meta
        ...
        sig do
          params(
            meta:
              NextbillionSDK::Fleetify::DocumentTemplateContentRequest::Meta::OrHash
          ).void
        end
        attr_writer :meta
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Fleetify::DocumentTemplateContentRequest::Validation
            )
          )
        end
        ...
        sig do
          params(
            validation:
              NextbillionSDK::Fleetify::DocumentTemplateContentRequest::Validation::OrHash
          ).void
        end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                NextbillionSDK::Fleetify::DocumentTemplateContentRequest::Type
              )
            end
        ...
        class Meta < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T::Array[
                NextbillionSDK::Fleetify::DocumentTemplateContentRequest::Meta::Option
              ]
            )
          end
          ...
          sig do
            params(
              options:
                T::Array[
                  NextbillionSDK::Fleetify::DocumentTemplateContentRequest::Meta::Option::OrHash
                ]
            ).returns(T.attached_class)
          end
          def self.new(
