    ...
    module Fleetify
      class DocumentTemplateCreateResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Fleetify::DocumentTemplateCreateResponse,
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::Fleetify::DocumentTemplateCreateResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              NextbillionSDK::Models::Fleetify::DocumentTemplateCreateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
