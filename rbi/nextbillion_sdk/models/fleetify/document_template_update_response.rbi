    ...
    module Fleetify
      class DocumentTemplateUpdateResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Fleetify::DocumentTemplateUpdateResponse,
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::Fleetify::DocumentTemplateUpdateResponse::Data
            )
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              NextbillionSDK::Models::Fleetify::DocumentTemplateUpdateResponse::Data::OrHash
          ).void
        end
        attr_writer :data
