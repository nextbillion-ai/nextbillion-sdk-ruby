  ...
  module Models
    class GeofenceContainsResponse < NextbillionSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::Models::GeofenceContainsResponse,
      ...
      sig do
        returns(
          T.nilable(NextbillionSDK::Models::GeofenceContainsResponse::Data)
        )
      end
      attr_reader :data
      ...
      sig do
        params(
          data: NextbillionSDK::Models::GeofenceContainsResponse::Data::OrHash
        ).void
      end
      attr_writer :data
      ...
      class Data < NextbillionSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                NextbillionSDK::Models::GeofenceContainsResponse::Data::ResultList
              ]
            )
          )
        end
        ...
        sig do
          params(
            result_list:
              T::Array[
                NextbillionSDK::Models::GeofenceContainsResponse::Data::ResultList::OrHash
              ]
          ).void
        end
        ...
        class ResultList < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            params(geofence_detail: NextbillionSDK::GeofenceAPI::OrHash).void
          end
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  NextbillionSDK::Models::GeofenceContainsResponse::Data::ResultList::Result
                ]
              )
            )
          end
          ...
          sig do
            params(
              result:
                T::Array[
                  NextbillionSDK::Models::GeofenceContainsResponse::Data::ResultList::Result::OrHash
                ]
            ).void
          end
          attr_writer :result
          ...
          sig do
            params(
              geofence_detail: NextbillionSDK::GeofenceAPI::OrHash,
              geofence_id: String,
              result:
                T::Array[
                  NextbillionSDK::Models::GeofenceContainsResponse::Data::ResultList::Result::OrHash
