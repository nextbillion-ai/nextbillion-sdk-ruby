  ...
  module Models
    class AutocompleteSuggestResponse < NextbillionSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::Models::AutocompleteSuggestResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[NextbillionSDK::Models::AutocompleteSuggestResponse::Item]
          )
        )
      end
      attr_reader :items
      ...
      sig do
        params(
          items:
            T::Array[
              NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OrHash
            ]
        ).void
      end
      attr_writer :items
        ...
        override.returns(
          {
            items:
              T::Array[
                NextbillionSDK::Models::AutocompleteSuggestResponse::Item
              ]
          }
        )
      end
      ...
      class Item < NextbillionSDK::Internal::Type::BaseModel
        ...
        sig do
          params(
            opening_hours:
              NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::AutocompleteSuggestResponse::Item::Scoring
            )
          )
        end
        attr_reader :scoring
        ...
        sig do
          params(
            scoring:
              NextbillionSDK::Models::AutocompleteSuggestResponse::Item::Scoring::OrHash
          ).void
        end
        attr_writer :scoring
        ...
        class OpeningHours < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange
                ]
              )
            )
          end
          ...
          sig do
            params(
              time_ranges:
                T::Array[
                  NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange::OrHash
                ]
            ).void
          end
          ...
          class TimeRange < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                end_time:
                  NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange::EndTime::OrHash
              ).void
            end
            ...
            sig do
              params(
                start_time:
                  NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange::StartTime::OrHash
              ).void
            end
