    ...
    module Optimization
      class Job < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Optimization::Job,
        ...
        sig { returns(T.nilable(NextbillionSDK::Optimization::Job::Volume)) }
        attr_reader :volume

        sig do
          params(volume: NextbillionSDK::Optimization::Job::Volume::OrHash).void
        end
        attr_writer :volume
        ...
        sig do
          params(
            ...
            volume: NextbillionSDK::Optimization::Job::Volume::OrHash,
        ...
        class Volume < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Optimization::Job::Volume::Alignment::OrSymbol
              )
            )
          end
          ...
          module Alignment
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Optimization::Job::Volume::Alignment
                )
              end
            ...
            STRICT =
              T.let(
                :"`strict`",
                NextbillionSDK::Optimization::Job::Volume::Alignment::TaggedSymbol
              )
            PARALLEL =
              T.let(
                :"`parallel`",
