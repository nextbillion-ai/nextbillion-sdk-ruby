    ...
    module Optimization
      class Shipment < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Optimization::Shipment,
              NextbillionSDK::Internal::AnyHash
            )
          end

        # Specify the details of the delivery step of the shipment.
        sig { returns(NextbillionSDK::Optimization::Shipment::Delivery) }
        attr_reader :delivery

        sig do
          params(
            delivery: NextbillionSDK::Optimization::Shipment::Delivery::OrHash
          ).void
        end
        attr_writer :delivery

        # Specify the details of the pickup step of the shipment.
        sig { returns(NextbillionSDK::Optimization::Shipment::Pickup) }
        attr_reader :pickup

        sig do
          params(
            pickup: NextbillionSDK::Optimization::Shipment::Pickup::OrHash
          ).void
        end
        attr_writer :pickup
        ...
        sig do
          returns(T.nilable(NextbillionSDK::Optimization::Shipment::Volume))
        end
        attr_reader :volume

        sig do
          params(
            volume: NextbillionSDK::Optimization::Shipment::Volume::OrHash
          ).void
        end
        attr_writer :volume
        ...
        sig do
          override.returns(
            {
              delivery: NextbillionSDK::Optimization::Shipment::Delivery,
              pickup: NextbillionSDK::Optimization::Shipment::Pickup,
              amount: T::Array[Integer],
              follow_lifo_order: T::Boolean,
              incompatible_load_types: T::Array[String],
              joint_order: Integer,
              ...
              revenue: Integer,
              skills: T::Array[Integer],
              volume: NextbillionSDK::Optimization::Shipment::Volume,
              zones: T::Array[Integer]
            }
          )
        end
        ...
        class Delivery < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Optimization::Shipment::Delivery,
                NextbillionSDK::Internal::AnyHash
              )
            end
        ...
        class Pickup < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Optimization::Shipment::Pickup,
                NextbillionSDK::Internal::AnyHash
              )
            end
        ...
        class Volume < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Optimization::Shipment::Volume,
                NextbillionSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Optimization::Shipment::Volume::Alignment::OrSymbol
              )
            )
          end
          ...
          module Alignment
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Optimization::Shipment::Volume::Alignment
                )
              end
