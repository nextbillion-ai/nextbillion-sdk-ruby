    ...
    module Optimization
      class Vehicle < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Optimization::Vehicle,
        ...
        sig { returns(NextbillionSDK::Optimization::Vehicle::Location) }
        attr_reader :location

        sig do
          params(
            location: NextbillionSDK::Optimization::Vehicle::Location::OrHash
          ).void
        end
        ...
        sig do
          returns(T.nilable(T::Array[NextbillionSDK::Optimization::Location]))
        end
        ...
        sig do
          params(
            remaining_waypoints:
              T::Array[NextbillionSDK::Optimization::Location::OrHash]
          ).void
        end
        ...
        sig do
          override.returns(
            {
              id: String,
              location: NextbillionSDK::Optimization::Vehicle::Location,
              attributes: T.anything,
              priority: Integer,
              remaining_waypoints:
                T::Array[NextbillionSDK::Optimization::Location]
            }
          )
        end
        def to_hash
        ...
        class Location < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Optimization::Vehicle::Location,
                NextbillionSDK::Internal::AnyHash
              )
            end
