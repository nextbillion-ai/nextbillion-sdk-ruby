    ...
    module Optimization
      class V2RetrieveResultResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Optimization::V2RetrieveResultResponse,
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result
            )
          )
        end
        attr_reader :result
        ...
        sig do
          params(
            result:
              NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::OrHash
          ).void
        end
        attr_writer :result
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Status::TaggedSymbol
            )
          )
        end
        attr_reader :status
        ...
        sig do
          params(
            status:
              NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Status::OrSymbol
          ).void
        end
        attr_writer :status
        ...
        class Result < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              routes:
                T::Array[
                  NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route::OrHash
                ]
            ).void
          end
          attr_writer :routes
          ...
          sig do
            params(
              summary:
                NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Summary::OrHash
            ).void
          end
          attr_writer :summary
          ...
          sig do
            params(
              unassigned:
                T::Array[
                  NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Unassigned::OrHash
                ]
            ).void
          end
          ...
          class Route < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                steps:
                  T::Array[
                    NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route::Step::OrHash
                  ]
              ).void
            end
            attr_writer :steps
        ...
        module Status
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Status
              )
            end
