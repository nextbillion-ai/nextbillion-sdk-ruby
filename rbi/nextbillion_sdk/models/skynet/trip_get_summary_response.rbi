    ...
    module Skynet
      class TripGetSummaryResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Skynet::TripGetSummaryResponse,
        ...
        sig do
          params(
            data:
              NextbillionSDK::Models::Skynet::TripGetSummaryResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        class Data < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            params(
              trip:
                NextbillionSDK::Models::Skynet::TripGetSummaryResponse::Data::Trip::OrHash
            ).void
          end
          attr_writer :trip
          ...
          class Trip < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                id: String,
                asset: NextbillionSDK::Skynet::AssetDetails::OrHash,
                asset_id: String,
