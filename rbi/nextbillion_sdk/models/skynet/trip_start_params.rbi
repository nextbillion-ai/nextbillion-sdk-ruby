    ...
    module Skynet
      class TripStartParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Skynet::TripStartParams,
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Skynet::TripStartParams::Cluster::OrSymbol
            )
          )
        end
        attr_reader :cluster
        ...
        sig do
          params(
            cluster: NextbillionSDK::Skynet::TripStartParams::Cluster::OrSymbol
          ).void
        end
        attr_writer :cluster
        ...
        sig do
          returns(
            T.nilable(T::Array[NextbillionSDK::Skynet::TripStartParams::Stop])
          )
        end
        attr_reader :stops
        ...
        sig do
          params(
            stops:
              T::Array[NextbillionSDK::Skynet::TripStartParams::Stop::OrHash]
          ).void
        end
        attr_writer :stops
          ...
          override.returns(
            {
              ...
              meta_data: T.anything,
              name: String,
              stops: T::Array[NextbillionSDK::Skynet::TripStartParams::Stop],
        ...
        module Cluster
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, NextbillionSDK::Skynet::TripStartParams::Cluster)
            end
          ...
          AMERICA =
            T.let(
              :america,
              NextbillionSDK::Skynet::TripStartParams::Cluster::TaggedSymbol
            )
        ...
        class Stop < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Skynet::TripStartParams::Stop,
                NextbillionSDK::Internal::AnyHash
              )
            end
