...
module NextbillionSDK
  module Models
    module Skynet
      class AssetListParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Skynet::AssetListParams,
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Skynet::AssetListParams::Cluster::OrSymbol
            )
          )
        end
        attr_reader :cluster
        ...
        module Cluster
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, NextbillionSDK::Skynet::AssetListParams::Cluster)
            end
          ...
          AMERICA =
            T.let(
              :america,
              NextbillionSDK::Skynet::AssetListParams::Cluster::TaggedSymbol
            )
