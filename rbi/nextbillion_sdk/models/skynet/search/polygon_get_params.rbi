      ...
      module Search
        class PolygonGetParams < NextbillionSDK::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Skynet::Search::PolygonGetParams,
          ...
          module SortBy
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Skynet::Search::PolygonGetParams::SortBy
                )
              end
            ...
            DISTANCE =
              T.let(
                :distance,
                NextbillionSDK::Skynet::Search::PolygonGetParams::SortBy::TaggedSymbol
              )
            DURATION =
              T.let(
                :duration,
          ...
          module SortDrivingMode
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Skynet::Search::PolygonGetParams::SortDrivingMode
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            CAR =
              T.let(
                :car,
                NextbillionSDK::Skynet::Search::PolygonGetParams::SortDrivingMode::TaggedSymbol
              )
            TRUCK =
              T.let(
                :truck,
