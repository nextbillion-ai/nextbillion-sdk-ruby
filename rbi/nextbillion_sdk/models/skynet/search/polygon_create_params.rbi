      ...
      module Search
        class PolygonCreateParams < NextbillionSDK::Internal::Type::BaseModel
          ...
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Skynet::Search::PolygonCreateParams,
          ...
          sig do
            returns(
              NextbillionSDK::Skynet::Search::PolygonCreateParams::Polygon
            )
          end
          attr_reader :polygon
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Skynet::Search::PolygonCreateParams::MatchFilter
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort
              )
            )
          end
          attr_reader :sort
            ...
            override.returns(
              {
                ...
                pn: Integer,
                ps: Integer,
                sort: NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort,
          ...
          class Sort < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortBy::OrSymbol
                )
              )
            end
            attr_reader :sort_by
            ...
            sig do
              params(
                sort_destination:
                  NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortDestination::OrHash
              ).void
            end
            ...
            sig do
              returns(
                T.nilable(
                  NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortDrivingMode::OrSymbol
                )
              )
            end
            ...
            module SortBy
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortBy
                  )
                end
              ...
              DISTANCE =
                T.let(
                  :distance,
                  NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortBy::TaggedSymbol
                )
              DURATION =
                T.let(
                  :duration,
            ...
            module SortDrivingMode
              ...
              TaggedSymbol =
                T.type_alias do
                  T.all(
                    Symbol,
                    NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortDrivingMode
                  )
                end
              OrSymbol = T.type_alias { T.any(Symbol, String) }
              ...
              CAR =
                T.let(
                  :car,
                  NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortDrivingMode::TaggedSymbol
                )
              TRUCK =
                T.let(
                  :truck,
