  ...
  module Models
    module Skynet
      class AssetDetails < NextbillionSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(NextbillionSDK::Skynet::AssetDetails::LatestLocation)
          )
        end
        ...
        sig do
          params(
            latest_location:
              NextbillionSDK::Skynet::AssetDetails::LatestLocation::OrHash
          ).void
        end
          ...
          override.returns(
            {
              ...
              device_id: String,
              latest_location:
                NextbillionSDK::Skynet::AssetDetails::LatestLocation,
              meta_data: T.anything,
              name: String,
              state: String,
              tags: T::Array[String],
        ...
        class LatestLocation < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Skynet::AssetDetails::LatestLocation::Location
              )
            )
          end
          ...
          sig do
            params(
              location:
                NextbillionSDK::Skynet::AssetDetails::LatestLocation::Location::OrHash
            ).void
          end
