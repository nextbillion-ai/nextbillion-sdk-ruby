    ...
    module Skynet
      class AssetCreateParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Skynet::AssetCreateParams,
        ...
        module Cluster
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, NextbillionSDK::Skynet::AssetCreateParams::Cluster)
            end
          ...
          AMERICA =
            T.let(
              :america,
              NextbillionSDK::Skynet::AssetCreateParams::Cluster::TaggedSymbol
            )
