    ...
    module Skynet
      class TripStartResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Skynet::TripStartResponse,
        ...
        sig do
          returns(
            T.nilable(NextbillionSDK::Models::Skynet::TripStartResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              NextbillionSDK::Models::Skynet::TripStartResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: NextbillionSDK::Models::Skynet::TripStartResponse::Data,
              message: String,
              status: String
            }
          )
        ...
        class Data < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Models::Skynet::TripStartResponse::Data,
                NextbillionSDK::Internal::AnyHash
              )
            end
