      ...
      module Asset
        class EventListResponse < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Models::Skynet::Asset::EventListResponse,
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data
              )
            )
          end
          attr_reader :data
          ...
          sig do
            params(
              data:
                NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::OrHash
            ).void
          end
          attr_writer :data
          ...
          class Data < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  T::Array[
                    NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List
                  ]
                )
              )
            end
            ...
            sig do
              params(
                list:
                  T::Array[
                    NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::OrHash
                  ]
              ).void
            end
            attr_writer :list
            ...
            class List < NextbillionSDK::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::EventType::TaggedSymbol
                  )
                )
              end
              ...
              sig do
                params(
                  event_type:
                    NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::EventType::OrSymbol
                ).void
              end
              ...
              sig do
                params(
                  prev_location:
                    NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation::OrHash
                ).void
              end
              ...
              sig do
                params(
                  triggered_location:
                    NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation::OrHash
                ).void
              end
              ...
              module EventType
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::EventType
                    )
                  end
              ...
              class PrevLocation < NextbillionSDK::Internal::Type::BaseModel
                ...
                sig do
                  params(
                    location:
                      NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation::Location::OrHash
                  ).void
                end
              ...
              class TriggeredLocation < NextbillionSDK::Internal::Type::BaseModel
                ...
                sig do
                  params(
                    location:
                      NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation::Location::OrHash
                  ).void
                end
                attr_writer :location
