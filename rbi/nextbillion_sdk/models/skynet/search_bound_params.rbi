    ...
    module Skynet
      class SearchBoundParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Skynet::SearchBoundParams,
        ...
        sig do
          params(
            sort_by: NextbillionSDK::Skynet::SearchBoundParams::SortBy::OrSymbol
          ).void
        end
        attr_writer :sort_by
        ...
        module SortBy
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, NextbillionSDK::Skynet::SearchBoundParams::SortBy)
            end
          ...
          DISTANCE =
            T.let(
              :distance,
              NextbillionSDK::Skynet::SearchBoundParams::SortBy::TaggedSymbol
            )
          DURATION =
            T.let(
              :duration,
        ...
        module SortDrivingMode
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(
                Symbol,
                NextbillionSDK::Skynet::SearchBoundParams::SortDrivingMode
              )
            end
          OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          CAR =
            T.let(
              :car,
              NextbillionSDK::Skynet::SearchBoundParams::SortDrivingMode::TaggedSymbol
            )
          TRUCK =
            T.let(
              :truck,
