    ...
    module Skynet
      class AssetUpdateParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Skynet::AssetUpdateParams,
        ...
        module Cluster
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, NextbillionSDK::Skynet::AssetUpdateParams::Cluster)
            end
          ...
          AMERICA =
            T.let(
              :america,
              NextbillionSDK::Skynet::AssetUpdateParams::Cluster::TaggedSymbol
            )
