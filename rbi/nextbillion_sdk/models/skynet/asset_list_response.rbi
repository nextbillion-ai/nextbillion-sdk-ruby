    ...
    module Skynet
      class AssetListResponse < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::Skynet::AssetListResponse,
        ...
        sig do
          returns(
            T.nilable(NextbillionSDK::Models::Skynet::AssetListResponse::Data)
          )
        end
        attr_reader :data
        ...
        sig do
          params(
            data:
              NextbillionSDK::Models::Skynet::AssetListResponse::Data::OrHash
          ).void
        end
        attr_writer :data
        ...
        sig do
          override.returns(
            {
              data: NextbillionSDK::Models::Skynet::AssetListResponse::Data,
              message: String,
              status: String
            }
          )
        ...
        class Data < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Models::Skynet::AssetListResponse::Data,
                NextbillionSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(T.nilable(T::Array[NextbillionSDK::Skynet::AssetDetails]))
          end
          attr_reader :list

          sig do
            params(
              list: T::Array[NextbillionSDK::Skynet::AssetDetails::OrHash]
            ).void
          end
          attr_writer :list
          ...
          sig do
            override.returns(
              {
                list: T::Array[NextbillionSDK::Skynet::AssetDetails],
