    ...
    module Skynet
      class SkynetMonitor < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Skynet::SkynetMonitor,
        ...
        sig do
          returns(
            T.nilable(NextbillionSDK::Skynet::SkynetMonitor::GeofenceConfig)
          )
        end
        ...
        sig do
          params(
            geofence_config:
              NextbillionSDK::Skynet::SkynetMonitor::GeofenceConfig::OrHash
          ).void
        end
        ...
        # of monitor.
        sig do
          returns(T.nilable(NextbillionSDK::Skynet::SkynetMonitor::IdleConfig))
        end
        ...
        sig do
          params(
            idle_config:
              NextbillionSDK::Skynet::SkynetMonitor::IdleConfig::OrHash
          ).void
        end
        ...
        sig do
          returns(T.nilable(NextbillionSDK::Skynet::SkynetMonitor::MatchFilter))
        end
        ...
        sig do
          params(
            match_filter:
              NextbillionSDK::Skynet::SkynetMonitor::MatchFilter::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(NextbillionSDK::Skynet::SkynetMonitor::SpeedingConfig)
          )
        end
        ...
        sig do
          params(
            speeding_config:
              NextbillionSDK::Skynet::SkynetMonitor::SpeedingConfig::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(NextbillionSDK::Skynet::SkynetMonitor::Type::TaggedSymbol)
          )
        end
        attr_reader :type
        ...
        sig do
          params(
            type: NextbillionSDK::Skynet::SkynetMonitor::Type::OrSymbol
          ).void
        end
        attr_writer :type
          ...
          override.returns(
            {
              ...
              description: String,
              geofence_config:
                NextbillionSDK::Skynet::SkynetMonitor::GeofenceConfig,
              geofences: T::Array[String],
              idle_config: NextbillionSDK::Skynet::SkynetMonitor::IdleConfig,
              match_filter: NextbillionSDK::Skynet::SkynetMonitor::MatchFilter,
              meta_data: T.anything,
              name: String,
              speeding_config:
                NextbillionSDK::Skynet::SkynetMonitor::SpeedingConfig,
              tags: T::Array[String],
              type: NextbillionSDK::Skynet::SkynetMonitor::Type::TaggedSymbol,
              updated_at: Integer
            }
          )
        end
        ...
        class IdleConfig < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Skynet::SkynetMonitor::IdleConfig,
                NextbillionSDK::Internal::AnyHash
              )
            end
        ...
        class MatchFilter < NextbillionSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                NextbillionSDK::Skynet::SkynetMonitor::MatchFilter,
                NextbillionSDK::Internal::AnyHash
              )
            end
        ...
        module Type
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, NextbillionSDK::Skynet::SkynetMonitor::Type)
            end
          ...
          ENTER =
            T.let(
              :enter,
              NextbillionSDK::Skynet::SkynetMonitor::Type::TaggedSymbol
            )
          EXIT =
            T.let(
              :exit,
