  ...
  module Models
    class RevgeocodeRetrieveResponse < NextbillionSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::Models::RevgeocodeRetrieveResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[NextbillionSDK::Models::RevgeocodeRetrieveResponse::Item]
          )
        )
      end
      attr_reader :items
      ...
      sig do
        params(
          items:
            T::Array[
              NextbillionSDK::Models::RevgeocodeRetrieveResponse::Item::OrHash
            ]
        ).void
      end
      attr_writer :items
      ...
      class Item < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::RevgeocodeRetrieveResponse::Item,
              NextbillionSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            opening_hours:
              NextbillionSDK::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::OrHash
          ).void
        end
        ...
        sig do
          params(
            scoring:
              NextbillionSDK::Models::RevgeocodeRetrieveResponse::Item::Scoring::OrHash
          ).void
        end
        attr_writer :scoring
        ...
        class OpeningHours < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  NextbillionSDK::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange
                ]
              )
            )
          end
          ...
          sig do
            params(
              time_ranges:
                T::Array[
                  NextbillionSDK::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange::OrHash
                ]
            ).void
          end
          ...
          class TimeRange < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                end_time:
                  NextbillionSDK::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange::EndTime::OrHash
              ).void
            end
            ...
            sig do
              params(
                start_time:
                  NextbillionSDK::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange::StartTime::OrHash
              ).void
            end
