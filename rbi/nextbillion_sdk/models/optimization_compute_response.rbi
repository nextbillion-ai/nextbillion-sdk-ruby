  ...
  module Models
    class OptimizationComputeResponse < NextbillionSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::Models::OptimizationComputeResponse,
      ...
      sig do
        returns(
          T.nilable(
            NextbillionSDK::Models::OptimizationComputeResponse::Location
          )
        )
      end
      ...
      sig do
        params(
          location:
            NextbillionSDK::Models::OptimizationComputeResponse::Location::OrHash
        ).void
      end
      ...
      sig do
        returns(
          T.nilable(
            T::Array[NextbillionSDK::Models::OptimizationComputeResponse::Trip]
          )
        )
      end
      attr_reader :trips
      ...
      sig do
        params(
          trips:
            T::Array[
              NextbillionSDK::Models::OptimizationComputeResponse::Trip::OrHash
            ]
        ).void
      end
      attr_writer :trips
      ...
      sig do
        returns(
          T.nilable(
            T::Array[
              NextbillionSDK::Models::OptimizationComputeResponse::Waypoint
            ]
          )
        )
      end
      ...
      sig do
        params(
          waypoints:
            T::Array[
              NextbillionSDK::Models::OptimizationComputeResponse::Waypoint::OrHash
            ]
        ).void
      end
        ...
        override.returns(
          {
            ...
            trips:
              T::Array[
                NextbillionSDK::Models::OptimizationComputeResponse::Trip
              ],
            waypoints:
              T::Array[
                NextbillionSDK::Models::OptimizationComputeResponse::Waypoint
      ...
      class Trip < NextbillionSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::OptimizationComputeResponse::Trip::Geojson
            )
          )
        end
        attr_reader :geojson
        ...
        sig do
          params(
            geojson:
              NextbillionSDK::Models::OptimizationComputeResponse::Trip::Geojson::OrHash
          ).void
        end
        attr_writer :geojson
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                NextbillionSDK::Models::OptimizationComputeResponse::Trip::Leg
              ]
            )
          )
        end
        ...
        sig do
          params(
            legs:
              T::Array[
                NextbillionSDK::Models::OptimizationComputeResponse::Trip::Leg::OrHash
              ]
          ).void
        end
        attr_writer :legs
        ...
        class Geojson < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                NextbillionSDK::Models::OptimizationComputeResponse::Trip::Geojson::Type::TaggedSymbol
              )
            )
          end
          attr_reader :type
          ...
          sig do
            params(
              type:
                NextbillionSDK::Models::OptimizationComputeResponse::Trip::Geojson::Type::OrSymbol
            ).void
          end
          attr_writer :type
          ...
          module Type
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  NextbillionSDK::Models::OptimizationComputeResponse::Trip::Geojson::Type
                )
              end
        ...
        class Leg < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  NextbillionSDK::Models::OptimizationComputeResponse::Trip::Leg::Step
                ]
              )
            )
          end
          ...
          sig do
            params(
              steps:
                T::Array[
                  NextbillionSDK::Models::OptimizationComputeResponse::Trip::Leg::Step::OrHash
                ]
            ).void
          end
          attr_writer :steps
          ...
          class Step < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              returns(
                T.nilable(
                  NextbillionSDK::Models::OptimizationComputeResponse::Trip::Leg::Step::Geojson
                )
              )
            end
            attr_reader :geojson
            ...
            sig do
              params(
                geojson:
                  NextbillionSDK::Models::OptimizationComputeResponse::Trip::Leg::Step::Geojson::OrHash
              ).void
            end
            attr_writer :geojson
            ...
            class Geojson < NextbillionSDK::Internal::Type::BaseModel
              ...
              sig do
                returns(
                  T.nilable(
                    NextbillionSDK::Models::OptimizationComputeResponse::Trip::Leg::Step::Geojson::Type::TaggedSymbol
                  )
                )
              end
              attr_reader :type
              ...
              sig do
                params(
                  type:
                    NextbillionSDK::Models::OptimizationComputeResponse::Trip::Leg::Step::Geojson::Type::OrSymbol
                ).void
              end
              attr_writer :type
              ...
              module Type
                ...
                TaggedSymbol =
                  T.type_alias do
                    T.all(
                      Symbol,
                      NextbillionSDK::Models::OptimizationComputeResponse::Trip::Leg::Step::Geojson::Type
                    )
                  end
                OrSymbol = T.type_alias { T.any(Symbol, String) }
      ...
      class Waypoint < NextbillionSDK::Internal::Type::BaseModel
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::OptimizationComputeResponse::Waypoint::Location
            )
          )
        end
        attr_reader :location
        ...
        sig do
          params(
            location:
              NextbillionSDK::Models::OptimizationComputeResponse::Waypoint::Location::OrHash
          ).void
        end
        attr_writer :location
