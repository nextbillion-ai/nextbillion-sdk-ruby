  ...
  module Models
    class LookupByIDResponse < NextbillionSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::Models::LookupByIDResponse,
      ...
      sig do
        returns(
          T.nilable(T::Array[NextbillionSDK::Models::LookupByIDResponse::Item])
        )
      end
      attr_reader :items
      ...
      sig do
        params(
          items:
            T::Array[NextbillionSDK::Models::LookupByIDResponse::Item::OrHash]
        ).void
      end
      attr_writer :items
      ...
      sig do
        override.returns(
          { items: T::Array[NextbillionSDK::Models::LookupByIDResponse::Item] }
        )
      end
      def to_hash
      end
      ...
      class Item < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::LookupByIDResponse::Item,
              NextbillionSDK::Internal::AnyHash
            )
          end
