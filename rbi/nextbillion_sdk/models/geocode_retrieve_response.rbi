  ...
  module Models
    class GeocodeRetrieveResponse < NextbillionSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            NextbillionSDK::Models::GeocodeRetrieveResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[NextbillionSDK::Models::GeocodeRetrieveResponse::Item]
          )
        )
      end
      attr_reader :items
      ...
      sig do
        params(
          items:
            T::Array[
              NextbillionSDK::Models::GeocodeRetrieveResponse::Item::OrHash
            ]
        ).void
      end
      attr_writer :items
      ...
      class Item < NextbillionSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              NextbillionSDK::Models::GeocodeRetrieveResponse::Item,
              NextbillionSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          params(
            opening_hours:
              NextbillionSDK::Models::GeocodeRetrieveResponse::Item::OpeningHours::OrHash
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              NextbillionSDK::Models::GeocodeRetrieveResponse::Item::Scoring
            )
          )
        end
        attr_reader :scoring
        ...
        sig do
          params(
            scoring:
              NextbillionSDK::Models::GeocodeRetrieveResponse::Item::Scoring::OrHash
          ).void
        end
        attr_writer :scoring
        ...
        class OpeningHours < NextbillionSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              T.nilable(
                T::Array[
                  NextbillionSDK::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange
                ]
              )
            )
          end
          ...
          sig do
            params(
              time_ranges:
                T::Array[
                  NextbillionSDK::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange::OrHash
                ]
            ).void
          end
          ...
          class TimeRange < NextbillionSDK::Internal::Type::BaseModel
            ...
            sig do
              params(
                end_time:
                  NextbillionSDK::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange::EndTime::OrHash
              ).void
            end
            ...
            sig do
              params(
                start_time:
                  NextbillionSDK::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange::StartTime::OrHash
              ).void
            end
