...
class Nextbillionai::Test::SingletonClient < Nextbillionai::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: Nextbillionai::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class Nextbillionai::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @nextbillion_sdk = Nextbillionai::Test::SingletonClient.instance
  end
