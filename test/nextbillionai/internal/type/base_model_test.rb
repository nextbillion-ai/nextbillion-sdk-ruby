...
class Nextbillionai::Test::PrimitiveModelTest < Minitest::Test
  A = Nextbillionai::Internal::Type::ArrayOf[-> { Integer }]
  H = Nextbillionai::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < Nextbillionai::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Nextbillionai::Internal::Type::Unknown,
      Nextbillionai::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Nextbillionai::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Nextbillionai::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Nextbillionai::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Nextbillionai::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Nextbillionai::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Nextbillionai::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Nextbillionai::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Nextbillionai::Internal::Type::Boolean, true] => true,
      [Nextbillionai::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Nextbillionai::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Nextbillionai::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Nextbillionai::Internal::Type::Converter.new_coerce_state
      Nextbillionai::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Nextbillionai::Internal::Type::Converter.dump(target, input, state: state)
...
class Nextbillionai::Test::CollectionModelTest < Minitest::Test
  A1 = Nextbillionai::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Nextbillionai::Internal::Type::HashOf[Integer]

  A2 = Nextbillionai::Internal::Type::ArrayOf[H1]
  H2 = Nextbillionai::Internal::Type::HashOf[-> { A1 }]

  A3 = Nextbillionai::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Nextbillionai::Internal::Type::HashOf[Integer, nil?: true]
...
class Nextbillionai::Test::BaseModelTest < Minitest::Test
  class M1 < Nextbillionai::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Nextbillionai::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Nextbillionai::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Nextbillionai::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Nextbillionai::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Nextbillionai::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Nextbillionai::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Nextbillionai::Errors::ConversionError => e
...
class Nextbillionai::Test::UnionTest < Minitest::Test
  class U0
    include Nextbillionai::Internal::Type::Union
  ...
  class M2 < Nextbillionai::Internal::Type::BaseModel
  ...
  class M4 < Nextbillionai::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Nextbillionai::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Nextbillionai::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Nextbillionai::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Nextbillionai::Test::BaseModelQoLTest < Minitest::Test
  ...
  def test_equality
    cases = {
      [Nextbillionai::Internal::Type::Unknown, Nextbillionai::Internal::Type::Unknown] => true,
      [Nextbillionai::Internal::Type::Boolean, Nextbillionai::Internal::Type::Boolean] => true,
      [Nextbillionai::Internal::Type::Unknown, Nextbillionai::Internal::Type::Boolean] => false,
...
class Nextbillionai::Test::MetaInfoTest < Minitest::Test
  A1 = Nextbillionai::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Nextbillionai::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
