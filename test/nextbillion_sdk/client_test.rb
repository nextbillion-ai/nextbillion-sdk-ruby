...
class NextbillionSDKTest < Minitest::Test
  ...
  def test_client_default_request_default_retry_attempts
    ...
    assert_raises(NextbillionSDK::Errors::InternalServerError) do
  ...
  def test_client_retry_after_seconds
    ...
    nextbillion_sdk =
      NextbillionSDK::Client.new(base_url: "http://localhost", api_key: "My API Key", max_retries: 1)
  ...
  def test_client_redirect_307
    ...
    assert_raises(NextbillionSDK::Errors::APIConnectionError) do
      nextbillion_sdk.directions.compute_route(
        destination: "41.349302,2.136480",
        origin: "41.349302,2.136480",
    ...
    assert_requested(:any, "http://localhost/redirected", times: NextbillionSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_303
    ...
    assert_requested(:get, "http://localhost/redirected", times: NextbillionSDK::Client::MAX_REDIRECTS) do
  ...
  def test_client_redirect_auth_strip_cross_origin
    ...
    assert_requested(:any, "https://example.com/redirected", times: NextbillionSDK::Client::MAX_REDIRECTS) do
      headers = _1.headers.keys.map(&:downcase)
