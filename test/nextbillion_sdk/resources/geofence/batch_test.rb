...
class NextbillionSDK::Test::Resources::Geofence::BatchTest < NextbillionSDK::Test::ResourceTest
  def test_create_required_params
    ...
    assert_pattern do
      response => NextbillionSDK::Models::Geofence::BatchCreateResponse
    end

    assert_pattern do
      response => {
        data: NextbillionSDK::Models::Geofence::BatchCreateResponse::Data | nil,
        status: String | nil
      }
    end
  end
  ...
  def test_list_required_params
    ...
    assert_pattern do
      response => NextbillionSDK::Models::Geofence::BatchListResponse
    end
