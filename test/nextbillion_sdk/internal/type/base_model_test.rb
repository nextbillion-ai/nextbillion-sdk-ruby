...
class NextbillionSDK::Test::PrimitiveModelTest < Minitest::Test
  A = NextbillionSDK::Internal::Type::ArrayOf[-> { Integer }]
  H = NextbillionSDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend NextbillionSDK::Internal::Type::Union
  end

  class B < NextbillionSDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      NextbillionSDK::Internal::Type::Unknown,
      NextbillionSDK::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => NextbillionSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [NextbillionSDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [NextbillionSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [NextbillionSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = NextbillionSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        NextbillionSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [NextbillionSDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [NextbillionSDK::Internal::Type::Boolean, true] => true,
      [NextbillionSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => NextbillionSDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        NextbillionSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = NextbillionSDK::Internal::Type::Converter.new_coerce_state
      NextbillionSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        NextbillionSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class NextbillionSDK::Test::EnumModelTest < Minitest::Test
  class E0
    include NextbillionSDK::Internal::Type::Enum
    attr_reader :values
...
class NextbillionSDK::Test::CollectionModelTest < Minitest::Test
  A1 = NextbillionSDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = NextbillionSDK::Internal::Type::HashOf[Integer]

  A2 = NextbillionSDK::Internal::Type::ArrayOf[H1]
  H2 = NextbillionSDK::Internal::Type::HashOf[-> { A1 }]

  A3 = NextbillionSDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = NextbillionSDK::Internal::Type::HashOf[Integer, nil?: true]
...
class NextbillionSDK::Test::BaseModelTest < Minitest::Test
  class M1 < NextbillionSDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < NextbillionSDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < NextbillionSDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, NextbillionSDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = NextbillionSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = NextbillionSDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(NextbillionSDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue NextbillionSDK::Errors::ConversionError => e
...
class NextbillionSDK::Test::UnionTest < Minitest::Test
  class U0
    include NextbillionSDK::Internal::Type::Union
  ...
  class M2 < NextbillionSDK::Internal::Type::BaseModel
  ...
  class M4 < NextbillionSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, NextbillionSDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < NextbillionSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, NextbillionSDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class NextbillionSDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include NextbillionSDK::Internal::Type::Enum
    attr_reader :values
  ...
  def test_equality
    cases = {
      [NextbillionSDK::Internal::Type::Unknown, NextbillionSDK::Internal::Type::Unknown] => true,
      [NextbillionSDK::Internal::Type::Boolean, NextbillionSDK::Internal::Type::Boolean] => true,
      [NextbillionSDK::Internal::Type::Unknown, NextbillionSDK::Internal::Type::Boolean] => false,
