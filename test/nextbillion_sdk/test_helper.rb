...
class NextbillionSDK::Test::SingletonClient < NextbillionSDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: NextbillionSDK::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class NextbillionSDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @nextbillion_sdk = NextbillionSDK::Test::SingletonClient.instance
  end
