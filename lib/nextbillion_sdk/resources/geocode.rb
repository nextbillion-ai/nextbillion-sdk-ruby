...
module NextbillionSDK
  module Resources
    class Geocode
      ...
      # {NextbillionSDK::Models::GeocodeRetrieveParams} for more details.
      #
      # Geocode
      #
      ...
      #
      # @return [NextbillionSDK::Models::GeocodeRetrieveResponse]
      #
      # @see NextbillionSDK::Models::GeocodeRetrieveParams
      def retrieve(params)
        parsed, options = NextbillionSDK::GeocodeRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
          path: "geocode",
          query: parsed.transform_keys(in_: "in"),
          model: NextbillionSDK::Models::GeocodeRetrieveResponse,
          options: options
        )
      end

      # Some parameter documentations has been truncated, see
      # {NextbillionSDK::Models::GeocodeBatchCreateParams} for more details.
      #
      # Batch Geocode
      #
      ...
      #
      # @param body [Array<NextbillionSDK::Models::GeocodeBatchCreateParams::Body>] Body param:
      #
      # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [NextbillionSDK::Models::GeocodeBatchCreateResponse]
      #
      # @see NextbillionSDK::Models::GeocodeBatchCreateParams
      def batch_create(params)
        parsed, options = NextbillionSDK::GeocodeBatchCreateParams.dump_request(params)
        @client.request(
          method: :post,
          path: "geocode/batch",
          query: parsed.except(:body),
          body: parsed[:body],
          model: NextbillionSDK::Models::GeocodeBatchCreateResponse,
          options: options
        )
      end

      # Some parameter documentations has been truncated, see
      # {NextbillionSDK::Models::GeocodeStructuredRetrieveParams} for more details.
      #
      # Structured Geocode
      #
      ...
      # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [NextbillionSDK::Models::GeocodeStructuredRetrieveResponse]
      #
      # @see NextbillionSDK::Models::GeocodeStructuredRetrieveParams
      def structured_retrieve(params)
        parsed, options = NextbillionSDK::GeocodeStructuredRetrieveParams.dump_request(params)
        @client.request(
          method: :get,
          ...
          model: NextbillionSDK::Models::GeocodeStructuredRetrieveResponse,
          options: options
        )
      end
