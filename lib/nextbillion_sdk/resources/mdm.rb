...
module NextbillionSDK
  module Resources
    class Mdm
      ...
      #
      # @param destinations_approach [Symbol, NextbillionSDK::Models::MdmCreateDistanceMatrixParams::DestinationsApproach] Body param: Specify the side of the road from which to approach destinations poi
      #
      ...
      #
      # @param route_type [Symbol, NextbillionSDK::Models::MdmCreateDistanceMatrixParams::RouteType] Body param: Set the route type that needs to be returned. Please note that route
      #
