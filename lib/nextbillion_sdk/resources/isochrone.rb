...
module NextbillionSDK
  module Resources
    class Isochrone
      ...
      # {NextbillionSDK::Models::IsochroneComputeParams} for more details.
      #
      ...
      #
      # @param mode [Symbol, NextbillionSDK::Models::IsochroneComputeParams::Mode] Set which driving mode the service should use to determine the contour. For exam
      #
      ...
      #
      # @return [NextbillionSDK::Models::IsochroneComputeResponse]
      #
      # @see NextbillionSDK::Models::IsochroneComputeParams
      def compute(params)
        parsed, options = NextbillionSDK::IsochroneComputeParams.dump_request(params)
        @client.request(
          method: :get,
          path: "isochrone/json",
          query: parsed,
          model: NextbillionSDK::Models::IsochroneComputeResponse,
          options: options
        )
      end
