...
module NextbillionSDK
  module Resources
    class Autosuggest
      ...
      # {NextbillionSDK::Models::AutosuggestSuggestParams} for more details.
      #
      # Autosuggest
      #
      ...
      #
      # @return [NextbillionSDK::Models::AutosuggestSuggestResponse]
      #
      # @see NextbillionSDK::Models::AutosuggestSuggestParams
      def suggest(params)
        parsed, options = NextbillionSDK::AutosuggestSuggestParams.dump_request(params)
        @client.request(
          method: :get,
          path: "autosuggest",
          query: parsed.transform_keys(in_: "in"),
          model: NextbillionSDK::Models::AutosuggestSuggestResponse,
          options: options
        )
      end
