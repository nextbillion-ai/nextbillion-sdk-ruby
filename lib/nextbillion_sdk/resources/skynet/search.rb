...
module NextbillionSDK
  module Resources
    class Skynet
      class Search
        # @return [NextbillionSDK::Resources::Skynet::Search::Polygon]
        attr_reader :polygon

        # Some parameter documentations has been truncated, see
        # {NextbillionSDK::Models::Skynet::SearchAroundParams} for more details.
        #
        # Around Search
        #
        ...
        #
        # @param sort_driving_mode [Symbol, NextbillionSDK::Models::Skynet::SearchAroundParams::SortDrivingMode] Specifies the driving mode to be used for determining travel duration or driving
        #
        ...
        #
        # @see NextbillionSDK::Models::Skynet::SearchAroundParams
        def around(params)
          parsed, options = NextbillionSDK::Skynet::SearchAroundParams.dump_request(params)
          @client.request(
            method: :get,
        ...
        # Some parameter documentations has been truncated, see
        # {NextbillionSDK::Models::Skynet::SearchBoundParams} for more details.
        #
        # Bound Search
        #
        ...
        # @param ps [Integer] Denotes number of search results per page. Use this along with the pn parameter
        #
        # @param sort_by [Symbol, NextbillionSDK::Models::Skynet::SearchBoundParams::SortBy] Specify the metric to sort the assets returned in the search result. The valid v
        #
        # @param sort_destination [String] Specifies the location coordinates of the point which acts as destination for so
        #
        # @param sort_driving_mode [Symbol, NextbillionSDK::Models::Skynet::SearchBoundParams::SortDrivingMode] Specifies the driving mode to be used for determining travel duration or driving
        #
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [NextbillionSDK::Models::Skynet::SearchResponse]
        #
        # @see NextbillionSDK::Models::Skynet::SearchBoundParams
        def bound(params)
          parsed, options = NextbillionSDK::Skynet::SearchBoundParams.dump_request(params)
          @client.request(
            method: :get,
        ...
        def initialize(client:)
          @client = client
          @polygon = NextbillionSDK::Resources::Skynet::Search::Polygon.new(client: client)
        end
      end
    end
  end
