    ...
    class Skynet
      class Search
        class Polygon
          ...
          #
          # @param polygon [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Polygon] Body param: An object to collect geoJSON details of a custom polygon. Please ens
          #
          # @param filter [String] Body param: \*\*tags parameter will be deprecated soon! Please use the
          # include_any
          #
          # @param match_filter [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::MatchFilter] Body param: An object to define the attributes which will be used to filter the
          #
          ...
          #
          # @param sort [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort] Body param:
          #
          # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [NextbillionSDK::Models::Skynet::SearchResponse]
          #
          # @see NextbillionSDK::Models::Skynet::Search::PolygonCreateParams
          def create(params)
            parsed, options = NextbillionSDK::Skynet::Search::PolygonCreateParams.dump_request(params)
            query_params = [:key]
            @client.request(
              method: :post,
              ...
              model: NextbillionSDK::Skynet::SearchResponse,
              options: options
            )
          end

          # Some parameter documentations has been truncated, see
          # {NextbillionSDK::Models::Skynet::Search::PolygonGetParams} for more details.
          #
          # Polygon Search
          #
          ...
          #
          # @param sort_by [Symbol, NextbillionSDK::Models::Skynet::Search::PolygonGetParams::SortBy] Specify the metric to sort the assets returned in the search result. The valid v
          #
          # @param sort_destination [String] Specifies the location coordinates of the point which acts as destination for so
          #
          # @param sort_driving_mode [Symbol, NextbillionSDK::Models::Skynet::Search::PolygonGetParams::SortDrivingMode] Specifies the driving mode to be used for determining travel duration or driving
          #
          # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
          #
          # @return [NextbillionSDK::Models::Skynet::SearchResponse]
          #
          # @see NextbillionSDK::Models::Skynet::Search::PolygonGetParams
          def get(params)
            parsed, options = NextbillionSDK::Skynet::Search::PolygonGetParams.dump_request(params)
            @client.request(
              method: :get,
              path: "skynet/search/polygon",
              query: parsed,
