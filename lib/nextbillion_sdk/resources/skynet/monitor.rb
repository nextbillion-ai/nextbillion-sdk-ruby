  ...
  module Resources
    class Skynet
      class Monitor
        ...
        #
        # @param match_filter [NextbillionSDK::Models::Skynet::MonitorCreateParams::MatchFilter] Body param: This object is used to identify the asset(s) on which the `monitor`
        #
        ...
        #
        # @param speeding_config [NextbillionSDK::Models::Skynet::MonitorCreateParams::SpeedingConfig] Body param: `speeding_config` is used to set up constraints for creating over-sp
        #
        ...
        #
        # @param geofence_config [NextbillionSDK::Models::Skynet::MonitorUpdateParams::GeofenceConfig] Body param: `geofence_config` is used to update the set of geofences linked to t
        #
        # @param geofence_ids [Array<String>] Body param: Use this parameter to update the geofences linked to the `monitor` b
        #
        # @param idle_config [NextbillionSDK::Models::Skynet::MonitorUpdateParams::IdleConfig] Body param: `idle_config` is used to update the constraints for creating idle ev
        #
        # @param match_filter [NextbillionSDK::Models::Skynet::MonitorUpdateParams::MatchFilter] Body param: Use this object to update the `attributes` of the `monitor`. Please
        #
        # @param meta_data [Object] Body param: Any valid json object data. Can be used to save customized data. Max
        #
        # @param name [String] Body param: Use this parameter to update the `name` of the `monitor`. Users can
        #
        # @param speeding_config [NextbillionSDK::Models::Skynet::MonitorUpdateParams::SpeedingConfig] Body param: `speeding_config` is used to update the tolerance values for creatin
        #
        # @param tags [Array<String>] Body param: Use this parameter to update the `tags` of the `monitor`. `tags` can
        #
        # @param type [Symbol, NextbillionSDK::Models::Skynet::MonitorUpdateParams::Type] Body param: Use this parameter to update the `type` of the `monitor`. The `monit
        #
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
