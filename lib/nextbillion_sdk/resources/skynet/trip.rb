  ...
  module Resources
    class Skynet
      class Trip
        ...
        #
        # @return [NextbillionSDK::Models::Skynet::TripRetrieveResponse]
        #
        # @see NextbillionSDK::Models::Skynet::TripRetrieveParams
        def retrieve(id, params)
          parsed, options = NextbillionSDK::Skynet::TripRetrieveParams.dump_request(params)
          @client.request(
            method: :get,
            path: ["skynet/trip/%1$s", id],
            query: parsed,
            model: NextbillionSDK::Models::Skynet::TripRetrieveResponse,
            options: options
          )
        end
        ...
        #
        # @param cluster [Symbol, NextbillionSDK::Models::Skynet::TripUpdateParams::Cluster] Query param: the cluster of the region you want to use
        #
        ...
        #
        # @param stops [Array<NextbillionSDK::Models::Skynet::TripUpdateParams::Stop>] Body param: Use this object to update the details of the stops made during the t
        #
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [NextbillionSDK::Models::Skynet::SimpleResp]
        #
        # @see NextbillionSDK::Models::Skynet::TripUpdateParams
        def update(id, params)
          parsed, options = NextbillionSDK::Skynet::TripUpdateParams.dump_request(params)
        ...
        # Some parameter documentations has been truncated, see
        # {NextbillionSDK::Models::Skynet::TripDeleteParams} for more details.
        #
        ...
        # @param key [String] A key is a unique identifier that is required to authenticate a request to the A
        #
        # @param cluster [Symbol, NextbillionSDK::Models::Skynet::TripDeleteParams::Cluster] the cluster of the region you want to use
        #
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [NextbillionSDK::Models::Skynet::SimpleResp]
        #
        # @see NextbillionSDK::Models::Skynet::TripDeleteParams
        def delete(id, params)
          parsed, options = NextbillionSDK::Skynet::TripDeleteParams.dump_request(params)
          @client.request(
            method: :delete,
            path: ["skynet/trip/%1$s", id],
            query: parsed,
        ...
        #
        # @param cluster [Symbol, NextbillionSDK::Models::Skynet::TripEndParams::Cluster] Query param: the cluster of the region you want to use
        #
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [NextbillionSDK::Models::Skynet::SimpleResp]
        #
        # @see NextbillionSDK::Models::Skynet::TripEndParams
        def end_(params)
          parsed, options = NextbillionSDK::Skynet::TripEndParams.dump_request(params)
          query_params = [:key, :cluster]
          @client.request(
            method: :post,
        ...
        # Some parameter documentations has been truncated, see
        # {NextbillionSDK::Models::Skynet::TripGetSummaryParams} for more details.
        #
        ...
        # @param key [String] A key is a unique identifier that is required to authenticate a request to the A
        #
        # @param cluster [Symbol, NextbillionSDK::Models::Skynet::TripGetSummaryParams::Cluster] the cluster of the region you want to use
        #
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [NextbillionSDK::Models::Skynet::TripGetSummaryResponse]
        #
        # @see NextbillionSDK::Models::Skynet::TripGetSummaryParams
        def get_summary(id, params)
          parsed, options = NextbillionSDK::Skynet::TripGetSummaryParams.dump_request(params)
          @client.request(
            method: :get,
            path: ["skynet/trip/%1$s/summary", id],
            query: parsed,
            model: NextbillionSDK::Models::Skynet::TripGetSummaryResponse,
            options: options
          )
        end
        ...
        #
        # @param cluster [Symbol, NextbillionSDK::Models::Skynet::TripStartParams::Cluster] Query param: the cluster of the region you want to use
        #
        ...
        #
        # @param stops [Array<NextbillionSDK::Models::Skynet::TripStartParams::Stop>] Body param: An array of objects to collect the details about all the stops that
        #
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [NextbillionSDK::Models::Skynet::TripStartResponse]
        #
        # @see NextbillionSDK::Models::Skynet::TripStartParams
        def start(params)
          parsed, options = NextbillionSDK::Skynet::TripStartParams.dump_request(params)
          query_params = [:key, :cluster]
          @client.request(
            method: :post,
            ...
            query: parsed.slice(*query_params),
            body: parsed.except(*query_params),
            model: NextbillionSDK::Models::Skynet::TripStartResponse,
            options: options
          )
        end
