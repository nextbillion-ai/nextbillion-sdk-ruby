...
module NextbillionSDK
  module Resources
    class RouteReport
      ...
      #
      # @param original_shape_type [Symbol, NextbillionSDK::Models::RouteReportCreateParams::OriginalShapeType] Body param: Specify the encoding type of route geometry provided in original_sha
      #
