  ...
  module Resources
    class Multigeocode
      class Place
        ...
        #
        # @param place [Array<NextbillionSDK::Models::Multigeocode::PlaceCreateParams::Place>] Body param: This parameter represents the place details, including geographical
        #
        # @param data_source [NextbillionSDK::Models::Multigeocode::PlaceCreateParams::DataSource] Body param: It contains information about the dataset that returns the specific
        #
        ...
        #
        # @return [NextbillionSDK::Models::Multigeocode::PlaceCreateResponse]
        #
        # @see NextbillionSDK::Models::Multigeocode::PlaceCreateParams
        def create(params)
          parsed, options = NextbillionSDK::Multigeocode::PlaceCreateParams.dump_request(params)
          query_params = [:key]
          @client.request(
            method: :post,
            ...
            model: NextbillionSDK::Models::Multigeocode::PlaceCreateResponse,
            options: options
          )
        end

        # Some parameter documentations has been truncated, see
        # {NextbillionSDK::Models::Multigeocode::PlaceRetrieveParams} for more details.
        #
        ...
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse]
        #
        # @see NextbillionSDK::Models::Multigeocode::PlaceRetrieveParams
        def retrieve(doc_id, params)
          parsed, options = NextbillionSDK::Multigeocode::PlaceRetrieveParams.dump_request(params)
          @client.request(
            method: :get,
            path: ["multigeocode/place/%1$s", doc_id],
            query: parsed,
            model: NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse,
            options: options
          )
        end
        ...
        # @param key [String] Query param: A key is a unique identifier that is required to authenticate a req
        #
        # @param data_source [NextbillionSDK::Models::Multigeocode::PlaceUpdateParams::DataSource] Body param: dataSource values can be updated to enhance or prioritize the search
        #
        # @param place [Array<NextbillionSDK::Models::Multigeocode::PlaceItem>] Body param: This parameter represents the place details, including geographical
        #
        # @param score [Integer] Body param: Search score of the place. This is calculated based on how ‘richly’
        #
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [NextbillionSDK::Models::Multigeocode::PlaceUpdateResponse]
        #
        # @see NextbillionSDK::Models::Multigeocode::PlaceUpdateParams
        def update(doc_id, params)
          parsed, options = NextbillionSDK::Multigeocode::PlaceUpdateParams.dump_request(params)
          query_params = [:key]
          @client.request(
            method: :put,
            path: ["multigeocode/place/%1$s", doc_id],
            query: parsed.slice(*query_params),
            body: parsed.except(*query_params),
            model: NextbillionSDK::Models::Multigeocode::PlaceUpdateResponse,
            options: options
          )
        end

        # Some parameter documentations has been truncated, see
        # {NextbillionSDK::Models::Multigeocode::PlaceDeleteParams} for more details.
        #
        ...
        # @param request_options [NextbillionSDK::RequestOptions, Hash{Symbol=>Object}, nil]
        #
        # @return [NextbillionSDK::Models::Multigeocode::PlaceDeleteResponse]
        #
        # @see NextbillionSDK::Models::Multigeocode::PlaceDeleteParams
        def delete(doc_id, params)
          parsed, options = NextbillionSDK::Multigeocode::PlaceDeleteParams.dump_request(params)
          @client.request(
            method: :delete,
            path: ["multigeocode/place/%1$s", doc_id],
            query: parsed,
            model: NextbillionSDK::Models::Multigeocode::PlaceDeleteResponse,
            options: options
          )
        end
