...
module NextbillionSDK
  module Models
    ...
    class GeocodeBatchCreateParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<NextbillionSDK::Models::GeocodeBatchCreateParams::Body>]
      required :body,
               -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::GeocodeBatchCreateParams::Body] }

      # @!method initialize(key:, body:, request_options: {})
      #   Some parameter documentations has been truncated, see
      #   {NextbillionSDK::Models::GeocodeBatchCreateParams} for more details.
      #
      #   @param key [String] A key is a unique identifier that is required to authenticate a request to the A
      #
      #   @param body [Array<NextbillionSDK::Models::GeocodeBatchCreateParams::Body>]
      #
      ...
      class Body < NextbillionSDK::Internal::Type::BaseModel
        ...
        # @!method initialize(q:, at: nil, in_: nil, lang: nil, limit: nil)
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::GeocodeBatchCreateParams::Body} for more details.
        #
        #   @param q [String] Specify the free-text search query. Please note that whitespace, urls, email add
        #
        ...
        #
        #   @param limit [Integer] Maximum number of results to be returned. Please note that the minimum value tha
      end
    end
  end
end
