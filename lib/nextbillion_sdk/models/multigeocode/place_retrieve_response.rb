...
module NextbillionSDK
  module Models
    module Multigeocode
      # @see NextbillionSDK::Resources::Multigeocode::Place#retrieve
      class PlaceRetrieveResponse < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse::DataSorce, nil]
        optional :data_sorce,
        ...
        #   {NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse} for more details.
        #
        #   @param data_sorce [NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse::DataSorce] It displays the information about the current source and current status of the p
        #
        ...
        # @see NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse#data_sorce
        class DataSorce < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   not.
          #
          #   @return [Symbol, NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse::DataSorce::Status, nil]
          optional :status,
                   enum: -> { NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse::DataSorce::Status }

          # @!method initialize(ref_id: nil, source: nil, status: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse::DataSorce} for
          #   more details.
          #
          #   It displays the information about the current source and current status of the
          #   place. Use the “Update Place” method to change these values, as needed.
          ...
          #
          #   @param status [Symbol, NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse::DataSorce::Status] This parameter indicates if a place is currently discoverable by search API or n

          # This parameter indicates if a place is currently discoverable by search API or
          # not.
          #
          # @see NextbillionSDK::Models::Multigeocode::PlaceRetrieveResponse::DataSorce#status
          module Status
