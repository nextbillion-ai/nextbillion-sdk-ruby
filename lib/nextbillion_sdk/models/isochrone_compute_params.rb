...
module NextbillionSDK
  module Models
    ...
    class IsochroneComputeParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      #   additional profiles.
      #
      #   @return [Symbol, NextbillionSDK::Models::IsochroneComputeParams::Mode, nil]
      optional :mode, enum: -> { NextbillionSDK::IsochroneComputeParams::Mode }
      ...
      #
      #   @return [Boolean, nil]
      optional :polygons, NextbillionSDK::Internal::Type::Boolean
