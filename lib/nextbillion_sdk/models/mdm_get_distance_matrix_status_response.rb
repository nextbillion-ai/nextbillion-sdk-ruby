...
module NextbillionSDK
  module Models
    # @see NextbillionSDK::Resources::Mdm#get_distance_matrix_status
    class MdmGetDistanceMatrixStatusResponse < NextbillionSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, NextbillionSDK::Models::MdmGetDistanceMatrixStatusResponse::Code, nil]
      optional :code, enum: -> { NextbillionSDK::Models::MdmGetDistanceMatrixStatusResponse::Code }
      ...
      #   {NextbillionSDK::Models::MdmGetDistanceMatrixStatusResponse} for more details.
      #
      #   @param code [Symbol, NextbillionSDK::Models::MdmGetDistanceMatrixStatusResponse::Code] A code representing the status of the request.
      #
      ...
      # A code representing the status of the request.
      #
      # @see NextbillionSDK::Models::MdmGetDistanceMatrixStatusResponse#code
      module Code
