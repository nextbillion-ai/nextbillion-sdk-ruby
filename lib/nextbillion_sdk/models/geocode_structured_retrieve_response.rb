...
module NextbillionSDK
  module Models
    # @see NextbillionSDK::Resources::Geocode#structured_retrieve
    class GeocodeStructuredRetrieveResponse < NextbillionSDK::Internal::Type::BaseModel
      # @!attribute items
      ...
      #
      #   @return [Array<NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item>, nil]
      optional :items,
               -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item] }

      # @!method initialize(items: nil)
      #   Some parameter documentations has been truncated, see
      #   {NextbillionSDK::Models::GeocodeStructuredRetrieveResponse} for more details.
      #
      #   @param items [Array<NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item>] The results are presented as a JSON list of candidates in ranked order (most-lik
      ...
      class Item < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours, nil]
        optional :opening_hours,
                 -> { NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours },
        ...
        #
        #   @return [NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::Scoring, nil]
        optional :scoring, -> { NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::Scoring }
        ...
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item} for more
        #   details.
        #
        ...
        #
        #   @param opening_hours [NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours] Returns the operating hours of the place, if available.
        #
        #   @param position [NextbillionSDK::Models::Position] Returns the location coordinates of the result.
        #
        #   @param scoring [NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::Scoring] Score of the result. A higher score indicates a closer match.
        #
        #   @param title [String] The localized display name of this result item.

        # @see NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item#opening_hours
        class OpeningHours < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange>, nil]
          optional :time_ranges,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange] },
                   api_name: :timeRanges
          ...
          #   Returns the operating hours of the place, if available.
          #
          #   @param time_ranges [Array<NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange>] A collection of attributes with details about the opening and closing hours for

          class TimeRange < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute end_time
            #   Returns the closing time details.
            #
            #   @return [NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::EndTime, nil]
            optional :end_time,
                     -> { NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::EndTime },
                     api_name: :endTime

            # @!attribute start_time
            #   Returns the open time details.
            #
            #   @return [NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::StartTime, nil]
            optional :start_time,
                     -> { NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::StartTime },
                     api_name: :startTime

            # @!method initialize(end_time: nil, start_time: nil)
            #   @param end_time [NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::EndTime] Returns the closing time details.
            #
            #   @param start_time [NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::StartTime] Returns the open time details.

            # @see NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange#end_time
            ...
            # @see NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange#start_time
        ...
        # @see NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item#scoring
        class Scoring < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::GeocodeStructuredRetrieveResponse::Item::Scoring} for
          #   more details.
          #
          #   Score of the result. A higher score indicates a closer match.
          #
