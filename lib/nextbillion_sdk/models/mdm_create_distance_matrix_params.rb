...
module NextbillionSDK
  module Models
    ...
    class MdmCreateDistanceMatrixParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      #
      #   @param destinations_approach [Symbol, NextbillionSDK::Models::MdmCreateDistanceMatrixParams::DestinationsApproach] Specify the side of the road from which to approach `destinations` points. Pleas
      #
      ...
      #
      #   @param origins_approach [Symbol, NextbillionSDK::Models::MdmCreateDistanceMatrixParams::OriginsApproach] Specify the side of the road from which to approach `origins` points. Please not
      #
      #   @param route_type [Symbol, NextbillionSDK::Models::MdmCreateDistanceMatrixParams::RouteType] Set the route type that needs to be returned. Please note that `route_type` is e
      #
