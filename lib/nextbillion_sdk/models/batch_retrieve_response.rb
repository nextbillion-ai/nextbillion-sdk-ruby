...
module NextbillionSDK
  module Models
    ...
    class BatchRetrieveResponse < NextbillionSDK::Internal::Type::BaseModel
      ...
      #   query in the input.
      #
      #   @return [Array<NextbillionSDK::Models::BatchRetrieveResponse::Response>, nil]
      optional :responses,
               -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::BatchRetrieveResponse::Response] }
      ...
      #   {NextbillionSDK::Models::BatchRetrieveResponse} for more details.
      #
      #   @param msg [String] Displays the error message in case of a failed request or operation. Please note
      #
      #   @param responses [Array<NextbillionSDK::Models::BatchRetrieveResponse::Response>] An array of objects returning the results of all the individual routing queries
      #
      ...
      class Response < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Object, nil]
        optional :response, NextbillionSDK::Internal::Type::Unknown
        ...
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::BatchRetrieveResponse::Response} for more details.
        #
