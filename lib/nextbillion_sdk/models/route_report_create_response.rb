...
module NextbillionSDK
  module Models
    ...
    class RouteReportCreateResponse < NextbillionSDK::Internal::Type::BaseModel
      # @!attribute geometry
      ...
      #
      #   @return [Array<NextbillionSDK::Models::RouteReportCreateResponse::Mileage>, nil]
      optional :mileage,
               -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::RouteReportCreateResponse::Mileage] }
      ...
      #
      #   @return [Array<NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary>, nil]
      optional :road_summary,
               -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary] }
      ...
      #   {NextbillionSDK::Models::RouteReportCreateResponse} for more details.
      #
      #   @param geometry [Array<String>] An array of objects returning encoded geometry of the routes. Each object repres
      #
      #   @param mileage [Array<NextbillionSDK::Models::RouteReportCreateResponse::Mileage>] Returns the details of route segments in each state or country that the route pa
      #
      #   @param msg [String] Displays the error message in case of a failed request or operation. Please note
      #
      #   @param road_summary [Array<NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary>] An array of objects returning a summary of the route with information about toll
      #
      #   @param status [String] A string indicating the state of the response. On normal responses, the value wi

      class Mileage < NextbillionSDK::Internal::Type::BaseModel
        # @!attribute segment
        #   Returns the details of road segments that the route covers in different states
        #   and countries.
        #
        #   @return [NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment, nil]
        optional :segment, -> { NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment }

        # @!attribute summary
        #   Returns a summary of distances that the route covers in different states and
        #   countries.
        #
        #   @return [NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Summary, nil]
        optional :summary, -> { NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Summary }

        # @!method initialize(segment: nil, summary: nil)
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::RouteReportCreateResponse::Mileage} for more details.
        #
        #   @param segment [NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment] Returns the details of road segments that the route covers in different states a
        #
        #   @param summary [NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Summary] Returns a summary of distances that the route covers in different states and cou

        # @see NextbillionSDK::Models::RouteReportCreateResponse::Mileage#segment
        class Segment < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment::Country>, nil]
          optional :country,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment::Country] }
          ...
          #
          #   @return [Array<NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment::State>, nil]
          optional :state,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment::State] }

          # @!method initialize(country: nil, state: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment} for more
          #   details.
          #
          #   Returns the details of road segments that the route covers in different states
          #   and countries.
          #
          #   @param country [Array<NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment::Country>] An array of objects containing country-wise break up of the route segments. Each
          #
          #   @param state [Array<NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment::State>] An array of objects containing state-wise break up of the route segments. Each o

          class Country < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute distance
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment::Country}
            #   for more details.
            #
          ...
          class State < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute distance
            ...
            # @!method initialize(distance: nil, length: nil, offset: nil, value: nil)
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Segment::State} for
            #   more details.
            #
        ...
        class Summary < NextbillionSDK::Internal::Type::BaseModel
          ...
          # @!method initialize(country: nil, state: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::RouteReportCreateResponse::Mileage::Summary} for more
          #   details.
          #
          #   Returns a summary of distances that the route covers in different states and
          #   countries.
      ...
      class RoadSummary < NextbillionSDK::Internal::Type::BaseModel
        # @!attribute segment
        #   Returns the segment-wise road class and max speed information of the route.
        #
        #   @return [NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment, nil]
        optional :segment, -> { NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment }

        # @!attribute summary
        #   Returns an overview of the route with information about trip distance, duration
        #   and road class details among others.
        #
        #   @return [NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Summary, nil]
        optional :summary, -> { NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Summary }

        # @!method initialize(segment: nil, summary: nil)
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary} for more
        #   details.
        #
        #   @param segment [NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment] Returns the segment-wise road class and max speed information of the route.
        #
        #   @param summary [NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Summary] Returns an overview of the route with information about trip distance, duration

        # @see NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary#segment
        class Segment < NextbillionSDK::Internal::Type::BaseModel
          # @!attribute max_speed
          #   An array of objects returning the maximum speed of different segments that the
          #   route goes through.
          #
          #   @return [Array<NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment::MaxSpeed>, nil]
          optional :max_speed,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment::MaxSpeed] }
          ...
          #   unique road class.
          #
          #   @return [Array<NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment::RoadClass>, nil]
          optional :road_class,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment::RoadClass] }

          # @!method initialize(max_speed: nil, road_class: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment} for
          #   more details.
          #
          #   Returns the segment-wise road class and max speed information of the route.
          #
          #   @param max_speed [Array<NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment::MaxSpeed>] An array of objects returning the maximum speed of different segments that the r
          #
          #   @param road_class [Array<NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment::RoadClass>] An array of objects returning the details of road segments belonging to differen
          ...
          class MaxSpeed < NextbillionSDK::Internal::Type::BaseModel
            ...
            # @!method initialize(distance: nil, length: nil, offset: nil, value: nil)
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment::MaxSpeed}
            #   for more details.
            #
          ...
          class RoadClass < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute distance
            #   Returns the total distance of this segment, in meters.
            #
            #   @return [Integer, nil]
            ...
            # @!method initialize(distance: nil, length: nil, offset: nil, value: nil)
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Segment::RoadClass}
            #   for more details.
            #
            #   @param distance [Integer] Returns the total distance of this segment, in meters.
            #
        ...
        # @see NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary#summary
        class Summary < NextbillionSDK::Internal::Type::BaseModel
          # @!attribute distance
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::RouteReportCreateResponse::RoadSummary::Summary} for
          #   more details.
          #
          #   Returns an overview of the route with information about trip distance, duration
          #   and road class details among others.
