...
module NextbillionSDK
  module Models
    ...
    class SnapToRoadSnapParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Approaches, nil]
      optional :approaches, enum: -> { NextbillionSDK::SnapToRoadSnapParams::Approaches }
      ...
      #   objects are avoided.
      #
      #   @return [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Avoid, nil]
      optional :avoid, enum: -> { NextbillionSDK::SnapToRoadSnapParams::Avoid }
      ...
      #
      #   @return [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Geometry, nil]
      optional :geometry, enum: -> { NextbillionSDK::SnapToRoadSnapParams::Geometry }
      ...
      #   additional profiles.
      #
      #   @return [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Mode, nil]
      optional :mode, enum: -> { NextbillionSDK::SnapToRoadSnapParams::Mode }
      ...
      #
      #   @return [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Option, nil]
      optional :option, enum: -> { NextbillionSDK::SnapToRoadSnapParams::Option }
      ...
      #
      #   @return [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::RoadInfo, nil]
      optional :road_info, enum: -> { NextbillionSDK::SnapToRoadSnapParams::RoadInfo }
      ...
      #
      #   @return [Boolean, nil]
      optional :tolerate_outlier, NextbillionSDK::Internal::Type::Boolean
      ...
      #   {NextbillionSDK::Models::SnapToRoadSnapParams} for more details.
      #
      #   @param key [String] A key is a unique identifier that is required to authenticate a request to the A
      #
      #   @param path [String] Pipe-separated list of coordinate points along a path which would be snapped to
      #
      #   @param approaches [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Approaches] A semicolon-separated list indicating the side of the road from which to approac
      #
      #   @param avoid [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Avoid] Setting this will ensure the route avoids ferries, tolls, highways or nothing. M
      #
      #   @param geometry [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Geometry] Sets the output format of the route geometry in the response. Only the "polyline
      #
      #   @param mode [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Mode] Set which driving mode the service should use to determine a route. For example,
      #
      #   @param option [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::Option] Include this parameter in the request to return segment-wise speed information o
      #
      #   @param radiuses [String] Pipe separated radiuses, in meters (m), up to which a coordinate point can be sn
      #
      #   @param road_info [Symbol, NextbillionSDK::Models::SnapToRoadSnapParams::RoadInfo] Use this parameter to receive segment-wise maximum speed information of the rout
      #
