...
module NextbillionSDK
  module Models
    ...
    class NavigationRetrieveRouteParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, NextbillionSDK::Models::NavigationRetrieveRouteParams::Approaches, nil]
      optional :approaches, enum: -> { NextbillionSDK::NavigationRetrieveRouteParams::Approaches }
      ...
      #   objects are avoided.
      #
      #   @return [Symbol, NextbillionSDK::Models::NavigationRetrieveRouteParams::Avoid, nil]
      optional :avoid, enum: -> { NextbillionSDK::NavigationRetrieveRouteParams::Avoid }
      ...
      #   route.
      #
      #   @return [Symbol, NextbillionSDK::Models::NavigationRetrieveRouteParams::Geometry, nil]
      optional :geometry, enum: -> { NextbillionSDK::NavigationRetrieveRouteParams::Geometry }
      ...
      #   additional profiles.
      #
      #   @return [Symbol, NextbillionSDK::Models::NavigationRetrieveRouteParams::Mode, nil]
      optional :mode, enum: -> { NextbillionSDK::NavigationRetrieveRouteParams::Mode }
      ...
      #   parameter.
      #
      #   @return [Symbol, NextbillionSDK::Models::NavigationRetrieveRouteParams::OriginalShapeType, nil]
      optional :original_shape_type,
               enum: -> { NextbillionSDK::NavigationRetrieveRouteParams::OriginalShapeType }
      ...
      #   "false".
      #
      #   @return [Symbol, NextbillionSDK::Models::NavigationRetrieveRouteParams::Overview, nil]
      optional :overview, enum: -> { NextbillionSDK::NavigationRetrieveRouteParams::Overview }
