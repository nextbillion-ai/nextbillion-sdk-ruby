  ...
  module Models
    ...
    class GeofenceContainsResponse < NextbillionSDK::Internal::Type::BaseModel
      ...
      class Data < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @param result_list [Array<NextbillionSDK::Models::GeofenceContainsResponse::Data::ResultList>] An array of objects containing each of the geofences provided in the `geofences`
