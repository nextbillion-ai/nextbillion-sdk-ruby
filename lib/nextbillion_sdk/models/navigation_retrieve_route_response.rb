...
module NextbillionSDK
  module Models
    # @see NextbillionSDK::Resources::Navigation#retrieve_route
    class NavigationRetrieveRouteResponse < NextbillionSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route>, nil]
      optional :routes,
               -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route] }
      ...
      #   {NextbillionSDK::Models::NavigationRetrieveRouteResponse} for more details.
      #
      #   @param msg [String] Displays the error message in case of a failed request or operation. Please note
      #
      #   @param routes [Array<NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route>] An array of objects describing different possible routes from the starting locat
      #
      ...
      class Route < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::EndLocation, nil]
        optional :end_location, -> { NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::EndLocation }

        # @!attribute geojson
        #   The GeoJSON representation of the route.
        #
        #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Geojson, nil]
        ...
        optional :legs,
                 -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg] }
        ...
        #
        #   @return [Object, nil]
        optional :special_objects, NextbillionSDK::Internal::Type::Unknown

        # @!attribute start_location
        #   Location coordinates of the point where the route starts.
        #
        #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::StartLocation, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route} for more
        #   details.
        #
        ...
        #
        #   @param end_location [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::EndLocation] Location coordinates of the point where the route ends.
        #
        ...
        #
        #   @param start_location [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::StartLocation] Location coordinates of the point where the route starts.
        #
        ...
        class Geojson < NextbillionSDK::Internal::Type::BaseModel
          ...
          # @!attribute type
          #
          #   @return [Symbol, NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Geojson::Type, nil]
          optional :type, enum: -> { NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Geojson::Type }
          ...
          #   @param type [Symbol, NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Geojson::Type]

          # @see NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Geojson#type
          module Type
        ...
        class Leg < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Distance, nil]
          optional :distance, -> { NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Distance }

          # @!attribute duration
          #   An object containing leg duration value, in seconds.
          #
          #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Duration, nil]
          optional :duration, -> { NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Duration }

          # @!attribute end_location
          #   Location coordinates of the point where the leg ends.
          #
          #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::EndLocation, nil]
          ...
          #
          #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::StartLocation, nil]
          optional :start_location,
          ...
          #
          #   @return [Array<NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step>, nil]
          optional :steps,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step] }

          # @!method initialize(distance: nil, duration: nil, end_location: nil, raw_duration: nil, start_location: nil, steps: nil)
          #   @param distance [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Distance] An object containing leg distance value, in meters.
          #
          #   @param duration [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Duration] An object containing leg duration value, in seconds.
          #
          ...
          #
          #   @param steps [Array<NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step>] An array of step objects containing turn-by-turn guidance for easy navigation.

          # @see NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg#distance
          ...
          # @see NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg#duration
          ...
          class Step < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step::Distance, nil]
            optional :distance,
            ...
            #
            #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step::Duration, nil]
            optional :duration,
            ...
            #
            #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step::RoadShieldType, nil]
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step} for
            #   more details.
            #
            #   @param distance [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step::Distance] An object containing step distance value, in meters.
            #
            ...
            # @see NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step#duration
            class Duration < NextbillionSDK::Internal::Type::BaseModel
              # @!attribute value
              #
              #   @return [Integer, nil]
            ...
            class Intersection < NextbillionSDK::Internal::Type::BaseModel
              ...
              optional :lanes,
                       -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step::Intersection::Lane] }

              # @!attribute location
              #   A [longitude, latitude] pair describing the location of the intersection.
              #
              #   @return [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step::Intersection::Location, nil]
              optional :location,
              ...
              #
              #   @param location [NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step::Intersection::Location] A [longitude, latitude] pair describing the location of the intersection.
              ...
              class Lane < NextbillionSDK::Internal::Type::BaseModel
                ...
                #
                #   @return [Array<String>, nil]
                optional :indications, NextbillionSDK::Internal::Type::ArrayOf[String]
                ...
                #
                #   @return [Boolean, nil]
                optional :valid, NextbillionSDK::Internal::Type::Boolean
            ...
            # @see NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step#maneuver
            class Maneuver < NextbillionSDK::Internal::Type::BaseModel
              ...
              #
              #   @return [Boolean, nil]
              optional :muted, NextbillionSDK::Internal::Type::Boolean
              ...
              optional :voice_instruction,
                       -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step::Maneuver::VoiceInstruction] }
            ...
            # @see NextbillionSDK::Models::NavigationRetrieveRouteResponse::Route::Leg::Step#road_shield_type
