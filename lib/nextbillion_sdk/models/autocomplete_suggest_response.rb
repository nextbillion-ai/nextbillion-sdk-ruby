...
module NextbillionSDK
  module Models
    # @see NextbillionSDK::Resources::Autocomplete#suggest
    class AutocompleteSuggestResponse < NextbillionSDK::Internal::Type::BaseModel
      # @!attribute items
      ...
      #
      #   @return [Array<NextbillionSDK::Models::AutocompleteSuggestResponse::Item>, nil]
      optional :items,
               -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::AutocompleteSuggestResponse::Item] }

      # @!method initialize(items: nil)
      #   Some parameter documentations has been truncated, see
      #   {NextbillionSDK::Models::AutocompleteSuggestResponse} for more details.
      #
      #   @param items [Array<NextbillionSDK::Models::AutocompleteSuggestResponse::Item>] The results are presented as a JSON list of candidates in ranked order (most-lik
      ...
      class Item < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours, nil]
        optional :opening_hours,
                 -> { NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours },
        ...
        #
        #   @return [NextbillionSDK::Models::AutocompleteSuggestResponse::Item::Scoring, nil]
        optional :scoring, -> { NextbillionSDK::Models::AutocompleteSuggestResponse::Item::Scoring }
        ...
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::AutocompleteSuggestResponse::Item} for more details.
        #
        ...
        #
        #   @param opening_hours [NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours] Returns the operating hours of the place, if available.
        #
        #   @param position [NextbillionSDK::Models::Position] Returns the location coordinates of the result.
        #
        #   @param scoring [NextbillionSDK::Models::AutocompleteSuggestResponse::Item::Scoring] Score of the result. A higher score indicates a closer match.
        #
        #   @param title [String] The localized display name of this result item.

        # @see NextbillionSDK::Models::AutocompleteSuggestResponse::Item#opening_hours
        class OpeningHours < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange>, nil]
          optional :time_ranges,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange] },
                   api_name: :timeRanges

          # @!method initialize(time_ranges: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours} for
          #   more details.
          #
          #   Returns the operating hours of the place, if available.
          #
          #   @param time_ranges [Array<NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange>] A collection of attributes with details about the opening and closing hours for

          class TimeRange < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute end_time
            #   Returns the closing time details.
            #
            #   @return [NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange::EndTime, nil]
            optional :end_time,
                     -> { NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange::EndTime },
                     api_name: :endTime

            # @!attribute start_time
            #   Returns the open time details.
            #
            #   @return [NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange::StartTime, nil]
            optional :start_time,
                     -> { NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange::StartTime },
                     api_name: :startTime

            # @!method initialize(end_time: nil, start_time: nil)
            #   @param end_time [NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange::EndTime] Returns the closing time details.
            #
            #   @param start_time [NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange::StartTime] Returns the open time details.

            # @see NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange#end_time
            ...
            # @see NextbillionSDK::Models::AutocompleteSuggestResponse::Item::OpeningHours::TimeRange#start_time
        ...
        # @see NextbillionSDK::Models::AutocompleteSuggestResponse::Item#scoring
        class Scoring < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::AutocompleteSuggestResponse::Item::Scoring} for more
          #   details.
          #
          #   Score of the result. A higher score indicates a closer match.
          #
