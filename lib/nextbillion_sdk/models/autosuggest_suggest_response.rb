...
module NextbillionSDK
  module Models
    # @see NextbillionSDK::Resources::Autosuggest#suggest
    class AutosuggestSuggestResponse < NextbillionSDK::Internal::Type::BaseModel
      # @!attribute items
      ...
      #
      #   @return [Array<NextbillionSDK::Models::AutosuggestSuggestResponse::Item>, nil]
      optional :items,
               -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::AutosuggestSuggestResponse::Item] }

      # @!method initialize(items: nil)
      #   Some parameter documentations has been truncated, see
      #   {NextbillionSDK::Models::AutosuggestSuggestResponse} for more details.
      #
      #   @param items [Array<NextbillionSDK::Models::AutosuggestSuggestResponse::Item>] The results are presented as a JSON list of candidates in ranked order (most-lik
      ...
      class Item < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours, nil]
        optional :opening_hours,
                 -> { NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours },
        ...
        #
        #   @return [NextbillionSDK::Models::AutosuggestSuggestResponse::Item::Scoring, nil]
        optional :scoring, -> { NextbillionSDK::Models::AutosuggestSuggestResponse::Item::Scoring }
        ...
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::AutosuggestSuggestResponse::Item} for more details.
        #
        ...
        #
        #   @param opening_hours [NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours] Returns the operating hours of the place, if available.
        #
        #   @param position [NextbillionSDK::Models::Position] Returns the location coordinates of the result.
        #
        #   @param scoring [NextbillionSDK::Models::AutosuggestSuggestResponse::Item::Scoring] Score of the result. A higher score indicates a closer match.
        #
        #   @param title [String] The localized display name of this result item.

        # @see NextbillionSDK::Models::AutosuggestSuggestResponse::Item#opening_hours
        class OpeningHours < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange>, nil]
          optional :time_ranges,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange] },
                   api_name: :timeRanges

          # @!method initialize(time_ranges: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours} for
          #   more details.
          #
          #   Returns the operating hours of the place, if available.
          #
          #   @param time_ranges [Array<NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange>] A collection of attributes with details about the opening and closing hours for

          class TimeRange < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute end_time
            #   Returns the closing time details.
            #
            #   @return [NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::EndTime, nil]
            optional :end_time,
                     -> { NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::EndTime },
                     api_name: :endTime

            # @!attribute start_time
            #   Returns the open time details.
            #
            #   @return [NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::StartTime, nil]
            optional :start_time,
                     -> { NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::StartTime },
                     api_name: :startTime

            # @!method initialize(end_time: nil, start_time: nil)
            #   @param end_time [NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::EndTime] Returns the closing time details.
            #
            #   @param start_time [NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange::StartTime] Returns the open time details.

            # @see NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange#end_time
            ...
            # @see NextbillionSDK::Models::AutosuggestSuggestResponse::Item::OpeningHours::TimeRange#start_time
        ...
        # @see NextbillionSDK::Models::AutosuggestSuggestResponse::Item#scoring
        class Scoring < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::AutosuggestSuggestResponse::Item::Scoring} for more
          #   details.
          #
          #   Score of the result. A higher score indicates a closer match.
          #
