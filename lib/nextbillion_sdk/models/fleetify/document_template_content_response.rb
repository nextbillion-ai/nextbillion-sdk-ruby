...
module NextbillionSDK
  module Models
    module Fleetify
      class DocumentTemplateContentResponse < NextbillionSDK::Internal::Type::BaseModel
        # @!attribute label
        ...
        #   items.
        #
        #   @return [NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Meta, nil]
        optional :meta, -> { NextbillionSDK::Fleetify::DocumentTemplateContentResponse::Meta }
        ...
        #   field types.
        #
        #   @return [NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Validation, nil]
        optional :validation, -> { NextbillionSDK::Fleetify::DocumentTemplateContentResponse::Validation }

        # @!method initialize(label: nil, meta: nil, name: nil, required: nil, type: nil, validation: nil)
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse} for more
        #   details.
        #
        ...
        #
        #   @param meta [NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Meta] Returns the options configured for single_choice or multi_choices type document
        #
        ...
        #
        #   @param validation [NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Validation] Returns the validation rules for number , multi_choices , and photos document fi

        # @see NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse#meta
        class Meta < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Meta::Option>, nil]
          optional :options,
                   -> {
                     NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Fleetify::DocumentTemplateContentResponse::Meta::Option]
                   }

          # @!method initialize(options: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Meta} for
          #   more details.
          #
          #   Returns the options configured for single_choice or multi_choices type document
          #   items.
          #
          #   @param options [Array<NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Meta::Option>] An array of objects returning the options for multi_choices or single_choice typ
          ...
          class Option < NextbillionSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Meta::Option}
            #   for more details.
            #
        ...
        # @see NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse#validation
        class Validation < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Validation}
          #   for more details.
          #
          #   Returns the validation rules for number , multi_choices , and photos document
          #   field types.
