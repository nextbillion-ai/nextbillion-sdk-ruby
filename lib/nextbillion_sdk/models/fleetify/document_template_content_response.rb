  ...
  module Models
    module Fleetify
      class DocumentTemplateContentResponse < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @param meta [NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Meta] Returns the options configured for `single_choice` or `multi_choices` type docum
        #
        ...
        #
        #   @param validation [NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Validation] Returns the validation rules for `number` , `multi_choices` , and `photos` docum
        ...
        class Meta < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   document items.
          #
          #   @param options [Array<NextbillionSDK::Models::Fleetify::DocumentTemplateContentResponse::Meta::Option>] An array of objects returning the options for `multi_choices` or `single_choice`
