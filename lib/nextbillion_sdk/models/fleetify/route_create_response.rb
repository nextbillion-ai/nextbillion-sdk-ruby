...
module NextbillionSDK
  module Models
    module Fleetify
      ...
      class RouteCreateResponse < NextbillionSDK::Internal::Type::BaseModel
        # @!attribute data
        #   An array of objects containing the details of each step in the dispatched route.
        #   Each object represents a single step.
        #
        #   @return [NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data, nil]
        optional :data, -> { NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data }
        ...
        #   {NextbillionSDK::Models::Fleetify::RouteCreateResponse} for more details.
        #
        #   @param data [NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data] An array of objects containing the details of each step in the dispatched route.
        #
        #   @param status [Integer] Returns the status code of the response.

        # @see NextbillionSDK::Models::Fleetify::RouteCreateResponse#data
        class Data < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data::Driver, nil]
          optional :driver, -> { NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data::Driver }
          ...
          #
          #   @return [Array<NextbillionSDK::Models::Fleetify::Routes::RouteStepsResponse>, nil]
          optional :steps,
                   -> {
                     NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Fleetify::Routes::RouteStepsResponse]
                   }
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data} for more details.
          #
          #   An array of objects containing the details of each step in the dispatched route.
          #   Each object represents a single step.
          #
          ...
          #
          #   @param driver [NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data::Driver] An object returning the details of the driver to whom the route was dispatched.
          #
          ...
          #
          #   @param steps [Array<NextbillionSDK::Models::Fleetify::Routes::RouteStepsResponse>] An array of objects containing the details of all steps to be performed as part
          #
          ...
          # @see NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data#driver
          class Driver < NextbillionSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Fleetify::RouteCreateResponse::Data::Driver} for more
            #   details.
            #
            #   An object returning the details of the driver to whom the route was dispatched.
            #
