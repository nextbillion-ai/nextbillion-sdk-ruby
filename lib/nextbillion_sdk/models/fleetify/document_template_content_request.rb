  ...
  module Models
    module Fleetify
      class DocumentTemplateContentRequest < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @param meta [NextbillionSDK::Models::Fleetify::DocumentTemplateContentRequest::Meta] An object to define additional information required for `single_choice` or `mult
        #
        ...
        class Meta < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   `multi_choices` type document items.
          #
          #   @param options [Array<NextbillionSDK::Models::Fleetify::DocumentTemplateContentRequest::Meta::Option>] An array of objects to define options for a `multi_choices` or `single_choice` t
