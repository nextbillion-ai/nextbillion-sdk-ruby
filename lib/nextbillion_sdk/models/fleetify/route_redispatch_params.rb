  ...
  module Models
    module Fleetify
      ...
      class RouteRedispatchParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<NextbillionSDK::Models::Fleetify::RouteRedispatchParams::Operation>]
        required :operations,
                 -> {
                   NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Fleetify::RouteRedispatchParams::Operation]
                 }
        ...
        #
        #   @param operations [Array<NextbillionSDK::Models::Fleetify::RouteRedispatchParams::Operation>] A collection of objects with details of the steps to be modified. Each object co
        #
        ...
        class Operation < NextbillionSDK::Internal::Type::BaseModel
          # @!attribute data
          #
          #   @return [NextbillionSDK::Models::Fleetify::RouteRedispatchParams::Operation::Data]
          required :data, -> { NextbillionSDK::Fleetify::RouteRedispatchParams::Operation::Data }

          # @!attribute operation
          #   Specify the type of operation to be performed for the step.
          #
          #   @return [Symbol, NextbillionSDK::Models::Fleetify::RouteRedispatchParams::Operation::Operation]
          required :operation,
                   enum: -> {
          ...
          #   @param data [NextbillionSDK::Models::Fleetify::RouteRedispatchParams::Operation::Data]
          #
          #   @param operation [Symbol, NextbillionSDK::Models::Fleetify::RouteRedispatchParams::Operation::Operation] Specify the type of operation to be performed for the step.

          # @see NextbillionSDK::Models::Fleetify::RouteRedispatchParams::Operation#data
          class Data < NextbillionSDK::Internal::Type::BaseModel
            ...
            # @!attribute step
            #
            #   @return [NextbillionSDK::Models::Fleetify::Routes::RouteStepsRequest, nil]
            optional :step, -> { NextbillionSDK::Fleetify::Routes::RouteStepsRequest }
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Fleetify::RouteRedispatchParams::Operation::Data} for
            #   more details.
            #
            ...
            #
            #   @param step [NextbillionSDK::Models::Fleetify::Routes::RouteStepsRequest]
            #
            #   @param step_id [String] Specify the ID of the step to be updated or deleted. Either one of `id` or `shor
          end

          # Specify the type of operation to be performed for the step.
          #
          # @see NextbillionSDK::Models::Fleetify::RouteRedispatchParams::Operation#operation
          module Operation
