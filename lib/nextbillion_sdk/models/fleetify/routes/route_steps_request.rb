    ...
    module Fleetify
      module Routes
        class RouteStepsRequest < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @param type [Symbol, NextbillionSDK::Models::Fleetify::Routes::RouteStepsRequest::Type] Specify the step type. It can belong to one of the following: start, job , picku
          #
