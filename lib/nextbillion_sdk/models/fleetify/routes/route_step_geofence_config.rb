    ...
    module Fleetify
      module Routes
        class RouteStepGeofenceConfig < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @param type [Symbol, NextbillionSDK::Models::Fleetify::Routes::RouteStepGeofenceConfig::Type] Specify the type of the geofence. Currently, `circle` is the only suppoeted valu
