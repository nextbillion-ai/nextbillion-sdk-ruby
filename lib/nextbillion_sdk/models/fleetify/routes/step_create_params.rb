...
module NextbillionSDK
  module Models
    module Fleetify
      module Routes
        # @see NextbillionSDK::Resources::Fleetify::Routes::Steps#create
        class StepCreateParams < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   layover or a break.
          #
          #   @return [Symbol, NextbillionSDK::Models::Fleetify::Routes::StepCreateParams::Type]
          required :type, enum: -> { NextbillionSDK::Fleetify::Routes::StepCreateParams::Type }
          ...
          #
          #   @return [NextbillionSDK::Models::Fleetify::Routes::StepCreateParams::Meta, nil]
          optional :meta, -> { NextbillionSDK::Fleetify::Routes::StepCreateParams::Meta }
          ...
          #
          #   @param type [Symbol, NextbillionSDK::Models::Fleetify::Routes::StepCreateParams::Type] Specify the step type. It can belong to one of the following: start, job , picku
          #
          ...
          #
          #   @param meta [NextbillionSDK::Models::Fleetify::Routes::StepCreateParams::Meta] An object to specify any additional details about the task to be associated with
          #
