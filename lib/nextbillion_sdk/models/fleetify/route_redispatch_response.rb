...
module NextbillionSDK
  module Models
    module Fleetify
      # @see NextbillionSDK::Resources::Fleetify::Routes#redispatch
      class RouteRedispatchResponse < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data, nil]
        optional :data, -> { NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data }
        ...
        #   {NextbillionSDK::Models::Fleetify::RouteRedispatchResponse} for more details.
        #
        #   @param data [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data] An array of objects containing the details of each step in the dispatched route.
        #
        ...
        # @see NextbillionSDK::Models::Fleetify::RouteRedispatchResponse#data
        class Data < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Completion, nil]
          optional :completion, -> { NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Completion }
          ...
          #
          #   @return [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Driver, nil]
          optional :driver, -> { NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Driver }
          ...
          #
          #   @return [NextbillionSDK::Models::Fleetify::RoutingResponse, nil]
          optional :routing, -> { NextbillionSDK::Fleetify::RoutingResponse }
          ...
          # @!attribute steps
          #
          #   @return [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps, nil]
          optional :steps, -> { NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps }
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data} for more
          #   details.
          #
          #   An array of objects containing the details of each step in the dispatched route.
          #   Each object represents a single step.
          ...
          #
          #   @param completion [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Completion] Returns the completion status of the route.
          #
          ...
          #
          #   @param driver [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Driver] An object returning the details of the driver to whom the route was dispatched.
          #
          #   @param ro_request_id [String] Returns the route optimization request ID which was used to dispatch the route.
          #
          #   @param routing [NextbillionSDK::Models::Fleetify::RoutingResponse] An object returning the routing characteristics that are used to generate the ro
          #
          #   @param short_id [String] Returns a shorter unique ID of the route for easier referencing and displaying p
          #
          #   @param steps [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps]
          #
          ...
          # @see NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data#completion
          class Completion < NextbillionSDK::Internal::Type::BaseModel
            ...
            #   "scheduled", "completed".
            #
            #   @return [Symbol, NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Completion::Status, nil]
            optional :status,
                     enum: -> { NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Completion::Status }
            ...
            #   Returns the completion status of the route.
            #
            #   @param status [Symbol, NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Completion::Status] Returns the status of the route. It can take one of the following values - "sche

            # Returns the status of the route. It can take one of the following values -
            # "scheduled", "completed".
            #
            # @see NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Completion#status
            module Status
          ...
          # @see NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data#driver
          class Driver < NextbillionSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Driver} for
            #   more details.
            #
            #   An object returning the details of the driver to whom the route was dispatched.
            #
          ...
          # @see NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data#steps
          class Steps < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps::Completion, nil]
            optional :completion,
            ...
            #
            #   @return [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps::Meta, nil]
            optional :meta, -> { NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps::Meta }
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps} for
            #   more details.
            #
            ...
            #
            #   @param completion [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps::Completion] Returns the completion status of the step.
            #
            ...
            #
            #   @param meta [NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps::Meta] An object returning custom details about the step that were configured in the in
            #
            ...
            # @see NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps#completion
            class Completion < NextbillionSDK::Internal::Type::BaseModel
              # @!attribute status
            ...
            # @see NextbillionSDK::Models::Fleetify::RouteRedispatchResponse::Data::Steps#meta
