  ...
  module Models
    module Optimization
      ...
      class V2RetrieveResultResponse < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result, nil]
        optional :result, -> { NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result }
        ...
        #
        #   @return [Symbol, NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Status, nil]
        optional :status, enum: -> { NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Status }
        ...
        #
        #   @param result [NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result] An object containing the details of the optimized routes.
        #
        #   @param status [Symbol, NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Status] It indicates the overall status or result of the API request denoting whether th

        # @see NextbillionSDK::Models::Optimization::V2RetrieveResultResponse#result
        class Result < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route>, nil]
          optional :routes,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route] }
          ...
          #   parameters.
          #
          #   @return [NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Summary, nil]
          optional :summary, -> { NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Summary }
          ...
          #
          #   @return [Array<NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Unassigned>, nil]
          optional :unassigned,
                   -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Unassigned] }

          # @!method initialize(code: nil, error: nil, routes: nil, routing_profiles: nil, summary: nil, unassigned: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result} for
          #   more details.
          #
          #   An object containing the details of the optimized routes.
          #
          ...
          #
          #   @param routes [Array<NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route>] An array of objects containing the details of each route in the optimized soluti
          #
          #   @param routing_profiles [Object] Returns all the routing profiles used in the solution. If no routing profiles we
          #
          #   @param summary [NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Summary] An object to describe the summarized result of the optimization request. This ob
          #
          #   @param unassigned [Array<NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Unassigned>] An array of objects containing the details of unassigned tasks in the optimized
          ...
          class Route < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route::Step>, nil]
            optional :steps,
                     -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route::Step] }
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route}
            #   for more details.
            #
            ...
            #
            #   @param steps [Array<NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route::Step>] This attribute contains the details of all the steps involved in the route. It i
            #
            ...
            class Step < NextbillionSDK::Internal::Type::BaseModel
              ...
              #
              #   @return [Array<Float>, nil]
              optional :projected_location, NextbillionSDK::Internal::Type::ArrayOf[Float]
              ...
              #
              #   @return [Array<Float>, nil]
              optional :snapped_location, NextbillionSDK::Internal::Type::ArrayOf[Float]
              ...
              #   Some parameter documentations has been truncated, see
              #   {NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Route::Step}
              #   for more details.
              #
              #   This attribute contains the details of all the steps involved in the route. It
              #   is an array of objects with each object representing one step.
          ...
          # @see NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result#summary
          class Summary < NextbillionSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Summary}
            #   for more details.
            #
            #   An object to describe the summarized result of the optimization request. This
            #   object can be useful to quickly get an overview of the important result
          ...
          class Unassigned < NextbillionSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2RetrieveResultResponse::Result::Unassigned}
            #   for more details.
            #
        ...
        # the operation was successful or did it encounter any errors.
        #
        # @see NextbillionSDK::Models::Optimization::V2RetrieveResultResponse#status
        module Status
