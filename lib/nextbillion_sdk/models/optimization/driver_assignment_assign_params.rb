...
module NextbillionSDK
  module Models
    module Optimization
      ...
      class DriverAssignmentAssignParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        required :orders,
                 -> {
                   NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::DriverAssignmentAssignParams::Order]
                 }
        ...
        #
        #   @return [NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options, nil]
        optional :options, -> { NextbillionSDK::Optimization::DriverAssignmentAssignParams::Options }
        ...
        #
        #   @param filter [NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Filter] Specify the filtering criterion for the vehicles with respect to each order's lo
        #
        #   @param orders [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order>] Collects the details of open orders to be fulfilled. Each object represents one
        #
        #   @param vehicles [Array<NextbillionSDK::Models::Optimization::Vehicle>] Collects the details of vehicles available to fulfill the orders. Each object re
        #
        #   @param options [NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options] Configure the assignment constraints and response settings.
        #
        ...
        class Filter < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Filter} for
          #   more details.
          #
          #   Specify the filtering criterion for the vehicles with respect to each order's
          #   location. filter is a mandatory input for all requests.
        ...
        class Order < NextbillionSDK::Internal::Type::BaseModel
          # @!attribute id
          ...
          #
          #   @return [NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::Pickup]
          required :pickup, -> { NextbillionSDK::Optimization::DriverAssignmentAssignParams::Order::Pickup }
          ...
          optional :dropoffs,
                   -> {
                     NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::DriverAssignmentAssignParams::Order::Dropoff]
                   }
          ...
          optional :vehicle_preferences,
                   -> {
                     NextbillionSDK::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences
                   }

          # @!method initialize(id:, pickup:, attributes: nil, dropoffs: nil, priority: nil, service_time: nil, vehicle_preferences: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order} for
          #   more details.
          #
          #   @param id [String] Specify a unique ID for the order.
          #
          #   @param pickup [NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::Pickup] Specify the location coordinates of the pickup location of the order. This input
          #
          #   @param attributes [Object] Specify custom attributes for the orders. Each attribute should be created as a
          #
          #   @param dropoffs [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::Dropoff>] Use this parameter to specify the location coordinates of the destination of the
          #
          ...
          #
          #   @param vehicle_preferences [NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences] Define custom preferences for task assignment based on vehicle's attributes. If

          # @see NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order#pickup
          ...
          class Dropoff < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute lat
          ...
          # @see NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order#vehicle_preferences
          class VehiclePreferences < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences::ExcludeAllOfAttribute>, nil]
            optional :exclude_all_of_attributes,
                     -> do
                       NextbillionSDK::Internal::Type::ArrayOf[
                         NextbillionSDK::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences::ExcludeAllOfAttribute
                       ]
                     end
            ...
            #
            #   @return [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences::RequiredAllOfAttribute>, nil]
            optional :required_all_of_attributes,
                     -> do
                       NextbillionSDK::Internal::Type::ArrayOf[
                         NextbillionSDK::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences::RequiredAllOfAttribute
                       ]
                     end
            ...
            #   maximum of 10 conditions can be added here for a given order.
            #
            #   @return [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences::RequiredAnyOfAttribute>, nil]
            optional :required_any_of_attributes,
                     -> do
                       NextbillionSDK::Internal::Type::ArrayOf[
                         NextbillionSDK::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences::RequiredAnyOfAttribute
                       ]
                     end

            # @!method initialize(exclude_all_of_attributes: nil, required_all_of_attributes: nil, required_any_of_attributes: nil)
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences}
            #   for more details.
            #
            #   Define custom preferences for task assignment based on vehicle's attributes. If
            #   multiple criteria are provided, they are evaluated using an AND
            ...
            #
            #   @param required_all_of_attributes [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences::RequiredAllOfAttribute>] An array of objects to add mandatory requirements for the order. A vehicle must
            #
            #   @param required_any_of_attributes [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Order::VehiclePreferences::RequiredAnyOfAttribute>] An array of objects to add optional requirements for the order. A vehicle
            #   must \*
        ...
        class Options < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Boolean, nil]
          optional :dropoff_details, NextbillionSDK::Internal::Type::Boolean
          ...
          #   such an order.
          #
          #   @return [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options::OrderAttributePriorityMapping>, nil]
          optional :order_attribute_priority_mappings,
                   -> {
                     NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::DriverAssignmentAssignParams::Options::OrderAttributePriorityMapping]
                   }
          ...
          #
          #   @return [Symbol, NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options::TravelCost, nil]
          optional :travel_cost,
                   enum: -> {
                     NextbillionSDK::Optimization::DriverAssignmentAssignParams::Options::TravelCost
                   }
          ...
          #   such a vehicle.
          #
          #   @return [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options::VehicleAttributePriorityMapping>, nil]
          optional :vehicle_attribute_priority_mappings,
                   -> {
                     NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::DriverAssignmentAssignParams::Options::VehicleAttributePriorityMapping]
                   }
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options}
          #   for more details.
          #
          #   Configure the assignment constraints and response settings.
          #
          ...
          #
          #   @param order_attribute_priority_mappings [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options::OrderAttributePriorityMapping>] Collection of rules for assigning custom priority to orders based on their attri
          #
          #   @param travel_cost [Symbol, NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options::TravelCost] Choose a travel cost that will be used by the service for assigning vehicles eff
          #
          #   @param vehicle_attribute_priority_mappings [Array<NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options::VehicleAttributePriorityMapping>] Collection of rules for assigning custom priority to vehicles based on their att
          ...
          # efficiently from a set of qualifying ones.
          #
          # @see NextbillionSDK::Models::Optimization::DriverAssignmentAssignParams::Options#travel_cost
          module TravelCost
