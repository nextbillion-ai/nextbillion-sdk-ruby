  ...
  module Models
    module Optimization
      class Vehicle < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [NextbillionSDK::Models::Optimization::Vehicle::Location]
        required :location, -> { NextbillionSDK::Optimization::Vehicle::Location }
        ...
        #
        #   @return [Array<NextbillionSDK::Models::Optimization::Location>, nil]
        optional :remaining_waypoints,
                 -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::Location] }

        # @!method initialize(id:, location:, attributes: nil, priority: nil, remaining_waypoints: nil)
        #   Some parameter documentations has been truncated, see
        #   {NextbillionSDK::Models::Optimization::Vehicle} for more details.
        #
        #   @param id [String] Specify a unique ID for the vehicle.
        #
        #   @param location [NextbillionSDK::Models::Optimization::Vehicle::Location] Specify the location coordinates where the vehicle is currently located. This in
        #
        ...
        #
        #   @param remaining_waypoints [Array<NextbillionSDK::Models::Optimization::Location>] An array of objects to collect the location coordinates of the stops remaining o

        # @see NextbillionSDK::Models::Optimization::Vehicle#location
