...
module NextbillionSDK
  module Models
    module Optimization
      # @see NextbillionSDK::Resources::Optimization::V2#submit
      class V2SubmitParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Locations]
        required :locations, -> { NextbillionSDK::Optimization::V2SubmitParams::Locations }
        ...
        required :vehicles,
                 -> {
                   NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::Vehicle]
                 }
        ...
        #
        #   @return [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Depot>, nil]
        optional :depots,
                 -> {
                   NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::V2SubmitParams::Depot]
                 }
        ...
        optional :jobs, -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::Job] }
        ...
        #   business objectives.
        #
        #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Options, nil]
        optional :options, -> { NextbillionSDK::Optimization::V2SubmitParams::Options }
        ...
        #   section.
        #
        #   @return [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Relation>, nil]
        optional :relations,
                 -> {
                   NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::V2SubmitParams::Relation]
                 }
        ...
        #
        #   @return [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Solution>, nil]
        optional :solution,
                 -> {
                   NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::V2SubmitParams::Solution]
                 }
        ...
        #
        #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Unassigned, nil]
        optional :unassigned, -> { NextbillionSDK::Optimization::V2SubmitParams::Unassigned }
        ...
        #
        #   @return [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Zone>, nil]
        optional :zones,
                 -> {
                   NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::V2SubmitParams::Zone]
                 }
        ...
        #
        #   @param locations [NextbillionSDK::Models::Optimization::V2SubmitParams::Locations] The `locations` object is used to define all the locations that will be used dur
        #
        #   @param vehicles [Array<NextbillionSDK::Models::Optimization::Vehicle>] The `vehicles` attribute describes the characteristics and constraints of the ve
        #
        #   @param cost_matrix [Array<Array<Integer>>] An array of arrays to denote the user-defined costs of traveling between each pa
        #
        #   @param depots [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Depot>] `depots` object is used to collect the details of a depot. Depots can be used as
        #
        ...
        #
        #   @param jobs [Array<NextbillionSDK::Models::Optimization::Job>] `jobs` object is used to collect the details of a particular job or task that ne
        #
        #   @param options [NextbillionSDK::Models::Optimization::V2SubmitParams::Options] It represents the set of options that can be used to configure optimization algo
        #
        #   @param relations [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Relation>] `relations` attribute is an array of individual relation objects. `type` paramet
        #
        #   @param shipments [Array<NextbillionSDK::Models::Optimization::Shipment>] The `shipments` object is used to collect the details of shipments that need to
        #
        #   @param solution [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Solution>] This attribute is related to the re-optimization feature. It allows for the prev
        #
        #   @param unassigned [NextbillionSDK::Models::Optimization::V2SubmitParams::Unassigned] `unassigned` attribute is related to the re-optimization feature. This attribute
        #
        #   @param zones [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Zone>] An array of objects to specify geometry of all the zones involved. Each object c
        #
        ...
        class Locations < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<String>]
          required :location, NextbillionSDK::Internal::Type::ArrayOf[String]
          ...
          #
          #   @return [Array<Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Locations::Approach>, nil]
          optional :approaches,
                   -> {
                     NextbillionSDK::Internal::Type::ArrayOf[enum: NextbillionSDK::Optimization::V2SubmitParams::Locations::Approach]
                   }

          # @!method initialize(location:, id: nil, approaches: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Locations} for more
          #   details.
          #
          #   The `locations` object is used to define all the locations that will be used
          #   during the optimization process. Read more about this attribute in the
          ...
          #
          #   @param approaches [Array<Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Locations::Approach>] Describe if the location is curbside. An array of strings indicates the side of
        ...
        class Depot < NextbillionSDK::Internal::Type::BaseModel
          # @!attribute id
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Depot} for more details.
          #
          #   @param id [String] Provide an unique ID for the depot. The IDs are case sensitive.
          #
          #   @param location_index [Integer] Specify the index of coordinates (in the `location` array) denoting the depot’s
          #
        ...
        class Options < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   other types.
          #
          #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Constraint, nil]
          optional :constraint, -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Constraint }
          ...
          #
          #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping, nil]
          optional :grouping, -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Grouping }

          # @!attribute objective
          #   This attribute is used to configure the objective of the optimization job.
          #
          #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective, nil]
          optional :objective, -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Objective }

          # @!attribute routing
          #   This attribute is used to define the routing configurations for the optimization
          #   job.
          #
          #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing, nil]
          optional :routing, -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Routing }

          # @!method initialize(constraint: nil, grouping: nil, objective: nil, routing: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Options} for more
          #   details.
          #
          #   It represents the set of options that can be used to configure optimization
          #   algorithms so that the solver provides a solution that meets the desired
          #   business objectives.
          #
          #   @param constraint [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Constraint] This attribute defines both the soft and hard constraints for an optimization jo
          #
          #   @param grouping [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping] Set grouping rules for the tasks and routes.
          #
          #   @param objective [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective] This attribute is used to configure the objective of the optimization job.
          #
          #   @param routing [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing] This attribute is used to define the routing configurations for the optimization

          # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options#constraint
          class Constraint < NextbillionSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Constraint} for
            #   more details.
            #
            #   This attribute defines both the soft and hard constraints for an optimization
            #   job.
          ...
          # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options#grouping
          class Grouping < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping::OrderGrouping, nil]
            optional :order_grouping,
                     -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Grouping::OrderGrouping }
            ...
            #
            #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping::RouteGrouping, nil]
            optional :route_grouping,
                     -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Grouping::RouteGrouping }

            # @!method initialize(order_grouping: nil, proximity_factor: nil, route_grouping: nil)
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping} for
            #   more details.
            #
            #   Set grouping rules for the tasks and routes.
            #
            ...
            #   - Use `route_grouping` to control route sequencing.
            #
            #   @param order_grouping [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping::OrderGrouping] Specify the criteria for grouping nearby tasks. The grouped tasks will be treate
            #
            #   @param proximity_factor [Float] When specified, routes are built taking into account the distance to the nearest
            #
            #   @param route_grouping [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping::RouteGrouping] Specify the criteria for prioritising routes in a zone over routes that are part

            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping#order_grouping
            class OrderGrouping < NextbillionSDK::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping::OrderGrouping}
              #   for more details.
              #
              #   Specify the criteria for grouping nearby tasks. The grouped tasks will be
              #   treated as one stop by the optimizer and no cost would be incurred when driver
            ...
            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping#route_grouping
            class RouteGrouping < NextbillionSDK::Internal::Type::BaseModel
              ...
              #
              #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping::RouteGrouping::ZoneSource, nil]
              optional :zone_source,
                       enum: -> {
                         NextbillionSDK::Optimization::V2SubmitParams::Options::Grouping::RouteGrouping::ZoneSource
                       }

              # @!method initialize(penalty_factor: nil, zone_diameter: nil, zone_source: nil)
              #   Some parameter documentations has been truncated, see
              #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping::RouteGrouping}
              #   for more details.
              #
              #   Specify the criteria for prioritising routes in a zone over routes that are part
              #   of another zone. As a result, all the tasks falling in a zone will be fulfilled
              ...
              #
              #   @param zone_source [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping::RouteGrouping::ZoneSource] Specify the source for creating boundaries of the routing zones. The default val
              ...
              #   `zones` attribute is null or missing in the input request.
              #
              # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Grouping::RouteGrouping#zone_source
              module ZoneSource
                extend NextbillionSDK::Internal::Type::Enum
          ...
          # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options#objective
          class Objective < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Boolean, nil]
            optional :allow_early_arrival, NextbillionSDK::Internal::Type::Boolean

            # @!attribute custom
            #   The `custom` parameter is used to define special objectives apart from the
            #   simpler travel cost minimization objectives.
            #
            #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::Custom, nil]
            optional :custom, -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Objective::Custom }

            # @!attribute minimise_num_depots
            #   Specify whether to minimize the number of depots used in optimization routes.
            #
            #   @return [Boolean, nil]
            optional :minimise_num_depots, NextbillionSDK::Internal::Type::Boolean
            ...
            #
            #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::SolverMode, nil]
            optional :solver_mode,
                     enum: -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Objective::SolverMode }
            ...
            #   completed.
            #
            #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::TravelCost, nil]
            optional :travel_cost,
                     enum: -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Objective::TravelCost }
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective} for
            #   more details.
            #
            #   This attribute is used to configure the objective of the optimization job.
            #
            #   @param allow_early_arrival [Boolean] Choose where the optimizer should schedule the driver’s wait time. When set to `
            #
            #   @param custom [NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::Custom] The `custom` parameter is used to define special objectives apart from the simpl
            #
            #   @param minimise_num_depots [Boolean] Specify whether to minimize the number of depots used in optimization routes.
            #
            #   @param solver_mode [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::SolverMode] If the input doesn’t include features of soft constraints, customized objectives
            #
            #   @param solving_time_limit [Integer] Specify the number of seconds within which the optimizer should ideally solve th
            #
            #   @param travel_cost [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::TravelCost] The `travel_cost` parameter specifies the type of cost used by the solver to det

            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective#custom
            class Custom < NextbillionSDK::Internal::Type::BaseModel
              # @!attribute type
              ...
              #
              #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::Custom::Type]
              required :type,
                       enum: -> {
                         NextbillionSDK::Optimization::V2SubmitParams::Options::Objective::Custom::Type
                       }
              ...
              #   approaches.
              #
              #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::Custom::Value]
              required :value,
                       enum: -> {
                         NextbillionSDK::Optimization::V2SubmitParams::Options::Objective::Custom::Value
                       }

              # @!method initialize(type:, value:)
              #   Some parameter documentations has been truncated, see
              #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::Custom}
              #   for more details.
              #
              #   The `custom` parameter is used to define special objectives apart from the
              #   simpler travel cost minimization objectives.
              #
              #   @param type [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::Custom::Type] The `type` parameter accepts two inputs:
              #
              #   @param value [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::Custom::Value] The `value` parameter accepts four inputs, two of them are valid for `min` type
              ...
              # Please note that `type` is mandatory only when using `custom` attribute.
              #
              # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::Custom#type
              module Type
                extend NextbillionSDK::Internal::Type::Enum
              ...
              # approaches.
              #
              # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective::Custom#value
              module Value
                extend NextbillionSDK::Internal::Type::Enum
            ...
            # still goes to “flexible” mode.
            #
            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective#solver_mode
            module SolverMode
              extend NextbillionSDK::Internal::Type::Enum
            ...
            # completed.
            #
            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Objective#travel_cost
            module TravelCost
              extend NextbillionSDK::Internal::Type::Enum
          ...
          # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options#routing
          class Routing < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute allow
            #
            #   @return [Array<Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::Allow>, nil]
            optional :allow,
                     -> {
                       NextbillionSDK::Internal::Type::ArrayOf[enum: NextbillionSDK::Optimization::V2SubmitParams::Options::Routing::Allow]
                     }
            ...
            #
            #   @return [Array<Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::Avoid>, nil]
            optional :avoid,
                     -> {
                       NextbillionSDK::Internal::Type::ArrayOf[enum: NextbillionSDK::Optimization::V2SubmitParams::Options::Routing::Avoid]
                     }
            ...
            #
            #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::Context, nil]
            optional :context,
                     enum: -> {
                       NextbillionSDK::Optimization::V2SubmitParams::Options::Routing::Context
                     }
            ...
            #
            #   @return [Boolean, nil]
            optional :disable_cache, NextbillionSDK::Internal::Type::Boolean
            ...
            #
            #   @return [Array<Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::HazmatType>, nil]
            optional :hazmat_type,
                     -> {
                       NextbillionSDK::Internal::Type::ArrayOf[enum: NextbillionSDK::Optimization::V2SubmitParams::Options::Routing::HazmatType]
                     }

            # @!attribute mode
            #   Define the traveling mode to be used for determining the optimized routes.
            #
            #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::Mode, nil]
            optional :mode, enum: -> { NextbillionSDK::Optimization::V2SubmitParams::Options::Routing::Mode }
            ...
            #
            #   @return [Object, nil]
            optional :profiles, NextbillionSDK::Internal::Type::Unknown
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing} for
            #   more details.
            #
            #   This attribute is used to define the routing configurations for the optimization
            #   job.
            #
            #   @param allow [Array<Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::Allow>]
            #
            #   @param avoid [Array<Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::Avoid>] Specify the type of objects/maneuvers that the route should avoid.
            #
            #   @param context [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::Context] Use this parameter to apply a single speed value for all ETA and drive time calc
            #
            ...
            #
            #   @param hazmat_type [Array<Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::HazmatType>] Specify the type of hazardous material being carried and the service will avoid
            #
            #   @param mode [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing::Mode] Define the traveling mode to be used for determining the optimized routes.
            #
            #   @param profiles [Object] Defines all the vehicle profiles. `profiles` is implemented as a dictionary of o
            #
            ...
            # parameter also impacts the cost of the solution.
            #
            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing#context
            module Context
              extend NextbillionSDK::Internal::Type::Enum
            ...
            # Define the traveling mode to be used for determining the optimized routes.
            #
            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Options::Routing#mode
            module Mode
              extend NextbillionSDK::Internal::Type::Enum
        ...
        class Relation < NextbillionSDK::Internal::Type::BaseModel
          # @!attribute steps
          ...
          #
          #   @return [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Relation::Step>]
          required :steps,
                   -> {
                     NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::V2SubmitParams::Relation::Step]
                   }
          ...
          #   object.
          #
          #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Relation::Type]
          required :type, enum: -> { NextbillionSDK::Optimization::V2SubmitParams::Relation::Type }
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Relation} for more
          #   details.
          #
          #   @param steps [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Relation::Step>] The `steps` property specifies the tasks or steps that are part of the relation
          #
          #   @param type [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Relation::Type] Specifies the type of relation constraint. The following types are supported:
          #
          #   @param id [Integer] **Deprecated! Please use the** `vehicle` \*_parameter to specify the vehicle
          #   ID._
          #
          #   @param max_duration [Integer] This attribute is effective only when `precedence` type relation is used. `max_d
          #
          #   @param min_duration [Integer] This attribute is effective only when `precedence` type relation is used. Use `m
          #
          ...
          class Step < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Relation::Step::Type]
            required :type, enum: -> { NextbillionSDK::Optimization::V2SubmitParams::Relation::Step::Type }
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Relation::Step} for more
            #   details.
            #
            #   @param type [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Relation::Step::Type] Specifies the type of the step. The `start` and `end` step types have to be the
            #
            ...
            # Please note that the `type` is mandatory when using the `relations` object.
            #
            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Relation::Step#type
            module Type
              extend NextbillionSDK::Internal::Type::Enum
          ...
          # object.
          #
          # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Relation#type
          module Type
            extend NextbillionSDK::Internal::Type::Enum
        ...
        class Solution < NextbillionSDK::Internal::Type::BaseModel
          # @!attribute cost
          ...
          #
          #   @return [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Solution::Step>]
          required :steps,
                   -> {
                     NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Optimization::V2SubmitParams::Solution::Step]
                   }
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Solution} for more
          #   details.
          #
          #   @param cost [Integer] Specify the cost of the route.
          #
          #   @param steps [Array<NextbillionSDK::Models::Optimization::V2SubmitParams::Solution::Step>] Describe the steps in this route.
          #
          ...
          class Step < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Solution::Step::Type]
            required :type, enum: -> { NextbillionSDK::Optimization::V2SubmitParams::Solution::Step::Type }
            ...
            #
            #   @return [Array<Integer>, nil]
            optional :load_, NextbillionSDK::Internal::Type::ArrayOf[Integer], api_name: :load
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Solution::Step} for more
            #   details.
            #
            #   Describe details about a step of a route
            #
            #   @param id [String] The ID of the step. This field is mandatory for all steps except for `start` and
            #
            #   @param arrival [Integer] Specify the time at which the vehicle arrives at the `step` location. If `time_w
            #
            #   @param type [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Solution::Step::Type] Specify the type of the step.
            #
            ...
            #
            #   @param location_index [Integer] Specify the index (in the `location` array) of the location coordinates where th
            #
            ...
            # Specify the type of the step.
            #
            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Solution::Step#type
            module Type
              extend NextbillionSDK::Internal::Type::Enum
        ...
        class Unassigned < NextbillionSDK::Internal::Type::BaseModel
          ...
          optional :jobs, NextbillionSDK::Internal::Type::ArrayOf[String]
          ...
          optional :shipments,
                   NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Internal::Type::ArrayOf[String]]

          # @!method initialize(jobs: nil, shipments: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Unassigned} for more
          #   details.
          #
          #   `unassigned` attribute is related to the re-optimization feature. This attribute
          #   should contain the tasks that were not assigned during an earlier optimization
        ...
        class Zone < NextbillionSDK::Internal::Type::BaseModel
          # @!attribute id
          ...
          #   Please note that one of `geometry` or `geofence_id` should be provided.
          #
          #   @return [NextbillionSDK::Models::Optimization::V2SubmitParams::Zone::Geometry, nil]
          optional :geometry, -> { NextbillionSDK::Optimization::V2SubmitParams::Zone::Geometry }

          # @!method initialize(id:, geofence_id: nil, geometry: nil)
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Zone} for more details.
          #
          ...
          #
          #   @param geometry [NextbillionSDK::Models::Optimization::V2SubmitParams::Zone::Geometry] It is a [geoJSON object](https://datatracker.ietf.org/doc/html/rfc7946#page-9) w

          # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Zone#geometry
          class Geometry < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Zone::Geometry::Type, nil]
            optional :type, enum: -> { NextbillionSDK::Optimization::V2SubmitParams::Zone::Geometry::Type }

            # @!method initialize(coordinates: nil, description: nil, type: nil)
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Optimization::V2SubmitParams::Zone::Geometry} for more
            #   details.
            #
            #   It is a [geoJSON object](https://datatracker.ietf.org/doc/html/rfc7946#page-9)
            #   with details of the geographic boundaries of the zone. Only “Polygon” and
            ...
            #
            #   @param type [Symbol, NextbillionSDK::Models::Optimization::V2SubmitParams::Zone::Geometry::Type] Type of the geoJSON geometry. Should always be `Polygon` or `MultiPolygon`.

            # Type of the geoJSON geometry. Should always be `Polygon` or `MultiPolygon`.
            #
            # @see NextbillionSDK::Models::Optimization::V2SubmitParams::Zone::Geometry#type
            module Type
              extend NextbillionSDK::Internal::Type::Enum
