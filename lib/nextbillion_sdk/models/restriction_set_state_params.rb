...
module NextbillionSDK
  module Models
    ...
    class RestrictionSetStateParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      #
      #   @param state [Symbol, NextbillionSDK::Models::RestrictionSetStateParams::State] Use this field to specify the new `state` of the restriction. Please note that t
      #
