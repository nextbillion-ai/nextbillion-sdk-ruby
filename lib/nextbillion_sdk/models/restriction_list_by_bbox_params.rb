...
module NextbillionSDK
  module Models
    # @see NextbillionSDK::Resources::Restrictions#list_by_bbox
    class RestrictionListByBboxParams < NextbillionSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Symbol, NextbillionSDK::Models::RestrictionListByBboxParams::Mode>, nil]
      optional :mode,
               -> {
                 NextbillionSDK::Internal::Type::ArrayOf[enum: NextbillionSDK::RestrictionListByBboxParams::Mode]
               }

      # @!attribute restriction_type
      #   Specify the type of restrictions to fetch.
      #
      #   @return [Symbol, NextbillionSDK::Models::RestrictionListByBboxParams::RestrictionType, nil]
      optional :restriction_type, enum: -> { NextbillionSDK::RestrictionListByBboxParams::RestrictionType }
      ...
      #
      #   @return [Symbol, NextbillionSDK::Models::RestrictionListByBboxParams::Source, nil]
      optional :source, enum: -> { NextbillionSDK::RestrictionListByBboxParams::Source }
      ...
      #
      #   @return [Symbol, NextbillionSDK::Models::RestrictionListByBboxParams::State, nil]
      optional :state, enum: -> { NextbillionSDK::RestrictionListByBboxParams::State }
      ...
      #
      #   @return [Symbol, NextbillionSDK::Models::RestrictionListByBboxParams::Status, nil]
      optional :status, enum: -> { NextbillionSDK::RestrictionListByBboxParams::Status }
