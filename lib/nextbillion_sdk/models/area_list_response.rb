...
module NextbillionSDK
  module Models
    class AreaListResponseItem < NextbillionSDK::Internal::Type::BaseModel
      # @!attribute code
      ...
      optional :modes, NextbillionSDK::Internal::Type::ArrayOf[String]
    ...
    AreaListResponse =
      NextbillionSDK::Internal::Type::ArrayOf[-> { NextbillionSDK::Models::AreaListResponseItem }]
  end
end
