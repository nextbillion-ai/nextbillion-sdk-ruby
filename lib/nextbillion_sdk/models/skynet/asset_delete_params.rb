...
module NextbillionSDK
  module Models
    module Skynet
      # @see NextbillionSDK::Resources::Skynet::Asset#delete
      class AssetDeleteParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, NextbillionSDK::Models::Skynet::AssetDeleteParams::Cluster, nil]
        optional :cluster, enum: -> { NextbillionSDK::Skynet::AssetDeleteParams::Cluster }
