...
module NextbillionSDK
  module Models
    module Skynet
      # @see NextbillionSDK::Resources::Skynet::Config#update
      class ConfigUpdateParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, NextbillionSDK::Models::Skynet::ConfigUpdateParams::Cluster, nil]
        optional :cluster, enum: -> { NextbillionSDK::Skynet::ConfigUpdateParams::Cluster }
        ...
        #
        #   @param cluster [Symbol, NextbillionSDK::Models::Skynet::ConfigUpdateParams::Cluster] the cluster of the region you want to use
        #
