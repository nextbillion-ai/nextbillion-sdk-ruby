...
module NextbillionSDK
  module Models
    module Skynet
      # @see NextbillionSDK::Resources::Skynet::Search#bound
      class SearchBoundParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        #     `sort-destination` .
        #
        #   @return [Symbol, NextbillionSDK::Models::Skynet::SearchBoundParams::SortBy, nil]
        optional :sort_by, enum: -> { NextbillionSDK::Skynet::SearchBoundParams::SortBy }
        ...
        #
        #   @return [Symbol, NextbillionSDK::Models::Skynet::SearchBoundParams::SortDrivingMode, nil]
        optional :sort_driving_mode, enum: -> { NextbillionSDK::Skynet::SearchBoundParams::SortDrivingMode }
