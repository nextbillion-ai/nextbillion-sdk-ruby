    ...
    module Skynet
      module Asset
        ...
        class LocationGetLastParams < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, NextbillionSDK::Models::Skynet::Asset::LocationGetLastParams::Cluster, nil]
          optional :cluster, enum: -> { NextbillionSDK::Skynet::Asset::LocationGetLastParams::Cluster }
