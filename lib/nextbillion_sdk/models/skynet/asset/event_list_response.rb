...
module NextbillionSDK
  module Models
    module Skynet
      module Asset
        # @see NextbillionSDK::Resources::Skynet::Asset::Event#list
        class EventListResponse < NextbillionSDK::Internal::Type::BaseModel
          # @!attribute data
          #   An object containing the information about the event history for the requested
          #   asset.
          #
          #   @return [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data, nil]
          optional :data, -> { NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data }
          ...
          #   {NextbillionSDK::Models::Skynet::Asset::EventListResponse} for more details.
          #
          #   @param data [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data] An object containing the information about the event history for the requested a
          #
          ...
          # @see NextbillionSDK::Models::Skynet::Asset::EventListResponse#data
          class Data < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute list
            #   An array of objects with each object on the list representing one event.
            #
            #   @return [Array<NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List>, nil]
            optional :list,
                     -> { NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List] }
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data} for more
            #   details.
            #
            #   An object containing the information about the event history for the requested
            #   asset.
            #
            #   @param list [Array<NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List>] An array of objects with each object on the list representing one event.
            #
            ...
            class List < NextbillionSDK::Internal::Type::BaseModel
              # @!attribute asset_id
              ...
              #
              #   @return [Symbol, NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::EventType, nil]
              optional :event_type,
                       enum: -> { NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::EventType }
              ...
              #
              #   @return [Object, nil]
              optional :extra, NextbillionSDK::Internal::Type::Unknown
              ...
              optional :monitor_tags, NextbillionSDK::Internal::Type::ArrayOf[String]

              # @!attribute prev_location
              #   An object with details of the asset at the last tracked location before the
              #   event was triggered.
              #
              #   @return [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation, nil]
              optional :prev_location,
                       -> { NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation }
              ...
              #   triggered.
              #
              #   @return [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation, nil]
              optional :triggered_location,
                       -> { NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation }
              ...
              #   Some parameter documentations has been truncated, see
              #   {NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List} for more
              #   details.
              #
              #   @param asset_id [String] ID of the asset. This is the same ID that was generated/provided at the time of
              #
              #   @param event_type [Symbol, NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::EventType] Nature of the event triggered by the asset. It can have following values:
              #
              ...
              #
              #   @param prev_location [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation] An object with details of the asset at the last tracked location before the even
              #
              #   @param timestamp [Integer] A UNIX epoch timestamp in milliseconds representing the time at which the event
              #
              #   @param triggered_location [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation] An object with details of the asset at the location where the event was triggere
              #
              ...
              # - idle: When the asset exhibits idle or no activity.
              #
              # @see NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List#event_type
              module EventType
              ...
              # @see NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List#prev_location
              class PrevLocation < NextbillionSDK::Internal::Type::BaseModel
                # @!attribute bearing
                ...
                #
                #   @return [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation::Location, nil]
                optional :location,
                         -> { NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation::Location }
                ...
                #
                #   @param location [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation::Location] prev_location information of the asset.
                #
                ...
                # @see NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation#location
              ...
              # @see NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List#triggered_location
              class TriggeredLocation < NextbillionSDK::Internal::Type::BaseModel
                # @!attribute bearing
                #   If available, this property returns the heading of the asset from true north in
                ...
                #
                #   @return [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation::Location, nil]
                optional :location,
                         -> { NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation::Location }
                ...
                #   @param bearing [Float] If available, this property returns the heading of the asset from true north in
                #
                #   @param location [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation::Location] An object with information about the location at which the event was triggered.
                #
                #   @param meta_data [Object] Returns the custom data added during the location information upload.
                #
                #   @param speed [Float] If available, this property returns the speed of the asset, in meters per second
                ...
                # @see NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation#location
                class Location < NextbillionSDK::Internal::Type::BaseModel
                  # @!attribute lat
