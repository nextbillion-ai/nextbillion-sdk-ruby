    ...
    module Skynet
      module Asset
        ...
        class EventListResponse < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @param data [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data] An object containing the information about the event history for the requested `
          #
          ...
          class Data < NextbillionSDK::Internal::Type::BaseModel
            ...
            class List < NextbillionSDK::Internal::Type::BaseModel
              ...
              #
              #   @param prev_location [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::PrevLocation] An object with details of the `asset` at the last tracked location before the ev
              #
              #   @param timestamp [Integer] A UNIX epoch timestamp in milliseconds representing the time at which the event
              #
              #   @param triggered_location [NextbillionSDK::Models::Skynet::Asset::EventListResponse::Data::List::TriggeredLocation] An object with details of the `asset` at the location where the event was trigge
              #
