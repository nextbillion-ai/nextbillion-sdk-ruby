...
module NextbillionSDK
  module Models
    module Skynet
      # @see NextbillionSDK::Resources::Skynet::Search#around
      class SearchResponse < NextbillionSDK::Internal::Type::BaseModel
        # @!attribute data
        #   A data object containing the search result.
        #
        #   @return [NextbillionSDK::Models::Skynet::SearchResponse::Data, nil]
        optional :data, -> { NextbillionSDK::Skynet::SearchResponse::Data }
        ...
        #   {NextbillionSDK::Models::Skynet::SearchResponse} for more details.
        #
        #   @param data [NextbillionSDK::Models::Skynet::SearchResponse::Data] A data object containing the search result.
        #
        ...
        # @see NextbillionSDK::Models::Skynet::SearchResponse#data
        class Data < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<NextbillionSDK::Models::Skynet::SearchResponse::Data::Asset>, nil]
          optional :assets,
                   -> {
                     NextbillionSDK::Internal::Type::ArrayOf[NextbillionSDK::Skynet::SearchResponse::Data::Asset]
                   }
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Skynet::SearchResponse::Data} for more details.
          #
          #   A data object containing the search result.
          #
          #   @param assets [Array<NextbillionSDK::Models::Skynet::SearchResponse::Data::Asset>] An array of objects with details of the asset(s) returned in the search result.
          #
          ...
          class Asset < NextbillionSDK::Internal::Type::BaseModel
            ...
            optional :latest_location, -> { NextbillionSDK::Skynet::Asset::TrackLocation }
            ...
            #
            #   @return [NextbillionSDK::Models::Skynet::SearchResponse::Data::Asset::RankingInfo, nil]
            optional :ranking_info, -> { NextbillionSDK::Skynet::SearchResponse::Data::Asset::RankingInfo }
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Skynet::SearchResponse::Data::Asset} for more details.
            #
            ...
            #
            #   @param latest_location [NextbillionSDK::Models::Skynet::Asset::TrackLocation] An object with details of the tracked location. Please note that if there are no
            #
            ...
            #
            #   @param ranking_info [NextbillionSDK::Models::Skynet::SearchResponse::Data::Asset::RankingInfo] An object returning the sorting details of the asset as per the configuration sp
            #
            ...
            # @see NextbillionSDK::Models::Skynet::SearchResponse::Data::Asset#ranking_info
            class RankingInfo < NextbillionSDK::Internal::Type::BaseModel
              ...
              #   Some parameter documentations has been truncated, see
              #   {NextbillionSDK::Models::Skynet::SearchResponse::Data::Asset::RankingInfo} for
              #   more details.
              #
              #   An object returning the sorting details of the asset as per the configuration
              #   specified in the input.
