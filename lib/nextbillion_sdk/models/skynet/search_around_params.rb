  ...
  module Models
    module Skynet
      ...
      class SearchAroundParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, NextbillionSDK::Models::Skynet::SearchAroundParams::SortDrivingMode, nil]
        optional :sort_driving_mode, enum: -> { NextbillionSDK::Skynet::SearchAroundParams::SortDrivingMode }

        # @!method initialize(center:, key:, radius:, filter: nil, include_all_of_attributes: nil, include_any_of_attributes: nil, max_search_limit: nil, pn: nil, ps: nil, sort_by: nil, sort_destination: nil, sort_driving_mode: nil, request_options: {})
