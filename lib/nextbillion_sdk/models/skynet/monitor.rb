...
module NextbillionSDK
  module Models
    module Skynet
      class SkynetMonitor < NextbillionSDK::Internal::Type::BaseModel
        # @!attribute id
        ...
        #
        #   @return [NextbillionSDK::Models::Skynet::SkynetMonitor::GeofenceConfig, nil]
        optional :geofence_config, -> { NextbillionSDK::Skynet::SkynetMonitor::GeofenceConfig }
        ...
        optional :geofences, NextbillionSDK::Internal::Type::ArrayOf[String]

        # @!attribute idle_config
        #   An object returning the details of the idle activity constraints for a `idle`
        #   type of `monitor`.
        #
        #   @return [NextbillionSDK::Models::Skynet::SkynetMonitor::IdleConfig, nil]
        optional :idle_config, -> { NextbillionSDK::Skynet::SkynetMonitor::IdleConfig }

        # @!attribute match_filter
        #   Use this object to update the `attributes` of the `monitor`.
        #
        #   @return [NextbillionSDK::Models::Skynet::SkynetMonitor::MatchFilter, nil]
        optional :match_filter, -> { NextbillionSDK::Skynet::SkynetMonitor::MatchFilter }
        ...
        #
        #   @return [NextbillionSDK::Models::Skynet::SkynetMonitor::SpeedingConfig, nil]
        optional :speeding_config, -> { NextbillionSDK::Skynet::SkynetMonitor::SpeedingConfig }
        ...
        #
        #   @return [Symbol, NextbillionSDK::Models::Skynet::SkynetMonitor::Type, nil]
        optional :type, enum: -> { NextbillionSDK::Skynet::SkynetMonitor::Type }
        ...
        #   {NextbillionSDK::Models::Skynet::SkynetMonitor} for more details.
        #
        #   @param id [String] Unique ID of the `monitor`. This is the same ID that was generated at the time o
        #
        #   @param created_at [Integer] A UNIX epoch timestamp in seconds representing the time at which the `monitor` w
        #
        #   @param description [String] Description of the `monitor`. The value would be the same as that provided for t
        #
        #   @param geofence_config [NextbillionSDK::Models::Skynet::SkynetMonitor::GeofenceConfig] An object returning the details of the geofence that are associated with the `mo
        #
        #   @param geofences [Array<String>] Geofence IDs that are linked to the `monitor`. These IDs were associated with th
        #
        #   @param idle_config [NextbillionSDK::Models::Skynet::SkynetMonitor::IdleConfig] An object returning the details of the idle activity constraints for a `idle` ty
        #
        #   @param match_filter [NextbillionSDK::Models::Skynet::SkynetMonitor::MatchFilter] Use this object to update the `attributes` of the `monitor`.
        #
        #   @param meta_data [Object] Any valid json object data. Can be used to save customized data. Max size is 65k
        #
        #   @param name [String] Name of the `monitor`. The value would be the same as that provided for the `nam
        #
        #   @param speeding_config [NextbillionSDK::Models::Skynet::SkynetMonitor::SpeedingConfig] An object returning the details of the over-speeding constraints for a `speeding
        #
        #   @param tags [Array<String>] Tags of the `monitor`. The values would be the same as that provided for the `ta
        #
        #   @param type [Symbol, NextbillionSDK::Models::Skynet::SkynetMonitor::Type] Type of the `monitor`. It represents the type of `asset` activity that the `moni
        #
        #   @param updated_at [Integer] A UNIX epoch timestamp in seconds representing the time at which the `monitor` w

        # @see NextbillionSDK::Models::Skynet::SkynetMonitor#geofence_config
        class GeofenceConfig < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Skynet::SkynetMonitor::GeofenceConfig} for more
          #   details.
          #
          #   An object returning the details of the geofence that are associated with the
          #   `monitor` for an `enter`, `exit` or `enter_and_exit` type of monitor.
          #
          #   @param geofence_ids [Array<String>] An array of geofence IDs that are linked to the `monitor`. Geofences are geograp
        end

        # @see NextbillionSDK::Models::Skynet::SkynetMonitor#idle_config
        class IdleConfig < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Skynet::SkynetMonitor::IdleConfig} for more details.
          #
          #   An object returning the details of the idle activity constraints for a `idle`
          #   type of `monitor`.
          #
          ...
          #
          #   @param time_tolerance [Integer] This parameter returns the time duration for which the `monitor` tracks the dist
        end

        # @see NextbillionSDK::Models::Skynet::SkynetMonitor#match_filter
        class MatchFilter < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Skynet::SkynetMonitor::MatchFilter} for more details.
          #
          #   Use this object to update the `attributes` of the `monitor`.
          #
          #   @param include_all_of_attributes [Object] A string type dictionary object to specify the `attributes` which will be used t
          #
          #   @param include_any_of_attributes [Object] A string dictionary object to specify the `attributes`, separated by a `,`. Only
        end

        # @see NextbillionSDK::Models::Skynet::SkynetMonitor#speeding_config
        class SpeedingConfig < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {NextbillionSDK::Models::Skynet::SkynetMonitor::SpeedingConfig} for more
          #   details.
          #
          #   An object returning the details of the over-speeding constraints for a
          #   `speeding` type of `monitor`.
          #
          #   @param customer_speed_limit [Integer] This property returns the actual speed limit that the `monitor` uses as a thresh
          #
          #   @param time_tolerance [Integer] This property returns the time duration value, in milliseconds, for which the `m
          #
        ...
        # `monitor` is configured to detect.
        #
        # @see NextbillionSDK::Models::Skynet::SkynetMonitor#type
        module Type
