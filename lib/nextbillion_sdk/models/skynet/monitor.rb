  ...
  module Models
    module Skynet
      class SkynetMonitor < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @param geofence_config [NextbillionSDK::Models::Skynet::SkynetMonitor::GeofenceConfig] An object returning the details of the geofence that are associated with the mon
        #
        #   @param geofences [Array<String>] Geofence IDs that are linked to the monitor. These IDs were associated with the
        #
        #   @param idle_config [NextbillionSDK::Models::Skynet::SkynetMonitor::IdleConfig] An object returning the details of the idle activity constraints for a idle type
        #
        ...
        #
        #   @param type [Symbol, NextbillionSDK::Models::Skynet::SkynetMonitor::Type] Type of the monitor. It represents the type of asset activity that the monitor i
        #
