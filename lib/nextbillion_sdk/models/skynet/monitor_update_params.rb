  ...
  module Models
    module Skynet
      ...
      class MonitorUpdateParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @param geofence_config [NextbillionSDK::Models::Skynet::MonitorUpdateParams::GeofenceConfig] `geofence_config` is used to update the set of geofences linked to the `monitor`
        #
        #   @param geofence_ids [Array<String>] Use this parameter to update the geofences linked to the `monitor` by providing
        #
        #   @param idle_config [NextbillionSDK::Models::Skynet::MonitorUpdateParams::IdleConfig] `idle_config` is used to update the constraints for creating idle events. When a
        #
        #   @param match_filter [NextbillionSDK::Models::Skynet::MonitorUpdateParams::MatchFilter] Use this object to update the `attributes` of the `monitor`. Please note that us
        #
        ...
        #
        #   @param speeding_config [NextbillionSDK::Models::Skynet::MonitorUpdateParams::SpeedingConfig] `speeding_config` is used to update the tolerance values for creating over-speed
        #
        #   @param tags [Array<String>] Use this parameter to update the `tags` of the `monitor`. `tags` can be used for
        #
        #   @param type [Symbol, NextbillionSDK::Models::Skynet::MonitorUpdateParams::Type] Use this parameter to update the `type` of the `monitor`. The `monitor` will be
        #
