...
module NextbillionSDK
  module Models
    module Skynet
      module Search
        # @see NextbillionSDK::Resources::Skynet::Search::Polygon#get
        class PolygonGetParams < NextbillionSDK::Internal::Type::BaseModel
          ...
          #     sort-destination .
          #
          #   @return [Symbol, NextbillionSDK::Models::Skynet::Search::PolygonGetParams::SortBy, nil]
          optional :sort_by, enum: -> { NextbillionSDK::Skynet::Search::PolygonGetParams::SortBy }
          ...
          #
          #   @return [Symbol, NextbillionSDK::Models::Skynet::Search::PolygonGetParams::SortDrivingMode, nil]
          optional :sort_driving_mode,
                   enum: -> { NextbillionSDK::Skynet::Search::PolygonGetParams::SortDrivingMode }
