    ...
    module Skynet
      module Search
        ...
        class PolygonCreateParams < NextbillionSDK::Internal::Type::BaseModel
          ...
          #
          #   @param match_filter [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::MatchFilter] An object to define the `attributes` which will be used to filter the assets fou
          #
