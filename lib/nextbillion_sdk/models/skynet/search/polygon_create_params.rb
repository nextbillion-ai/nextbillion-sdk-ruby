...
module NextbillionSDK
  module Models
    module Skynet
      module Search
        # @see NextbillionSDK::Resources::Skynet::Search::Polygon#create
        class PolygonCreateParams < NextbillionSDK::Internal::Type::BaseModel
          ...
          #   km<sup>2</sup>.
          #
          #   @return [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Polygon]
          required :polygon, -> { NextbillionSDK::Skynet::Search::PolygonCreateParams::Polygon }
          ...
          #   within the polygon.
          #
          #   @return [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::MatchFilter, nil]
          optional :match_filter, -> { NextbillionSDK::Skynet::Search::PolygonCreateParams::MatchFilter }
          ...
          # @!attribute sort
          #
          #   @return [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort, nil]
          optional :sort, -> { NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort }
          ...
          #   {NextbillionSDK::Models::Skynet::Search::PolygonCreateParams} for more details.
          #
          #   @param key [String] A key is a unique identifier that is required to authenticate a request to the A
          #
          #   @param polygon [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Polygon] An object to collect geoJSON details of a custom polygon. Please ensure that:
          #
          #   @param filter [String] \*\*tags parameter will be deprecated soon! Please use the
          #   include_any_of_attribut
          #
          #   @param match_filter [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::MatchFilter] An object to define the attributes which will be used to filter the assets found
          #
          ...
          #
          #   @param sort [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort]
          #
          ...
          class Polygon < NextbillionSDK::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Float>]
            required :coordinates, NextbillionSDK::Internal::Type::ArrayOf[Float]
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Polygon} for more
            #   details.
            #
            #   An object to collect geoJSON details of a custom polygon. Please ensure that:
            #
          ...
          class MatchFilter < NextbillionSDK::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::MatchFilter} for
            #   more details.
            #
            #   An object to define the attributes which will be used to filter the assets found
            #   within the polygon.
          ...
          class Sort < NextbillionSDK::Internal::Type::BaseModel
            # @!attribute sort_by
            ...
            #     sort-destination .
            #
            #   @return [Symbol, NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort::SortBy, nil]
            optional :sort_by, enum: -> { NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortBy }
            ...
            #   sort_by is provided.
            #
            #   @return [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort::SortDestination, nil]
            optional :sort_destination,
                     -> { NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortDestination }
            ...
            #
            #   @return [Symbol, NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort::SortDrivingMode, nil]
            optional :sort_driving_mode,
                     enum: -> { NextbillionSDK::Skynet::Search::PolygonCreateParams::Sort::SortDrivingMode }

            # @!method initialize(sort_by: nil, sort_destination: nil, sort_driving_mode: nil)
            #   Some parameter documentations has been truncated, see
            #   {NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort} for more
            #   details.
            #
            #   @param sort_by [Symbol, NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort::SortBy] Specify the metric to sort the assets returned in the search result. The valid v
            #
            #   @param sort_destination [NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort::SortDestination] Specifies the location coordinates of the point which acts as destination for so
            #
            #   @param sort_driving_mode [Symbol, NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort::SortDrivingMode] Specifies the driving mode to be used for determining travel duration or driving
            ...
            #   sort-destination .
            #
            # @see NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort#sort_by
            module SortBy
            ...
            # @see NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort#sort_destination
            class SortDestination < NextbillionSDK::Internal::Type::BaseModel
              # @!attribute lat
            ...
            # distance for sorting the assets in search result.
            #
            # @see NextbillionSDK::Models::Skynet::Search::PolygonCreateParams::Sort#sort_driving_mode
