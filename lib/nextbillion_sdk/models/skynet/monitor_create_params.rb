  ...
  module Models
    module Skynet
      ...
      class MonitorCreateParams < NextbillionSDK::Internal::Type::BaseModel
        ...
        #
        #   @param geofence_config [NextbillionSDK::Models::Skynet::MonitorCreateParams::GeofenceConfig] Geofences are geographic boundaries surrounding an area of interest. `geofence_c
        #
        #   @param geofence_ids [Array<String>] \*\*Deprecated. Please use the `geofence_config` to specify the geofence_ids for
        #   t
        #
        #   @param idle_config [NextbillionSDK::Models::Skynet::MonitorCreateParams::IdleConfig] `idle_config` is used to set up constraints for creating idle events. When an as
        #
        #   @param match_filter [NextbillionSDK::Models::Skynet::MonitorCreateParams::MatchFilter] This object is used to identify the asset(s) on which the `monitor` would be app
        #
        ...
        #
        #   @param speeding_config [NextbillionSDK::Models::Skynet::MonitorCreateParams::SpeedingConfig] `speeding_config` is used to set up constraints for creating over-speed events.
        #
