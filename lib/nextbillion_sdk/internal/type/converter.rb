    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { NextbillionSDK::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { NextbillionSDK::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            NextbillionSDK::FilePart.new(value)
          in NextbillionSDK::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in NextbillionSDK::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [NextbillionSDK::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: NextbillionSDK::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in NextbillionSDK::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in NextbillionSDK::Internal::Type::Converter
              ...
              NextbillionSDK::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(NextbillionSDK::Internal::Type::Converter, T::Class[T.anything]) }
        end
