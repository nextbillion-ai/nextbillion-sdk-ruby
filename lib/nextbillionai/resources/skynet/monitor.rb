  ...
  module Resources
    class Skynet
      class Monitor
        ...
        #
        # @param match_filter [Nextbillionai::Models::Skynet::MonitorCreateParams::MatchFilter] Body param: This object is used to identify the asset(s) on which the monitor wo
        #
        ...
        #
        # @param speeding_config [Nextbillionai::Models::Skynet::MonitorCreateParams::SpeedingConfig] Body param: speeding_config is used to set up constraints for creating over-spee
        #
        ...
        #
        # @param geofence_config [Nextbillionai::Models::Skynet::MonitorUpdateParams::GeofenceConfig] Body param: geofence_config is used to update the set of geofences linked to the
        #
        # @param geofence_ids [Array<String>] Body param: Use this parameter to update the geofences linked to the monitor by
        #
        # @param idle_config [Nextbillionai::Models::Skynet::MonitorUpdateParams::IdleConfig] Body param: idle_config is used to update the constraints for creating idle even
        #
        # @param match_filter [Nextbillionai::Models::Skynet::MonitorUpdateParams::MatchFilter] Body param: Use this object to update the attributes of the monitor. Please note
        #
        # @param meta_data [Object] Body param: Any valid json object data. Can be used to save customized data. Max
        #
        # @param name [String] Body param: Use this parameter to update the name of the monitor. Users can add
        #
        # @param speeding_config [Nextbillionai::Models::Skynet::MonitorUpdateParams::SpeedingConfig] Body param: speeding_config is used to update the tolerance values for creating
        #
        # @param tags [Array<String>] Body param: Use this parameter to update the tags of the monitor. tags can be us
        #
        # @param type [Symbol, Nextbillionai::Models::Skynet::MonitorUpdateParams::Type] Body param: Use this parameter to update the type of the monitor. The monitor wi
        #
        # @param request_options [Nextbillionai::RequestOptions, Hash{Symbol=>Object}, nil]
        #
