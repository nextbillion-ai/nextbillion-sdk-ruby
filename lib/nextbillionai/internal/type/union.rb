    ...
    module Type
      ...
      module Union
        ...
        private def variant(key, spec = nil)
          meta = Nextbillionai::Internal::Type::Converter.meta_info(nil, spec)
          variant_info =
            case key
            in Symbol
              [key, Nextbillionai::Internal::Type::Converter.type_info(spec), meta]
            in Proc | Nextbillionai::Internal::Type::Converter | Class | Hash
              [nil, Nextbillionai::Internal::Type::Converter.type_info(key), meta]
            end
