    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Nextbillionai::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Nextbillionai::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Nextbillionai::FilePart.new(value)
          in Nextbillionai::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Nextbillionai::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Nextbillionai::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Nextbillionai::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Nextbillionai::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Nextbillionai::Internal::Type::Converter
              ...
              Nextbillionai::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Nextbillionai::Internal::Type::Converter, T::Class[T.anything]) }
        end
