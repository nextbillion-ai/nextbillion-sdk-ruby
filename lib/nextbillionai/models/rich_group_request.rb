...
module Nextbillionai
  module Models
    class RichGroupRequest < Nextbillionai::Internal::Type::BaseModel
      ...
      #   be applied.
      #
      #   @return [Symbol, Nextbillionai::Models::RichGroupRequest::Direction, nil]
      optional :direction, enum: -> { Nextbillionai::RichGroupRequest::Direction }
      ...
      optional :segments,
               -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::RichGroupRequest::Segment] }
      ...
      #   {Nextbillionai::Models::RichGroupRequest} for more details.
      #
      ...
      #
      #   @param direction [Symbol, Nextbillionai::Models::RichGroupRequest::Direction] Represents the traffic direction on the segments to which the restriction will b
      #
      ...
      #
      #   @param mode [Array<Symbol, Nextbillionai::Models::RichGroupRequest::Mode>] Provide the driving modes for which the restriction should be effective. If the
      #
      #   @param repeat_on [String] It represents the days and times when the restriction is in effect. Users can us
      #
      #   @param segments [Array<Nextbillionai::Models::RichGroupRequest::Segment>] An array of objects to collect the details of the segments of a road on which th
      #
      ...
      #
      #   @param turns [Array<Nextbillionai::Models::RichGroupRequest::Turn>] An array of objects to collect the details of the turns of a road on which the r
      #
      ...
      # be applied.
      #
      # @see Nextbillionai::Models::RichGroupRequest#direction
      module Direction
      ...
      class Turn < Nextbillionai::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Nextbillionai::Models::RichGroupRequest::Turn} for more details.
        #
