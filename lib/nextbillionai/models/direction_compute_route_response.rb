  ...
  module Models
    ...
    class DirectionComputeRouteResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      class Route < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @param end_location [Nextbillionai::Models::DirectionComputeRouteResponse::Route::EndLocation] Location coordinates of the point where the route ends. It is the same as the `d
        #
        #   @param geojson [Nextbillionai::Models::DirectionComputeRouteResponse::Route::Geojson] An object with geoJSON details of the route. This object is returned when the `g
        #
        #   @param geometry [String] Encoded geometry of the returned route in the selected format and specified `ove
        #
        #   @param legs [Array<Nextbillionai::Models::DirectionComputeRouteResponse::Route::Leg>] An array of objects returning the details about each `leg` of the route. `waypoi
        #
        ...
        class Leg < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @param start_location [Nextbillionai::Models::DirectionComputeRouteResponse::Route::Leg::StartLocation] Location coordinates of the point where the leg starts. Returned only when `ste
          #
          #   @param steps [Array<Nextbillionai::Models::DirectionComputeRouteResponse::Route::Leg::Step>] An array of objects with details of each step of the `legs`. Returned only when
          ...
          class Step < Nextbillionai::Internal::Type::BaseModel
            ...
            #
            #   @param geojson [Nextbillionai::Models::DirectionComputeRouteResponse::Route::Leg::Step::Geojson] An object with geoJSON details of the `step`.This object is returned when the `g
            #
