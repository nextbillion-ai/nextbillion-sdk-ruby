  ...
  module Models
    module Skynet
      ...
      class NamespacedApikeyCreateResponse < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::Skynet::NamespacedApikeyCreateResponse::Result, nil]
        optional :result, -> { Nextbillionai::Models::Skynet::NamespacedApikeyCreateResponse::Result }
        ...
        #   {Nextbillionai::Models::Skynet::NamespacedApikeyCreateResponse} for more
        #   details.
        #
        ...
        #
        #   @param result [Nextbillionai::Models::Skynet::NamespacedApikeyCreateResponse::Result] An object to return the details about the namespace key created.
        #
        ...
        class Result < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::NamespacedApikeyCreateResponse::Result} for more
          #   details.
          #
          #   An object to return the details about the namespace key created.
          #
