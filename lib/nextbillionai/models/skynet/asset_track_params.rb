...
module Nextbillionai
  module Models
    module Skynet
      # @see Nextbillionai::Resources::Skynet::Asset#track
      class AssetTrackParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::Skynet::AssetTrackParams::Locations]
        required :locations, -> { Nextbillionai::Skynet::AssetTrackParams::Locations }

        # @!attribute cluster
        #   the cluster of the region you want to use
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::AssetTrackParams::Cluster, nil]
        optional :cluster, enum: -> { Nextbillionai::Skynet::AssetTrackParams::Cluster }

        # @!method initialize(id:, key:, device_id:, locations:, cluster: nil, request_options: {})
        ...
        #
        #   @param locations [Nextbillionai::Models::Skynet::AssetTrackParams::Locations] An array of objects to collect the location tracking information for an asset. E
        #
        #   @param cluster [Symbol, Nextbillionai::Models::Skynet::AssetTrackParams::Cluster] the cluster of the region you want to use
        #
        ...
        class Locations < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Nextbillionai::Models::Skynet::AssetTrackParams::Locations::Location]
          required :location, -> { Nextbillionai::Skynet::AssetTrackParams::Locations::Location }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::AssetTrackParams::Locations} for more details.
          #
          #   An array of objects to collect the location tracking information for an asset.
          #   Each object must correspond to details of only one location.
          #
          #   @param location [Nextbillionai::Models::Skynet::AssetTrackParams::Locations::Location] An object to collect the coordinate details of the tracked location. Please note
          #
          ...
          # @see Nextbillionai::Models::Skynet::AssetTrackParams::Locations#location
