  ...
  module Models
    module Skynet
      ...
      class SearchAroundParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #     sort-destination .
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::SearchAroundParams::SortBy, nil]
        optional :sort_by, enum: -> { Nextbillionai::Skynet::SearchAroundParams::SortBy }
        ...
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::SearchAroundParams::SortDrivingMode, nil]
        optional :sort_driving_mode, enum: -> { Nextbillionai::Skynet::SearchAroundParams::SortDrivingMode }
