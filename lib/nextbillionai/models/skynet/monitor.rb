  ...
  module Models
    module Skynet
      class SkynetMonitor < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @param geofence_config [Nextbillionai::Models::Skynet::SkynetMonitor::GeofenceConfig] An object returning the details of the geofence that are associated with the `mo
        #
        #   @param geofences [Array<String>] Geofence IDs that are linked to the `monitor`. These IDs were associated with th
        #
        #   @param idle_config [Nextbillionai::Models::Skynet::SkynetMonitor::IdleConfig] An object returning the details of the idle activity constraints for a `idle` ty
        #
        ...
        #
        #   @param type [Symbol, Nextbillionai::Models::Skynet::SkynetMonitor::Type] Type of the `monitor`. It represents the type of `asset` activity that the `moni
        #
