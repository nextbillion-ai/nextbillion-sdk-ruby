  ...
  module Models
    module Skynet
      ...
      class AssetUpdateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::AssetUpdateParams::Cluster, nil]
        optional :cluster, enum: -> { Nextbillionai::Skynet::AssetUpdateParams::Cluster }
        ...
        #
        #   @param cluster [Symbol, Nextbillionai::Models::Skynet::AssetUpdateParams::Cluster] the cluster of the region you want to use
        #
        #   @param attributes [Object] Use this param to update the `attributes` of an asset in `key`:`value` format. U
        #
        ...
        #
        #   @param name [String] Use this param to update the `name` of an `asset`. Users can assign meaningful c
        #
