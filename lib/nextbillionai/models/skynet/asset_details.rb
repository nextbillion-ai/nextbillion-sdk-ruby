  ...
  module Models
    module Skynet
      class AssetDetails < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::Skynet::AssetDetails::LatestLocation, nil]
        optional :latest_location, -> { Nextbillionai::Skynet::AssetDetails::LatestLocation }
        ...
        #   {Nextbillionai::Models::Skynet::AssetDetails} for more details.
        #
        ...
        #
        #   @param latest_location [Nextbillionai::Models::Skynet::AssetDetails::LatestLocation] An object with details of the last tracked location of the asset.
        #
        ...
        # @see Nextbillionai::Models::Skynet::AssetDetails#latest_location
        class LatestLocation < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Nextbillionai::Models::Skynet::AssetDetails::LatestLocation::Location, nil]
          optional :location, -> { Nextbillionai::Skynet::AssetDetails::LatestLocation::Location }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::AssetDetails::LatestLocation} for more details.
          #
          #   An object with details of the last tracked location of the asset.
          #
          ...
          #
          #   @param location [Nextbillionai::Models::Skynet::AssetDetails::LatestLocation::Location] An object with the coordinates of the last tracked location.
          #
          ...
          # @see Nextbillionai::Models::Skynet::AssetDetails::LatestLocation#location
