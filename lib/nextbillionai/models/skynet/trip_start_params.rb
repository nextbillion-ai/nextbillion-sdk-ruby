  ...
  module Models
    module Skynet
      ...
      class TripStartParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::TripStartParams::Cluster, nil]
        ...
        #
        #   @return [Array<Nextbillionai::Models::Skynet::TripStartParams::Stop>, nil]
        optional :stops,
                 -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Skynet::TripStartParams::Stop] }
        ...
        #
        #   @param stops [Array<Nextbillionai::Models::Skynet::TripStartParams::Stop>] An array of objects to collect the details about all the stops that need to be m
        #
        ...
        class Stop < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::TripStartParams::Stop} for more details.
          #
