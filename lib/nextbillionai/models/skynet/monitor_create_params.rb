  ...
  module Models
    module Skynet
      ...
      class MonitorCreateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @param geofence_config [Nextbillionai::Models::Skynet::MonitorCreateParams::GeofenceConfig] Geofences are geographic boundaries surrounding an area of interest. geofence_co
        #
        #   @param geofence_ids [Array<String>] \*\*Deprecated. Please use the geofence_config to specify the geofence_ids for
        #   thi
        #
        #   @param idle_config [Nextbillionai::Models::Skynet::MonitorCreateParams::IdleConfig] idle_config is used to set up constraints for creating idle events. When an asse
        #
        #   @param match_filter [Nextbillionai::Models::Skynet::MonitorCreateParams::MatchFilter] This object is used to identify the asset(s) on which the monitor would be appli
        #
        ...
        #
        #   @param speeding_config [Nextbillionai::Models::Skynet::MonitorCreateParams::SpeedingConfig] speeding_config is used to set up constraints for creating over-speed events. Wh
        #
