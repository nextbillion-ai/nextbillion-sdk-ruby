  ...
  module Models
    module Skynet
      ...
      class MonitorCreateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Array<String>]
        required :tags, Nextbillionai::Internal::Type::ArrayOf[String]
        ...
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::MonitorCreateParams::Type]
        required :type, enum: -> { Nextbillionai::Skynet::MonitorCreateParams::Type }

        # @!attribute cluster
        #   the cluster of the region you want to use
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::MonitorCreateParams::Cluster, nil]
        optional :cluster, enum: -> { Nextbillionai::Skynet::MonitorCreateParams::Cluster }
        ...
        #
        #   @return [Nextbillionai::Models::Skynet::MonitorCreateParams::GeofenceConfig, nil]
        optional :geofence_config, -> { Nextbillionai::Skynet::MonitorCreateParams::GeofenceConfig }
        ...
        #
        #   @return [Nextbillionai::Models::Skynet::MonitorCreateParams::IdleConfig, nil]
        optional :idle_config, -> { Nextbillionai::Skynet::MonitorCreateParams::IdleConfig }

        # @!attribute match_filter
        #   This object is used to identify the asset(s) on which the `monitor` would be
        #   applied.
        #
        #   @return [Nextbillionai::Models::Skynet::MonitorCreateParams::MatchFilter, nil]
        optional :match_filter, -> { Nextbillionai::Skynet::MonitorCreateParams::MatchFilter }
        ...
        #   Let's look at the properties of this object.
        #
        #   @return [Nextbillionai::Models::Skynet::MonitorCreateParams::SpeedingConfig, nil]
        optional :speeding_config, -> { Nextbillionai::Skynet::MonitorCreateParams::SpeedingConfig }
        ...
        #
        #   @param tags [Array<String>] Use this parameter to add `tags` to the `monitor`. `tags` can be used for filter
        #
        #   @param type [Symbol, Nextbillionai::Models::Skynet::MonitorCreateParams::Type] Specify the type of activity the `monitor` would detect.
        #
        #   @param cluster [Symbol, Nextbillionai::Models::Skynet::MonitorCreateParams::Cluster] the cluster of the region you want to use
        #
        #   @param custom_id [String] Set a unique ID for the new `monitor`. If not provided, an ID will be automatica
        #
        #   @param description [String] Add a description for your `monitor` using this parameter.
        #
        #   @param geofence_config [Nextbillionai::Models::Skynet::MonitorCreateParams::GeofenceConfig] Geofences are geographic boundaries surrounding an area of interest. `geofence_c
        #
        #   @param geofence_ids [Array<String>] \*\*Deprecated. Please use the `geofence_config` to specify the geofence_ids for
        #   t
        #
        #   @param idle_config [Nextbillionai::Models::Skynet::MonitorCreateParams::IdleConfig] `idle_config` is used to set up constraints for creating idle events. When an as
        #
        #   @param match_filter [Nextbillionai::Models::Skynet::MonitorCreateParams::MatchFilter] This object is used to identify the asset(s) on which the `monitor` would be app
        #
        #   @param meta_data [Object] Any valid json object data. Can be used to save customized data. Max size is 65k
        #
        #   @param name [String] Name of the `monitor`. Use this field to assign a meaningful, custom name to the
        #
        #   @param speeding_config [Nextbillionai::Models::Skynet::MonitorCreateParams::SpeedingConfig] `speeding_config` is used to set up constraints for creating over-speed events.
        #
        ...
        class GeofenceConfig < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<String>]
          required :geofence_ids, Nextbillionai::Internal::Type::ArrayOf[String]

          # @!method initialize(geofence_ids:)
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::MonitorCreateParams::GeofenceConfig} for more
          #   details.
          #
          #   Geofences are geographic boundaries surrounding an area of interest.
          #   `geofence_config` is used to specify the geofences for creating `enter` or
          ...
          #   of `enter`, `exit` or `enter_and_exit`.
          #
          #   @param geofence_ids [Array<String>] An array of strings to collect the geofence IDs that should be linked to the `mo
        end
        ...
        class IdleConfig < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::MonitorCreateParams::IdleConfig} for more
          #   details.
          #
          #   `idle_config` is used to set up constraints for creating idle events. When an
          #   asset associated with the `monitor` has not moved a given distance within a
          ...
          #
          #   @param time_tolerance [Integer] Use this parameter to configure a time duration for which the `monitor` would tr
        end
        ...
        class MatchFilter < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::MonitorCreateParams::MatchFilter} for more
          #   details.
          #
          #   This object is used to identify the asset(s) on which the `monitor` would be
          #   applied.
          #
          #   @param include_all_of_attributes [Object] A string type dictionary object to specify the `attributes`. Only the assets hav
          #
          #   @param include_any_of_attributes [Object] A string type dictionary object to specify the `attributes`. The assets having a
        end
        ...
        class SpeedingConfig < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::MonitorCreateParams::SpeedingConfig} for more
          #   details.
          #
          #   `speeding_config` is used to set up constraints for creating over-speed events.
          #   When an `asset` associated with a `monitor` is traveling at a speed above the
          ...
          #   Let's look at the properties of this object.
          #
          #   @param customer_speed_limit [Integer] Use this parameter to establish the speed limit that will allow the `monitor` to
          #
          #   @param time_tolerance [Integer] Use this parameter to configure a time tolerance before triggering an event. Add
          #
          #   @param use_admin_speed_limit [Boolean] A boolean attribute to indicate which speed limit values should be used by the `
        end
      end
    end
  end
