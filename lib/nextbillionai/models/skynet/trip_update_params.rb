...
module Nextbillionai
  module Models
    module Skynet
      # @see Nextbillionai::Resources::Skynet::Trip#update
      class TripUpdateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::TripUpdateParams::Cluster, nil]
        ...
        #
        #   @return [Array<Nextbillionai::Models::Skynet::TripUpdateParams::Stop>, nil]
        optional :stops,
                 -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Skynet::TripUpdateParams::Stop] }

        # @!method initialize(id:, key:, asset_id:, cluster: nil, attributes: nil, description: nil, meta_data: nil, name: nil, stops: nil, request_options: {})
        ...
        #
        #   @param stops [Array<Nextbillionai::Models::Skynet::TripUpdateParams::Stop>] Use this object to update the details of the stops made during the trip. Each ob
        #
        ...
        class Stop < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::TripUpdateParams::Stop} for more details.
          #
