  ...
  module Models
    module Skynet
      ...
      class AssetCreateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::AssetCreateParams::Cluster, nil]
        optional :cluster, enum: -> { Nextbillionai::Skynet::AssetCreateParams::Cluster }
        ...
        #
        #   @param cluster [Symbol, Nextbillionai::Models::Skynet::AssetCreateParams::Cluster] the cluster of the region you want to use
        #
        #   @param attributes [Object] `attributes` can be used to store custom information about an asset in `key`:`va
        #
        #   @param custom_id [String] Set a unique ID for the new `asset`. If not provided, an ID will be automaticall
        #
        ...
        #
        #   @param name [String] Name of the `asset`. Use this field to assign a meaningful, custom name to the `
        #
        #   @param tags [Array<String>] \*\*This parameter will be deprecated soon! Please use the `attributes`
        #   parameter
        #
