    ...
    module Skynet
      module Asset
        ...
        class LocationGetLastParams < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Nextbillionai::Models::Skynet::Asset::LocationGetLastParams::Cluster, nil]
          optional :cluster, enum: -> { Nextbillionai::Skynet::Asset::LocationGetLastParams::Cluster }
