      ...
      module Asset
        ...
        class LocationListResponse < Nextbillionai::Internal::Type::BaseModel
          ...
          class Data < Nextbillionai::Internal::Type::BaseModel
            ...
            #
            #   @param geojson [Nextbillionai::Models::Skynet::Asset::LocationListResponse::Data::Geojson] An object with geoJSON details of the route. It is returned only when the `mapma
            #
            #   @param geometry [Array<String>] Geometry of tracked locations in the requested format. It is returned only if th
            #
            #   @param list [Array<Nextbillionai::Models::Skynet::Asset::TrackLocation>] An array of objects with details of the tracked locations of the `asset`. Each o
            #
