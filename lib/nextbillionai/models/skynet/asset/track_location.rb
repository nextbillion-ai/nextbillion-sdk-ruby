    ...
    module Skynet
      module Asset
        class TrackLocation < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Nextbillionai::Models::Skynet::Asset::TrackLocation::Location, nil]
          optional :location, -> { Nextbillionai::Skynet::Asset::TrackLocation::Location }
          ...
          #   {Nextbillionai::Models::Skynet::Asset::TrackLocation} for more details.
          #
          ...
          #
          #   @param location [Nextbillionai::Models::Skynet::Asset::TrackLocation::Location] An object with the coordinates of the last tracked location.
          #
          ...
          # @see Nextbillionai::Models::Skynet::Asset::TrackLocation#location
