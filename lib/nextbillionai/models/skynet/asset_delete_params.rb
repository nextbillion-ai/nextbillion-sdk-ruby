...
module Nextbillionai
  module Models
    module Skynet
      # @see Nextbillionai::Resources::Skynet::Asset#delete
      class AssetDeleteParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Symbol, Nextbillionai::Models::Skynet::AssetDeleteParams::Cluster, nil]
        optional :cluster, enum: -> { Nextbillionai::Skynet::AssetDeleteParams::Cluster }
