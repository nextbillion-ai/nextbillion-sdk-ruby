  ...
  module Models
    module Skynet
      ...
      class MonitorUpdateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @param geofence_config [Nextbillionai::Models::Skynet::MonitorUpdateParams::GeofenceConfig] geofence_config is used to update the set of geofences linked to the monitor for
        #
        #   @param geofence_ids [Array<String>] Use this parameter to update the geofences linked to the monitor by providing th
        #
        #   @param idle_config [Nextbillionai::Models::Skynet::MonitorUpdateParams::IdleConfig] idle_config is used to update the constraints for creating idle events. When an
        #
        #   @param match_filter [Nextbillionai::Models::Skynet::MonitorUpdateParams::MatchFilter] Use this object to update the attributes of the monitor. Please note that using
        #
        ...
        #
        #   @param speeding_config [Nextbillionai::Models::Skynet::MonitorUpdateParams::SpeedingConfig] speeding_config is used to update the tolerance values for creating over-speed e
        #
        #   @param tags [Array<String>] Use this parameter to update the tags of the monitor. tags can be used for filte
        #
        #   @param type [Symbol, Nextbillionai::Models::Skynet::MonitorUpdateParams::Type] Use this parameter to update the type of the monitor. The monitor will be able t
        #
