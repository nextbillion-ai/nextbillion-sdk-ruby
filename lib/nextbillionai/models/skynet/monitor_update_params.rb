...
module Nextbillionai
  module Models
    module Skynet
      # @see Nextbillionai::Resources::Skynet::Monitor#update
      class MonitorUpdateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::Skynet::MonitorUpdateParams::GeofenceConfig, nil]
        optional :geofence_config, -> { Nextbillionai::Skynet::MonitorUpdateParams::GeofenceConfig }
        ...
        #
        #   @return [Nextbillionai::Models::Skynet::MonitorUpdateParams::IdleConfig, nil]
        optional :idle_config, -> { Nextbillionai::Skynet::MonitorUpdateParams::IdleConfig }
        ...
        #
        #   @return [Nextbillionai::Models::Skynet::MonitorUpdateParams::MatchFilter, nil]
        optional :match_filter, -> { Nextbillionai::Skynet::MonitorUpdateParams::MatchFilter }
        ...
        #
        #   @return [Nextbillionai::Models::Skynet::MonitorUpdateParams::SpeedingConfig, nil]
        optional :speeding_config, -> { Nextbillionai::Skynet::MonitorUpdateParams::SpeedingConfig }
        ...
        #
        #   @param geofence_config [Nextbillionai::Models::Skynet::MonitorUpdateParams::GeofenceConfig] `geofence_config` is used to update the set of geofences linked to the `monitor`
        #
        #   @param geofence_ids [Array<String>] Use this parameter to update the geofences linked to the `monitor` by providing
        #
        #   @param idle_config [Nextbillionai::Models::Skynet::MonitorUpdateParams::IdleConfig] `idle_config` is used to update the constraints for creating idle events. When a
        #
        #   @param match_filter [Nextbillionai::Models::Skynet::MonitorUpdateParams::MatchFilter] Use this object to update the `attributes` of the `monitor`. Please note that us
        #
        #   @param meta_data [Object] Any valid json object data. Can be used to save customized data. Max size is 65k
        #
        #   @param name [String] Use this parameter to update the `name` of the `monitor`. Users can add meaningf
        #
        #   @param speeding_config [Nextbillionai::Models::Skynet::MonitorUpdateParams::SpeedingConfig] `speeding_config` is used to update the tolerance values for creating over-speed
        #
        #   @param tags [Array<String>] Use this parameter to update the `tags` of the `monitor`. `tags` can be used for
        #
        #   @param type [Symbol, Nextbillionai::Models::Skynet::MonitorUpdateParams::Type] Use this parameter to update the `type` of the `monitor`. The `monitor` will be
        #
        ...
        class GeofenceConfig < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::MonitorUpdateParams::GeofenceConfig} for more
          #   details.
          #
          #   `geofence_config` is used to update the set of geofences linked to the `monitor`
          #   for creating `enter` or `exit` type of events based on the asset's location.
        ...
        class IdleConfig < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::MonitorUpdateParams::IdleConfig} for more
          #   details.
          #
          #   `idle_config` is used to update the constraints for creating idle events. When
          #   an asset associated with the `monitor` has not moved a given distance within a
          ...
          #
          #   @param time_tolerance [Integer] Use this parameter to update the time duration for which the `monitor` would tra
        end
        ...
        class MatchFilter < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::MonitorUpdateParams::MatchFilter} for more
          #   details.
          #
          #   Use this object to update the `attributes` of the `monitor`. Please note that
          #   using this property will overwrite the existing `attributes` that the monitor
        ...
        class SpeedingConfig < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Skynet::MonitorUpdateParams::SpeedingConfig} for more
          #   details.
          #
          #   `speeding_config` is used to update the tolerance values for creating over-speed
          #   events. When an asset associated with a `monitor` is traveling at a speed above
          ...
          #   Please note that this object is mandatory when the monitor `type` is `speeding`.
          #
          #   @param customer_speed_limit [String] Use this parameter to update the speed limit value that the `monitor` will use t
          #
          #   @param time_tolerance [Integer] Use this parameter to update the time tolerance before triggering an event. Addi
          #
          #   @param use_admin_speed_limit [Boolean] Use this attribute to update which speed limit values will be used by the `monit
        end
