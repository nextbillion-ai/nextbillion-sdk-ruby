...
module Nextbillionai
  module Models
    module Multigeocode
      # @see Nextbillionai::Resources::Multigeocode::Place#delete
      class PlaceDeleteResponse < Nextbillionai::Internal::Type::BaseModel
        # @!attribute msg
        ...
        #   {Nextbillionai::Models::Multigeocode::PlaceDeleteResponse} for more details.
        #
