  ...
  module Models
    module Multigeocode
      ...
      class PlaceCreateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::Multigeocode::PlaceCreateParams::DataSource, nil]
        ...
        #
        #   @return [Boolean, nil]
        optional :force, Nextbillionai::Internal::Type::Boolean
        ...
        #
        #   @param place [Array<Nextbillionai::Models::Multigeocode::PlaceCreateParams::Place>] This parameter represents the place details, including geographical information,
        #
        #   @param data_source [Nextbillionai::Models::Multigeocode::PlaceCreateParams::DataSource] It contains information about the dataset that returns the specific result
        #
        ...
        class Place < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Nextbillionai::Models::Multigeocode::PlaceCreateParams::Place::Geopoint]
          required :geopoint, -> { Nextbillionai::Multigeocode::PlaceCreateParams::Place::Geopoint }
          ...
          #
          #   @return [Nextbillionai::Models::Multigeocode::PlaceCreateParams::Place::Poi, nil]
          optional :poi, -> { Nextbillionai::Multigeocode::PlaceCreateParams::Place::Poi }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Multigeocode::PlaceCreateParams::Place} for more
          #   details.
          #
          #   @param geopoint [Nextbillionai::Models::Multigeocode::PlaceCreateParams::Place::Geopoint] This parameter represents the geographical coordinates of the place. It includes
          #
          ...
          #
          #   @param poi [Nextbillionai::Models::Multigeocode::PlaceCreateParams::Place::Poi] This parameter represents a point of interest within the place. A Point of Inter
          #
          ...
          # @see Nextbillionai::Models::Multigeocode::PlaceCreateParams::Place#geopoint
          ...
          # @see Nextbillionai::Models::Multigeocode::PlaceCreateParams::Place#poi
        ...
        class DataSource < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Nextbillionai::Models::Multigeocode::PlaceCreateParams::DataSource::Status, nil]
          optional :status, enum: -> { Nextbillionai::Multigeocode::PlaceCreateParams::DataSource::Status }

          # @!method initialize(ref_id: nil, source: nil, status: nil)
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Multigeocode::PlaceCreateParams::DataSource} for more
          #   details.
          #
          #   It contains information about the dataset that returns the specific result
          #
          ...
          #
          #   @param status [Symbol, Nextbillionai::Models::Multigeocode::PlaceCreateParams::DataSource::Status] This parameter indicates if a place is searchable.

          # This parameter indicates if a place is searchable.
          #
          # @see Nextbillionai::Models::Multigeocode::PlaceCreateParams::DataSource#status
          module Status
