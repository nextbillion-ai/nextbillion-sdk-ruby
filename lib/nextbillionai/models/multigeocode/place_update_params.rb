  ...
  module Models
    module Multigeocode
      ...
      class PlaceUpdateParams < Nextbillionai::Internal::Type::BaseModel
        ...
        # @!method initialize(doc_id:, key:, data_source: nil, place: nil, score: nil, request_options: {})
        ...
        class DataSource < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @param status [Symbol, Nextbillionai::Models::Multigeocode::PlaceUpdateParams::DataSource::Status] Set this to either enable or disable to allow the place to be retrieved by a sea
