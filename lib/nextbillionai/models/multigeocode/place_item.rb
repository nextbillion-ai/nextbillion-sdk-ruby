  ...
  module Models
    module Multigeocode
      class PlaceItem < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::Multigeocode::PlaceItem::Geopoint, nil]
        optional :geopoint, -> { Nextbillionai::Multigeocode::PlaceItem::Geopoint }
        ...
        #
        #   @return [Nextbillionai::Models::Multigeocode::PlaceItem::Poi, nil]
        optional :poi, -> { Nextbillionai::Multigeocode::PlaceItem::Poi }
        ...
        #   {Nextbillionai::Models::Multigeocode::PlaceItem} for more details.
        #
        ...
        #
        #   @param geopoint [Nextbillionai::Models::Multigeocode::PlaceItem::Geopoint] This parameter represents the geographical coordinates of the place. It includes
        #
        #   @param house [String] This parameter represents the house or building number of the place.
        #
        #   @param poi [Nextbillionai::Models::Multigeocode::PlaceItem::Poi] This parameter represents a point of interest within the place. A Point of Inter
        #
        ...
        # @see Nextbillionai::Models::Multigeocode::PlaceItem#geopoint
        ...
        # @see Nextbillionai::Models::Multigeocode::PlaceItem#poi
