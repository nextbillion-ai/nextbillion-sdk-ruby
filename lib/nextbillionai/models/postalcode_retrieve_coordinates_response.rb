...
module Nextbillionai
  module Models
    ...
    class PostalcodeRetrieveCoordinatesResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @return [Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places, nil]
      optional :places, -> { Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places }
      ...
      #   @param places [Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places] An object that contains details about the place that was provided in the input.
      #
      #   @param warning [Array<String>] Returns a message, in case the input provided triggers any warnings.

      # @see Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse#places
      class Places < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary, nil]
        optional :boundary, -> { Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary }
        ...
        #
        #   @return [Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Geopoint, nil]
        optional :geopoint, -> { Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Geopoint }
        ...
        #   {Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places} for more
        #   details.
        #
        #   An object that contains details about the place that was provided in the input.
        #
        ...
        #
        #   @param boundary [Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary] An object containing the boundary details of the postal code area. This object w
        #
        ...
        #
        #   @param geopoint [Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Geopoint] Refers to the geographic coordinate denoting the center of the postal code in la
        #
        ...
        # @see Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places#boundary
        class Boundary < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Geometry, nil]
          optional :geometry,
          ...
          #
          #   @return [Array<Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon>, nil]
          optional :multipolygon,
                   -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon] }
          ...
          #   [geojson format and standard](https://datatracker.ietf.org/doc/html/rfc7946).
          #
          #   @param geometry [Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Geometry] An object with geoJSON details of the boundary. This object is returned when the
          #
          #   @param multipolygon [Array<Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon>] An array of objects containing information about all the polygons forming the p
          #
          ...
          # @see Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary#geometry
          class Geometry < Nextbillionai::Internal::Type::BaseModel
            ...
            optional :coordinates,
                     Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Internal::Type::ArrayOf[Float]]]
          ...
          class Multipolygon < Nextbillionai::Internal::Type::BaseModel
            ...
            #   object.
            #
            #   @return [Array<Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::Polygon>, nil]
            optional :polygon,
                     -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::Polygon] }

            # @!method initialize(polygon: nil)
            #   Some parameter documentations has been truncated, see
            #   {Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon}
            #   for more details.
            #
            #   @param polygon [Array<Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::Polygon>] An object containing the details of a single polygon that is a part of the posta
            ...
            class Polygon < Nextbillionai::Internal::Type::BaseModel
              ...
              #
              #   @return [Array<Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::Polygon::Point>, nil]
              optional :points,
                       -> do
                         Nextbillionai::Internal::Type::ArrayOf[
                           Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::Polygon::Point
                         ]
                       end

              # @!method initialize(points: nil)
              #   @param points [Array<Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places::Boundary::Multipolygon::Polygon::Point>] Represents an array of geographic coordinates that define a `polygon` boundary.
        ...
        # @see Nextbillionai::Models::PostalcodeRetrieveCoordinatesResponse::Places#geopoint
