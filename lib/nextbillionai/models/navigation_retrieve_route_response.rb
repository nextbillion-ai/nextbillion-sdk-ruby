  ...
  module Models
    ...
    class NavigationRetrieveRouteResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      class Route < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @param legs [Array<Nextbillionai::Models::NavigationRetrieveRouteResponse::Route::Leg>] An array of objects returning the details about each leg of the route. waypoints
        #
        ...
        class Leg < Nextbillionai::Internal::Type::BaseModel
          ...
          class Step < Nextbillionai::Internal::Type::BaseModel
            ...
            class Maneuver < Nextbillionai::Internal::Type::BaseModel
              ...
              #
              #   @param voice_instruction [Array<Nextbillionai::Models::NavigationRetrieveRouteResponse::Route::Leg::Step::Maneuver::VoiceInstruction>] An array of voice instruction objects associated with the maneuver. Each object
