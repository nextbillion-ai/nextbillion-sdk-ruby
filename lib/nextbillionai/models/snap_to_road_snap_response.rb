...
module Nextbillionai
  module Models
    ...
    class SnapToRoadSnapResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @param snapped_points [Array<Nextbillionai::Models::SnapToRoadSnapResponse::SnappedPoint>] An array of objects. Each object provides the details of a `path` coordinate poi
      #
