...
module Nextbillionai
  module Models
    ...
    class IsochroneComputeResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      optional :features,
               -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::IsochroneComputeResponse::Feature] }
      ...
      #   {Nextbillionai::Models::IsochroneComputeResponse} for more details.
      #
      #   @param features [Array<Nextbillionai::Models::IsochroneComputeResponse::Feature>] A [GeoJSON FeatureCollection](https://datatracker.ietf.org/doc/html/rfc7946#sect
      #
      ...
      class Feature < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::IsochroneComputeResponse::Feature::Geometry, nil]
        optional :geometry, -> { Nextbillionai::Models::IsochroneComputeResponse::Feature::Geometry }

        # @!attribute properties
        #   An object with details of how the isochrone contour can be drawn on a map.
        #
        #   @return [Nextbillionai::Models::IsochroneComputeResponse::Feature::Properties, nil]
        ...
        #   Some parameter documentations has been truncated, see
        #   {Nextbillionai::Models::IsochroneComputeResponse::Feature} for more details.
        #
        #   @param geometry [Nextbillionai::Models::IsochroneComputeResponse::Feature::Geometry] A [GeoJSON geometry](https://datatracker.ietf.org/doc/html/rfc7946#page-7) objec
        #
        ...
        class Geometry < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::IsochroneComputeResponse::Feature::Geometry} for more
          #   details.
          #
          #   A [GeoJSON geometry](https://datatracker.ietf.org/doc/html/rfc7946#page-7)
          #   object with details of the contour line.
        ...
        # @see Nextbillionai::Models::IsochroneComputeResponse::Feature#properties
        class Properties < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::IsochroneComputeResponse::Feature::Properties} for more
          #   details.
          #
          #   An object with details of how the isochrone contour can be drawn on a map.
          #
