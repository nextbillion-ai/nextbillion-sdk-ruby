    ...
    module DistanceMatrix
      ...
      class JsonRetrieveResponse < Nextbillionai::Internal::Type::BaseModel
        ...
        class Row < Nextbillionai::Internal::Type::BaseModel
          ...
          #   details.
          #
          #   @param elements [Array<Nextbillionai::Models::DistanceMatrix::JsonRetrieveResponse::Row::Element>] An array of objects. Each `elements` array corresponds to a single `origins` coo
