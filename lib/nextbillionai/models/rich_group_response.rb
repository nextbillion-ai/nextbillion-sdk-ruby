...
module Nextbillionai
  module Models
    ...
    class RichGroupResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @return [Object, nil]
      optional :bbox, Nextbillionai::Internal::Type::Unknown
      ...
      #   applies.
      #
      #   @return [Symbol, Nextbillionai::Models::RichGroupResponse::Direction, nil]
      optional :direction, enum: -> { Nextbillionai::RichGroupResponse::Direction }
      ...
      #
      #   @return [Object, nil]
      optional :geofence, Nextbillionai::Internal::Type::Unknown
      ...
      optional :mode, Nextbillionai::Internal::Type::ArrayOf[String]
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::RichGroupResponse::RestrictionType, nil]
      optional :restriction_type, enum: -> { Nextbillionai::RichGroupResponse::RestrictionType }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::RichGroupResponse::State, nil]
      optional :state, enum: -> { Nextbillionai::RichGroupResponse::State }
      ...
      #   parameters.
      #
      #   @return [Symbol, Nextbillionai::Models::RichGroupResponse::Status, nil]
      optional :status, enum: -> { Nextbillionai::RichGroupResponse::Status }
      ...
      #   {Nextbillionai::Models::RichGroupResponse} for more details.
      #
      ...
      #
      #   @param direction [Symbol, Nextbillionai::Models::RichGroupResponse::Direction] Returns the direction of travel on the segments to which the restriction applies
      #
      ...
      #
      #   @param restriction_type [Symbol, Nextbillionai::Models::RichGroupResponse::RestrictionType] Returns the type of restriction. This is the same value as provided when creatin
      #
      ...
      #
      #   @param state [Symbol, Nextbillionai::Models::RichGroupResponse::State] Returns the state of the "restriction" itself - enabled, disabled or deleted. It
      #
      #   @param status [Symbol, Nextbillionai::Models::RichGroupResponse::Status] Returns the status of the restriction at the time of making the request i.e. whe
      #
      ...
      # applies.
      #
      # @see Nextbillionai::Models::RichGroupResponse#direction
      module Direction
      ...
      # creating or updating the restriction.
      #
      # @see Nextbillionai::Models::RichGroupResponse#restriction_type
      ...
      # does not denote if the restriction is actually in effect or not.
      #
      # @see Nextbillionai::Models::RichGroupResponse#state
      module State
        extend Nextbillionai::Internal::Type::Enum
      ...
      # parameters.
      #
      # @see Nextbillionai::Models::RichGroupResponse#status
      module Status
        extend Nextbillionai::Internal::Type::Enum
