...
module Nextbillionai
  module Models
    # @see Nextbillionai::Resources::Revgeocode#retrieve
    class RevgeocodeRetrieveResponse < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @return [Array<Nextbillionai::Models::RevgeocodeRetrieveResponse::Item>, nil]
      optional :items,
               -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::RevgeocodeRetrieveResponse::Item] }

      # @!method initialize(items: nil)
      #   Some parameter documentations has been truncated, see
      #   {Nextbillionai::Models::RevgeocodeRetrieveResponse} for more details.
      #
      #   @param items [Array<Nextbillionai::Models::RevgeocodeRetrieveResponse::Item>] The results are presented as a JSON list of candidates in ranked order (most-lik
      ...
      class Item < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours, nil]
        ...
        #
        #   @return [Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::Scoring, nil]
        optional :scoring, -> { Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::Scoring }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Nextbillionai::Models::RevgeocodeRetrieveResponse::Item} for more details.
        #
        ...
        #
        #   @param opening_hours [Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours] Returns the operating hours of the place, if available.
        #
        #   @param position [Nextbillionai::Models::Position] Returns the location coordinates of the result.
        #
        #   @param scoring [Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::Scoring] Score of the result. A higher score indicates a closer match.
        #
        #   @param title [String] The localized display name of this result item.

        # @see Nextbillionai::Models::RevgeocodeRetrieveResponse::Item#opening_hours
        class OpeningHours < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange>, nil]
          optional :time_ranges,
                   -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange] },
                   api_name: :timeRanges

          # @!method initialize(time_ranges: nil)
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours} for more
          #   details.
          #
          #   Returns the operating hours of the place, if available.
          #
          #   @param time_ranges [Array<Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange>] A collection of attributes with details about the opening and closing hours for

          class TimeRange < Nextbillionai::Internal::Type::BaseModel
            # @!attribute end_time
            #   Returns the closing time details.
            #
            #   @return [Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange::EndTime, nil]
            optional :end_time,
            ...
            #
            #   @return [Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange::StartTime, nil]
            optional :start_time,
            ...
            #   @param end_time [Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange::EndTime] Returns the closing time details.
            #
            #   @param start_time [Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange::StartTime] Returns the open time details.

            # @see Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange#end_time
            ...
            # @see Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::OpeningHours::TimeRange#start_time
        ...
        # @see Nextbillionai::Models::RevgeocodeRetrieveResponse::Item#scoring
        class Scoring < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::RevgeocodeRetrieveResponse::Item::Scoring} for more
          #   details.
          #
          #   Score of the result. A higher score indicates a closer match.
          #
