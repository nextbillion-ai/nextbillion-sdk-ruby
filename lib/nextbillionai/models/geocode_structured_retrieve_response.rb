...
module Nextbillionai
  module Models
    ...
    class GeocodeStructuredRetrieveResponse < Nextbillionai::Internal::Type::BaseModel
      # @!attribute items
      ...
      #
      #   @return [Array<Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item>, nil]
      optional :items,
               -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item] }

      # @!method initialize(items: nil)
      #   Some parameter documentations has been truncated, see
      #   {Nextbillionai::Models::GeocodeStructuredRetrieveResponse} for more details.
      #
      #   @param items [Array<Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item>] The results are presented as a JSON list of candidates in ranked order (most-lik
      ...
      class Item < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours, nil]
        optional :opening_hours,
                 -> { Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours },
        ...
        #
        #   @return [Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::Scoring, nil]
        optional :scoring, -> { Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::Scoring }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item} for more
        #   details.
        #
        ...
        #
        #   @param opening_hours [Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours] Returns the operating hours of the place, if available.
        #
        #   @param position [Nextbillionai::Models::Position] Returns the location coordinates of the result.
        #
        #   @param scoring [Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::Scoring] Score of the result. A higher score indicates a closer match.
        #
        #   @param title [String] The localized display name of this result item.

        # @see Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item#opening_hours
        class OpeningHours < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange>, nil]
          optional :time_ranges,
                   -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange] },
                   api_name: :timeRanges
          ...
          #   Returns the operating hours of the place, if available.
          #
          #   @param time_ranges [Array<Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange>] A collection of attributes with details about the opening and closing hours for

          class TimeRange < Nextbillionai::Internal::Type::BaseModel
            # @!attribute end_time
            #   Returns the closing time details.
            #
            #   @return [Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::EndTime, nil]
            optional :end_time,
                     -> { Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::EndTime },
                     api_name: :endTime

            # @!attribute start_time
            #   Returns the open time details.
            #
            #   @return [Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::StartTime, nil]
            optional :start_time,
                     -> { Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::StartTime },
                     api_name: :startTime

            # @!method initialize(end_time: nil, start_time: nil)
            #   @param end_time [Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::EndTime] Returns the closing time details.
            #
            #   @param start_time [Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange::StartTime] Returns the open time details.

            # @see Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange#end_time
            ...
            # @see Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::OpeningHours::TimeRange#start_time
        ...
        # @see Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item#scoring
        class Scoring < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::GeocodeStructuredRetrieveResponse::Item::Scoring} for
          #   more details.
          #
          #   Score of the result. A higher score indicates a closer match.
          #
