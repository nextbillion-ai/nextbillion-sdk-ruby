...
module Nextbillionai
  module Models
    class GeofenceAPI < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @return [Nextbillionai::Models::GeofenceAPI::CircleCenter, nil]
      optional :circle_center, -> { Nextbillionai::GeofenceAPI::CircleCenter }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::GeofenceAPI::Type, nil]
      optional :type, enum: -> { Nextbillionai::GeofenceAPI::Type }
      ...
      #   {Nextbillionai::Models::GeofenceAPI} for more details.
      #
      ...
      #
      #   @param circle_center [Nextbillionai::Models::GeofenceAPI::CircleCenter]
      #
      ...
      #
      #   @param type [Symbol, Nextbillionai::Models::GeofenceAPI::Type] Type of the geofence.
      #
      #   @param updated_at [Integer] Time at which the geofence was last updated, expressed as a UNIX timestamp in se

      # @see Nextbillionai::Models::GeofenceAPI#circle_center
      ...
      # Type of the geofence.
      #
      # @see Nextbillionai::Models::GeofenceAPI#type
      module Type
