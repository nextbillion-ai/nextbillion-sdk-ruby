  ...
  module Models
    module Optimization
      class Job < Nextbillionai::Internal::Type::BaseModel
        ...
        optional :depot_ids, Nextbillionai::Internal::Type::ArrayOf[String]
        ...
        #
        #   @return [Nextbillionai::Models::Optimization::Job::Volume, nil]
        optional :volume, -> { Nextbillionai::Optimization::Job::Volume }
        ...
        #   {Nextbillionai::Models::Optimization::Job} for more details.
        #
        ...
        #
        #   @param volume [Nextbillionai::Models::Optimization::Job::Volume] Specify the dimensions and alignment configurations for the cargo associated wit
        #
        #   @param zones [Array<Integer>] An array of integers specifying the IDs of the zone(s) that this job belongs to.

        # @see Nextbillionai::Models::Optimization::Job#volume
        class Volume < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Nextbillionai::Models::Optimization::Job::Volume::Alignment, nil]
          optional :alignment, enum: -> { Nextbillionai::Optimization::Job::Volume::Alignment }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Optimization::Job::Volume} for more details.
          #
          #   Specify the dimensions and alignment configurations for the cargo associated
          #   with the task. These inputs will be used to arrange the items into the loading
          #   compartment of the vehicle to utilize the three-dimensional space. If a job
          ...
          #   considered for arranging such items.
          #
          #   @param alignment [Symbol, Nextbillionai::Models::Optimization::Job::Volume::Alignment] Refers to the orientation of the cargo in the loading compartment. It supports t
          #
          ...
          #   vehicle’s available height, it cannot be loaded into the compartment.
          #
          # @see Nextbillionai::Models::Optimization::Job::Volume#alignment
          module Alignment
