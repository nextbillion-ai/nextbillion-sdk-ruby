  ...
  module Models
    module Optimization
      class Shipment < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::Optimization::Shipment::Delivery]
        required :delivery, -> { Nextbillionai::Optimization::Shipment::Delivery }

        # @!attribute pickup
        #   Specify the details of the pickup step of the shipment.
        #
        #   @return [Nextbillionai::Models::Optimization::Shipment::Pickup]
        required :pickup, -> { Nextbillionai::Optimization::Shipment::Pickup }
        ...
        optional :amount, Nextbillionai::Internal::Type::ArrayOf[Integer]
        ...
        #
        #   @return [Boolean, nil]
        optional :follow_lifo_order, Nextbillionai::Internal::Type::Boolean
        ...
        optional :incompatible_load_types, Nextbillionai::Internal::Type::ArrayOf[String]
        ...
        #
        #   @return [Array<String>, nil]
        optional :load_types, Nextbillionai::Internal::Type::ArrayOf[String]
        ...
        #
        #   @return [Array<Integer>, nil]
        optional :skills, Nextbillionai::Internal::Type::ArrayOf[Integer]
        ...
        #
        #   @return [Nextbillionai::Models::Optimization::Shipment::Volume, nil]
        optional :volume, -> { Nextbillionai::Optimization::Shipment::Volume }
        ...
        #
        #   @return [Array<Integer>, nil]
        optional :zones, Nextbillionai::Internal::Type::ArrayOf[Integer]
        ...
        #   {Nextbillionai::Models::Optimization::Shipment} for more details.
        #
        #   @param delivery [Nextbillionai::Models::Optimization::Shipment::Delivery] Specify the details of the delivery step of the shipment.
        #
        #   @param pickup [Nextbillionai::Models::Optimization::Shipment::Pickup] Specify the details of the pickup step of the shipment.
        #
        ...
        #
        #   @param revenue [Integer] Specify the revenue earned by completing this shipment. The optimizer uses the `
        #
        #   @param skills [Array<Integer>] Define the skills needed to complete the shipment. This attribute supports multi
        #
        #   @param volume [Nextbillionai::Models::Optimization::Shipment::Volume] Specify the dimensions and alignment configurations for the cargo associated wit
        #
        #   @param zones [Array<Integer>] An array of integers specifying the IDs of the zone(s) that this shipment belong

        # @see Nextbillionai::Models::Optimization::Shipment#delivery
        class Delivery < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Optimization::Shipment::Delivery} for more details.
          #
          #   Specify the details of the delivery step of the shipment.
          #
          ...
          #
          #   @param setup [Integer] Specify the set-up duration, in seconds, for the delivery. `setup` is the one-ti
          #
          #   @param time_windows [Array<Array<Integer>>] Describe time periods within which the shipment delivery should start. The time
        end

        # @see Nextbillionai::Models::Optimization::Shipment#pickup
        class Pickup < Nextbillionai::Internal::Type::BaseModel
          ...
          # @!method initialize(id:, location_index:, description: nil, max_visit_lateness: nil, metadata: nil, sequence_order: nil, service: nil, setup: nil, time_windows: nil)
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Optimization::Shipment::Pickup} for more details.
          #
          #   Specify the details of the pickup step of the shipment.
          #
          ...
          #
          #   @param setup [Integer] Specify the set-up duration, in seconds, for the pickup. `setup` is the one-time
          #
          #   @param time_windows [Array<Array<Integer>>] Describe time periods within which the shipment pickup should be start. The time
        end

        # @see Nextbillionai::Models::Optimization::Shipment#volume
        class Volume < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Nextbillionai::Models::Optimization::Shipment::Volume::Alignment, nil]
          optional :alignment, enum: -> { Nextbillionai::Optimization::Shipment::Volume::Alignment }
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::Optimization::Shipment::Volume} for more details.
          #
          #   Specify the dimensions and alignment configurations for the cargo associated
          #   with the shipment. These inputs will be used to arrange the items into the
          #   loading compartment of the vehicle to utilize the three-dimensional space. If a
          ...
          #   considered for arranging such items.
          #
          #   @param alignment [Symbol, Nextbillionai::Models::Optimization::Shipment::Volume::Alignment] Refers to the orientation of the cargo in the loading compartment. It supports t
          #
          ...
          #   vehicle’s available height, it cannot be loaded into the compartment.
          #
          # @see Nextbillionai::Models::Optimization::Shipment::Volume#alignment
          module Alignment
