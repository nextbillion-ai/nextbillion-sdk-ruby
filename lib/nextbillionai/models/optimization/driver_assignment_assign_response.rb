  ...
  module Models
    module Optimization
      ...
      class DriverAssignmentAssignResponse < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result, nil]
        optional :result, -> { Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result }
        ...
        #   {Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse} for more
        #   details.
        #
        #   @param message [String] Displays indicative error message in case of a failed request or operation. Plea
        #
        #   @param result [Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result] An object containing the details of the assignments.
        #
        #   @param status [Integer] An integer indicating the HTTP response code. See the [API Error Handling](https

        # @see Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse#result
        class Result < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip>, nil]
          optional :trips,
                   -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip] }
          ...
          optional :unassigned_orders,
                   -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::UnassignedOrder] }
          ...
          #
          #   @param unassigned_orders [Array<Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::UnassignedOrder>] A collection of objects listing the details of orders which remained unassigned.
          ...
          class AlternateAssignment < Nextbillionai::Internal::Type::BaseModel
            ...
            #
            #   @return [Array<Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::AlternateAssignment::Assignment>, nil]
            optional :assignments,
                     -> do
                       Nextbillionai::Internal::Type::ArrayOf[
                         Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::AlternateAssignment::Assignment
                       ]
                     end
            ...
            #   Some parameter documentations has been truncated, see
            #   {Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::AlternateAssignment}
            #   for more details.
            #
            #   @param assignments [Array<Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::AlternateAssignment::Assignment>] An array of objects containing the details of the alternate vehicle assignments.
            #
          ...
          class Trip < Nextbillionai::Internal::Type::BaseModel
            ...
            #
            #   @return [Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle, nil]
            optional :vehicle,
            ...
            #
            #   @param vehicle [Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle] Returns the details of the vehicle, assigned order and the trip steps.

            # @see Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip#vehicle
            class Vehicle < Nextbillionai::Internal::Type::BaseModel
              ...
              #
              #   @return [Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps, nil]
              optional :steps,
              ...
              #   Location info.
              #
              #   @return [Nextbillionai::Models::Optimization::Location, nil]
              optional :vehicle_current_location, -> { Nextbillionai::Optimization::Location }
              ...
              #
              #   @param steps [Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps] A collection of objects returning the sequence of steps that the vehicle needs t
              #
              #   @param vehicle_current_location [Nextbillionai::Models::Optimization::Location] Location info.

              # @see Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle#steps
              class Steps < Nextbillionai::Internal::Type::BaseModel
                ...
                #
                #   @return [Nextbillionai::Models::Optimization::Location, nil]
                optional :location, -> { Nextbillionai::Optimization::Location }
                ...
                #
                #   @return [Symbol, Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps::Type, nil]
                optional :type,
                         enum: -> { Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps::Type }
                ...
                #
                #   @param location [Nextbillionai::Models::Optimization::Location] Location info.
                #
                #   @param order_id [String] Returns the ID of the order. In case the step type is **ongoing**, an empty stri
                #
                #   @param type [Symbol, Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps::Type] Returns the type of the step. Currently, it can take following values:
                ...
                #   needs to complete in case multiple dropoffs are provided in the input.
                #
                # @see Nextbillionai::Models::Optimization::DriverAssignmentAssignResponse::Result::Trip::Vehicle::Steps#type
                module Type
