...
module Nextbillionai
  module Models
    ...
    class RestrictionListParams < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::RestrictionListParams::Mode, nil]
      optional :mode, enum: -> { Nextbillionai::RestrictionListParams::Mode }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::RestrictionListParams::RestrictionType, nil]
      optional :restriction_type, enum: -> { Nextbillionai::RestrictionListParams::RestrictionType }

      # @!attribute source
      #   It represents where it comes from, currently the possible values include "rrt",
      #   "xsm"
      #
      #   @return [Symbol, Nextbillionai::Models::RestrictionListParams::Source, nil]
      optional :source, enum: -> { Nextbillionai::RestrictionListParams::Source }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::RestrictionListParams::State, nil]
      optional :state, enum: -> { Nextbillionai::RestrictionListParams::State }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::RestrictionListParams::Status, nil]
      optional :status, enum: -> { Nextbillionai::RestrictionListParams::Status }
