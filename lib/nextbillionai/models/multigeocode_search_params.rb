...
module Nextbillionai
  module Models
    ...
    class MultigeocodeSearchParams < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @return [Nextbillionai::Models::MultigeocodeSearchParams::At]
      required :at, -> { Nextbillionai::MultigeocodeSearchParams::At }
      ...
      #
      #   @param at [Nextbillionai::Models::MultigeocodeSearchParams::At] Specify the center of the search context expressed as coordinates.
      #
