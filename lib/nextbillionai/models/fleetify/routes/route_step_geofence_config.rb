    ...
    module Fleetify
      module Routes
        class RouteStepGeofenceConfig < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @param type [Symbol, Nextbillionai::Models::Fleetify::Routes::RouteStepGeofenceConfig::Type] Specify the type of the geofence. Currently, `circle` is the only suppoeted valu
