    ...
    module Fleetify
      module Routes
        class RouteStepsResponse < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse::Completion, nil]
          optional :completion, -> { Nextbillionai::Fleetify::Routes::RouteStepsResponse::Completion }
          ...
          #
          #   @return [Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse::Meta, nil]
          optional :meta, -> { Nextbillionai::Fleetify::Routes::RouteStepsResponse::Meta }
          ...
          #   {Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse} for more details.
          #
          ...
          #
          #   @param completion [Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse::Completion]
          #
          ...
          #
          #   @param meta [Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse::Meta] An object returning custom details about the step that were configured in the in
          #
          ...
          # @see Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse#completion
          class Completion < Nextbillionai::Internal::Type::BaseModel
            ...
            optional :completed_by_mode, enum: -> { Nextbillionai::Fleetify::Routes::RouteStepCompletionMode }
            ...
            #
            #   @return [Object, nil]
            optional :document, Nextbillionai::Internal::Type::Unknown
            ...
            #   Some parameter documentations has been truncated, see
            #   {Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse::Completion} for
            #   more details.
            #
            #   @param completed_at [Integer] Represents the timestamp of the completion in seconds since the Unix epoch. Exam
            #
            #   @param completed_by_mode [Symbol, Nextbillionai::Models::Fleetify::Routes::RouteStepCompletionMode] Specify the mode of completion to be used for the step. Currently, following val
            #
            ...
            #
            #   @param status [Symbol, Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse::Completion::Status] Status of the step.

            # Status of the step.
            #
            # @see Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse::Completion#status
            module Status
          ...
          # @see Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse#meta
          class Meta < Nextbillionai::Internal::Type::BaseModel
            ...
            #   Some parameter documentations has been truncated, see
            #   {Nextbillionai::Models::Fleetify::Routes::RouteStepsResponse::Meta} for more
            #   details.
            #
            #   An object returning custom details about the step that were configured in the
            #   input request while configuring the step details. The information returned here
