...
module Nextbillionai
  module Models
    module Fleetify
      module Routes
        # @see Nextbillionai::Resources::Fleetify::Routes::Steps#update
        class StepUpdateResponse < Nextbillionai::Internal::Type::BaseModel
          # @!attribute data
          #
          ...
          #   {Nextbillionai::Models::Fleetify::Routes::StepUpdateResponse} for more details.
          #
