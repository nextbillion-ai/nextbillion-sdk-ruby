...
module Nextbillionai
  module Models
    ...
    class GeocodeBatchCreateParams < Nextbillionai::Internal::Type::BaseModel
      ...
      # @!attribute body
      #
      #   @return [Array<Nextbillionai::Models::GeocodeBatchCreateParams::Body>]
      required :body,
               -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::GeocodeBatchCreateParams::Body] }
      ...
      #
      #   @param body [Array<Nextbillionai::Models::GeocodeBatchCreateParams::Body>]
      #
      ...
      class Body < Nextbillionai::Internal::Type::BaseModel
        ...
        #   Some parameter documentations has been truncated, see
        #   {Nextbillionai::Models::GeocodeBatchCreateParams::Body} for more details.
        #
