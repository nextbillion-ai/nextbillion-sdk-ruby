...
module Nextbillionai
  module Models
    # @see Nextbillionai::Resources::Geocode#retrieve
    class GeocodeRetrieveResponse < Nextbillionai::Internal::Type::BaseModel
      # @!attribute items
      ...
      #
      #   @return [Array<Nextbillionai::Models::GeocodeRetrieveResponse::Item>, nil]
      optional :items,
               -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::GeocodeRetrieveResponse::Item] }

      # @!method initialize(items: nil)
      #   Some parameter documentations has been truncated, see
      #   {Nextbillionai::Models::GeocodeRetrieveResponse} for more details.
      #
      #   @param items [Array<Nextbillionai::Models::GeocodeRetrieveResponse::Item>] The results are presented as a JSON list of candidates in ranked order (most-lik
      ...
      class Item < Nextbillionai::Internal::Type::BaseModel
        ...
        #
        #   @return [Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours, nil]
        optional :opening_hours,
                 -> { Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours },
        ...
        #
        #   @return [Nextbillionai::Models::GeocodeRetrieveResponse::Item::Scoring, nil]
        optional :scoring, -> { Nextbillionai::Models::GeocodeRetrieveResponse::Item::Scoring }
        ...
        #   Some parameter documentations has been truncated, see
        #   {Nextbillionai::Models::GeocodeRetrieveResponse::Item} for more details.
        #
        ...
        #
        #   @param opening_hours [Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours] Returns the operating hours of the place, if available.
        #
        #   @param position [Nextbillionai::Models::Position] Returns the location coordinates of the result.
        #
        #   @param scoring [Nextbillionai::Models::GeocodeRetrieveResponse::Item::Scoring] Score of the result. A higher score indicates a closer match.
        #
        #   @param title [String] The localized display name of this result item.

        # @see Nextbillionai::Models::GeocodeRetrieveResponse::Item#opening_hours
        class OpeningHours < Nextbillionai::Internal::Type::BaseModel
          ...
          #
          #   @return [Array<Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange>, nil]
          optional :time_ranges,
                   -> { Nextbillionai::Internal::Type::ArrayOf[Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange] },
                   api_name: :timeRanges

          # @!method initialize(time_ranges: nil)
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours} for more
          #   details.
          #
          #   Returns the operating hours of the place, if available.
          #
          #   @param time_ranges [Array<Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange>] A collection of attributes with details about the opening and closing hours for

          class TimeRange < Nextbillionai::Internal::Type::BaseModel
            # @!attribute end_time
            #   Returns the closing time details.
            #
            #   @return [Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange::EndTime, nil]
            optional :end_time,
                     -> { Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange::EndTime },
                     api_name: :endTime

            # @!attribute start_time
            #   Returns the open time details.
            #
            #   @return [Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange::StartTime, nil]
            optional :start_time,
                     -> { Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange::StartTime },
                     api_name: :startTime

            # @!method initialize(end_time: nil, start_time: nil)
            #   @param end_time [Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange::EndTime] Returns the closing time details.
            #
            #   @param start_time [Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange::StartTime] Returns the open time details.

            # @see Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange#end_time
            ...
            # @see Nextbillionai::Models::GeocodeRetrieveResponse::Item::OpeningHours::TimeRange#start_time
        ...
        # @see Nextbillionai::Models::GeocodeRetrieveResponse::Item#scoring
        class Scoring < Nextbillionai::Internal::Type::BaseModel
          ...
          #   Some parameter documentations has been truncated, see
          #   {Nextbillionai::Models::GeocodeRetrieveResponse::Item::Scoring} for more
          #   details.
          #
          #   Score of the result. A higher score indicates a closer match.
          #
