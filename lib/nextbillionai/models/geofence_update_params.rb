...
module Nextbillionai
  module Models
    ...
    class GeofenceUpdateParams < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @param type [Symbol, Nextbillionai::Models::GeofenceUpdateParams::Type] Use this parameter to update the `type` of a geofence. Please note that you will
      #
      ...
      class Polygon < Nextbillionai::Internal::Type::BaseModel
        ...
        #   Area of the polygon should be less than 2000 km<sup>2</sup>.
        #
        #   @param geojson [Nextbillionai::Models::GeofenceUpdateParams::Polygon::Geojson] An object to collect geoJSON details of the `polygon` geofence. The contents of
