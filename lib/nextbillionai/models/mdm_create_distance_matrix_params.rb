...
module Nextbillionai
  module Models
    ...
    class MdmCreateDistanceMatrixParams < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @param destinations_approach [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::DestinationsApproach] Specify the side of the road from which to approach destinations points. Please
      #
      ...
      #
      #   @param origins_approach [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::OriginsApproach] Specify the side of the road from which to approach origins points. Please note
      #
      #   @param route_type [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::RouteType] Set the route type that needs to be returned. Please note that route_type is eff
      #
