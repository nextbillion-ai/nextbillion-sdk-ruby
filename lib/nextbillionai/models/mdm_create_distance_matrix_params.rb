...
module Nextbillionai
  module Models
    ...
    class MdmCreateDistanceMatrixParams < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Option]
      required :option, enum: -> { Nextbillionai::MdmCreateDistanceMatrixParams::Option }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Spliter, nil]
      optional :spliter, enum: -> { Nextbillionai::MdmCreateDistanceMatrixParams::Spliter }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Area, nil]
      optional :area, enum: -> { Nextbillionai::MdmCreateDistanceMatrixParams::Area }
      ...
      #       \[120,240\].
      #
      #   @return [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Avoid, nil]
      optional :avoid, enum: -> { Nextbillionai::MdmCreateDistanceMatrixParams::Avoid }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::DestinationsApproach, nil]
      optional :destinations_approach,
               enum: -> { Nextbillionai::MdmCreateDistanceMatrixParams::DestinationsApproach }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::HazmatType, nil]
      optional :hazmat_type, enum: -> { Nextbillionai::MdmCreateDistanceMatrixParams::HazmatType }
      ...
      #
      #   @return [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Mode, nil]
      optional :mode, enum: -> { Nextbillionai::MdmCreateDistanceMatrixParams::Mode }
      ...
      #   `origins`.
      #
      #   @return [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::OriginsApproach, nil]
      optional :origins_approach, enum: -> { Nextbillionai::MdmCreateDistanceMatrixParams::OriginsApproach }

      # @!attribute route_type
      #   Set the route type that needs to be returned. Please note that `route_type` is
      #   effective only when `option=flexible`.
      #
      #   @return [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::RouteType, nil]
      optional :route_type, enum: -> { Nextbillionai::MdmCreateDistanceMatrixParams::RouteType }
      ...
      #
      #   @param option [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Option] Use this option to switch to truck-specific routing or time based routing or if
      #
      #   @param origins [String] `origins` are the starting point of your route. Ensure that origins are routable
      #
      #   @param spliter [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Spliter] Specify a spliter to split the matrix by. It accepts 2 values:
      #
      #   @param area [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Area] Provide the country that the coordinates belong to.
      #
      #   @param avoid [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Avoid] Setting this will ensure the route avoids the object(s) specified as input. Mult
      #
      ...
      #
      #   @param destinations [String] `destinations` are the ending coordinates of your route. Ensure that destination
      #
      #   @param destinations_approach [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::DestinationsApproach] Specify the side of the road from which to approach `destinations` points. Pleas
      #
      #   @param hazmat_type [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::HazmatType] Specify the type of hazardous material being carried and the service will avoid
      #
      #   @param mode [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::Mode] Set which driving mode the service should use to determine a route.
      #
      #   @param origins_approach [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::OriginsApproach] Specify the side of the road from which to approach `origins` points. Please not
      #
      #   @param route_type [Symbol, Nextbillionai::Models::MdmCreateDistanceMatrixParams::RouteType] Set the route type that needs to be returned. Please note that `route_type` is e
      #
