...
module Nextbillionai
  module Models
    ...
    class RouteReportCreateParams < Nextbillionai::Internal::Type::BaseModel
      ...
      #
      #   @param original_shape_type [Symbol, Nextbillionai::Models::RouteReportCreateParams::OriginalShapeType] Specify the encoding type of route geometry provided in original_shape input. Pl
      #
